...
(lib.Символ4 = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(-374.9,13.5,1,1,0,0,0,58,41.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ4, new cjs.Rectangle(-478.9,-84.5,515.9,440.2), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ1, new cjs.Rectangle(-107.2,6,602.3,68), null);
...
(lib.lavina600300 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(318,294,0.812,0.812,0,0,0,209,57.6);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(52.5,34.7,0.6,0.6,0,0,0,67.6,49.5);
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(392.6,32,0.767,0.767,0,0,0,247,30);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1479810930273", id:"back"},
		{src:"images/blink.png?1479810930273", id:"blink"},
		{src:"images/book.png?1479810930273", id:"book"},
		{src:"images/chip.png?1479810930273", id:"chip"},
		{src:"images/goat.png?1479810930273", id:"goat"},
		{src:"images/goat2.png?1479810930273", id:"goat2"},
		{src:"images/han1.png?1479810930273", id:"han1"},
		{src:"images/han2.png?1479810930273", id:"han2"},
		{src:"images/helio.png?1479810930273", id:"helio"},
		{src:"images/imac.png?1479810930273", id:"imac"},
		{src:"images/iph.png?1479810930273", id:"iph"},
		{src:"images/logo.png?1479810930273", id:"logo"},
		{src:"images/more.png?1479810930273", id:"more"},
		{src:"images/pod.png?1479810930273", id:"pod"},
		{src:"images/priz.png?1479810930273", id:"priz"},
		{src:"images/rou.png?1479810930273", id:"rou"},
		{src:"images/snowman.png?1479810930273", id:"snowman"},
		{src:"images/tek.png?1479810930273", id:"tek"},
		{src:"images/twoth.png?1479810930273", id:"twoth"}
	],
	preloads: []
};
