...
(lib.Symbol63 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.2,scaleY:1.2,x:36.1,y:21.5},6,cjs.Ease.get(-1)).to({regX:35.9,scaleX:1.46,scaleY:1.46,x:35.9,y:21.4},8,cjs.Ease.get(1)).to({scaleX:1.21,scaleY:1.21,x:36.1,y:21.5},8,cjs.Ease.get(-1)).to({regX:36,scaleX:1,scaleY:1,x:36,y:21.4},7,cjs.Ease.get(1)).wait(1));
...
(lib.Symbol62 = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFCA40").s().p("");
	this.shape.setTransform(187.7,180.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFCA40").s().p("");
	this.shape_1.setTransform(164.7,179.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFCA40").s().p("");
	this.shape_2.setTransform(138.3,181);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFCA40").s().p("");
	this.shape_3.setTransform(112.8,181);
	...
	this.shape_4.setTransform(89.8,180.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFCA40").s().p("");
	this.shape_5.setTransform(208.3,104.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFCA40").s().p("");
	this.shape_6.setTransform(180.6,103.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFCA40").s().p("");
	this.shape_7.setTransform(154.2,111.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFCA40").s().p("");
	this.shape_8.setTransform(126.4,105.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFCA40").s().p("AhBBsQgYgQgQgXQgDgFgEgSIgEgZQAAgzATgiQASghAmgOQAagNAXAAQAWAAARAIQAOAHAUARQAVATADALIAMA1IAAAHIAAAUQgHAygkAdQgSAOgWAHQgWAHgYAAQgaAAgbgRgAgbg9QgEAHgGAXQgIAdAAATQAAASAJAPQAFAIAHAEQAGAFAJAAQAWAAAPgmQAKgdAAgYQAAgUgLgQQgNgRgSAAQgPAAgIAQg");
	this.shape_9.setTransform(97.3,105);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFCA40").s().p("");
	this.shape_10.setTransform(71.2,104.7);
	...
	this.instance.parent = this;
	this.instance.setTransform(108,22,0.222,0.222);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(135.8,146.6,1,1,0,0,0,36,21.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// Layer 1
	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFCA40").s().p("");
	this.shape_11.setTransform(270.2,-0.5);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFCA40").s().p("");
	this.shape_12.setTransform(254.6,-1.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFCA40").s().p("");
	this.shape_13.setTransform(237.4,-0.8);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFCA40").s().p("");
	this.shape_14.setTransform(221.6,-0.5);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFCA40").s().p("");
	this.shape_15.setTransform(202.2,-1.3);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFCA40").s().p("");
	this.shape_16.setTransform(182.3,-1.1);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFCA40").s().p("");
	this.shape_17.setTransform(165.4,0.1);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFCA40").s().p("");
	this.shape_18.setTransform(148.6,-1.2);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFCA40").s().p("");
	this.shape_19.setTransform(133,-1);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFCA40").s().p("");
	this.shape_20.setTransform(117.7,-0.4);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFCA40").s().p("");
	this.shape_21.setTransform(93.5,-3.7);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFCA40").s().p("");
	this.shape_22.setTransform(77.3,0.1);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFCA40").s().p("");
	this.shape_23.setTransform(62.4,0.1);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFCA40").s().p("");
	this.shape_24.setTransform(45.8,0.1);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFCA40").s().p("");
	this.shape_25.setTransform(29.2,-1.1);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFCA40").s().p("");
	this.shape_26.setTransform(12.9,-0.6);
...
}).prototype = getMCSymbolPrototype(lib.Symbol62, new cjs.Rectangle(4.5,-10,272.6,212.7), null);
...
(lib.Symbol56 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(167.3,39.6,0.942,0.942,0,0,0,35.1,35.1);
...
}).prototype = getMCSymbolPrototype(lib.Symbol56, new cjs.Rectangle(-19.5,-5,221,104.3), null);
...
(lib.Symbol45 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(103,164.5,1,1,0,0,0,81.5,14.6);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(100.8,135.2,1,1,0,0,0,56.7,8.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol45, new cjs.Rectangle(-13,1.2,221,177.9), null);
...
p.nominalBounds = new cjs.Rectangle(0,0,221,177.9);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/icon.png?1486040728014", id:"icon"},
		{src:"images/mouse.png?1486040728014", id:"mouse"},
		{src:"images/pizza1.png?1486040728014", id:"pizza1"},
		{src:"images/pizza2.png?1486040728014", id:"pizza2"},
		{src:"images/pizza3.png?1486040728014", id:"pizza3"},
		{src:"images/pizza4.png?1486040728014", id:"pizza4"},
		{src:"images/pizza5.png?1486040728014", id:"pizza5"},
		{src:"images/pizzatext.png?1486040728014", id:"pizzatext"},
		{src:"images/radar.png?1486040728014", id:"radar"},
		{src:"images/radarback.png?1486040728014", id:"radarback"},
		{src:"images/setka.png?1486040728014", id:"setka"}
	],
	preloads: []
};
