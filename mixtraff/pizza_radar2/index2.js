...
(lib.Symbol62 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(184,7,0.222,0.222);
	...
	this.shape_11.graphics.f("#FFCA40").s().p("");
	this.shape_11.setTransform(162.1,53.3);
	...
	this.shape_12.setTransform(150,52.7);
	...
	this.shape_13.setTransform(136.4,53);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFCA40").s().p("");
	this.shape_14.setTransform(124.1,53.3);
	...
	this.shape_15.setTransform(108.9,52.6);
	...
	this.shape_16.setTransform(93.4,52.8);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFCA40").s().p("");
	this.shape_17.setTransform(80.2,53.7);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFCA40").s().p("");
	this.shape_18.setTransform(67,52.7);
	...
	this.shape_19.setTransform(54.8,52.8);
	...
	this.shape_20.setTransform(42.8,53.3);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFCA40").s().p("");
	this.shape_21.setTransform(154.9,20.5);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFCA40").s().p("");
	this.shape_22.setTransform(132.8,25.6);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFCA40").s().p("");
	this.shape_23.setTransform(112.4,25.7);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFCA40").s().p("");
	this.shape_24.setTransform(89.8,25.6);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFCA40").s().p("");
	this.shape_25.setTransform(67.2,24);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFCA40").s().p("");
	this.shape_26.setTransform(45.1,24.7);
...
}).prototype = getMCSymbolPrototype(lib.Symbol62, new cjs.Rectangle(33.7,7,209,176.3), null);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/icon.png?1486041502380", id:"icon"},
		{src:"images/mouse.png?1486041502380", id:"mouse"},
		{src:"images/pizza1.png?1486041502380", id:"pizza1"},
		{src:"images/pizza2.png?1486041502380", id:"pizza2"},
		{src:"images/pizza3.png?1486041502380", id:"pizza3"},
		{src:"images/pizza4.png?1486041502380", id:"pizza4"},
		{src:"images/pizza5.png?1486041502380", id:"pizza5"},
		{src:"images/pizzatext.png?1486041502380", id:"pizzatext"},
		{src:"images/radar.png?1486041502380", id:"radar"},
		{src:"images/radarback.png?1486041502380", id:"radarback"},
		{src:"images/setka.png?1486041502380", id:"setka"}
	],
	preloads: []
};
