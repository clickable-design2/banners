...
(lib.Symbol40 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(1681.9,180,1,1,0,0,0,337,180);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(337,180,1,1,0,0,0,337,180);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol40, new cjs.Rectangle(0,0,2018.9,360), null);
...
p.nominalBounds = new cjs.Rectangle(0,0,2018.9,360);
...
}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(-31.9,-25.9,2040.9,443), null);
...
p.nominalBounds = new cjs.Rectangle(-261.6,84.1,2548.6,443);
// library properties:
lib.properties = {
	width: 600,
	height: 300,
