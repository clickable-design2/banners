...
(lib.arrw = function() {
	this.initialize(img.arrw);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,30,17);
...
p.nominalBounds = new cjs.Rectangle(0,0,25,240);
...
p.nominalBounds = new cjs.Rectangle(0,0,325,69);


(lib.www = function() {
	this.initialize(img.www);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,22,237);// helper functions:
...
(lib.Символ66 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#003300").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ66, new cjs.Rectangle(-14.9,-7.5,29.8,15.1), null);
...
(lib.Символ63 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#003300").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ63, new cjs.Rectangle(-7.9,-4.8,15.8,9.6), null);
...
(lib.Символ52 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.instance = new lib.arrw();
	this.instance.parent = this;
	this.instance.setTransform(-15,-8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ52, new cjs.Rectangle(-15,-8,30,17), null);
...
(lib.Символ50 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-11,-118);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ50, new cjs.Rectangle(-11,-118,22,237), null);
...
(lib.Символ65 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-68.9,0.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(159));

	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00FF00").s().p("At9B4IAAjvIb7AAIAADvg");

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#00FF00").s().p("AtkB4IAAjvIbJAAIAADvg");
	this.shape_1.setTransform(-2.5,0);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#00FF00").s().p("AtMB4IAAjvIaZAAIAADvg");
	this.shape_2.setTransform(-4.9,0);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#00FF00").s().p("As0B4IAAjvIZpAAIAADvg");
	this.shape_3.setTransform(-7.4,0);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#00FF00").s().p("AsbB4IAAjvIY3AAIAADvg");
	this.shape_4.setTransform(-9.8,0);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#00FF00").s().p("ArwB4IAAjvIXgAAIAADvg");
	this.shape_5.setTransform(-14.2,0);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#00FF00").s().p("ArEB4IAAjvIWJAAIAADvg");
	this.shape_6.setTransform(-18.6,0);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#00FF00").s().p("AqYB4IAAjvIUxAAIAADvg");
	this.shape_7.setTransform(-23,0);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#00FF00").s().p("ApsB4IAAjvITZAAIAADvg");
	this.shape_8.setTransform(-27.3,0);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#00FF00").s().p("AopB4IAAjvIRTAAIAADvg");
	this.shape_9.setTransform(-34.1,0);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#00FF00").s().p("AnmB4IAAjvIPMAAIAADvg");
	this.shape_10.setTransform(-40.8,0);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#00FF00").s().p("AmiB4IAAjvINFAAIAADvg");
	this.shape_11.setTransform(-47.5,0);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#00FF00").s().p("AlfB4IAAjvIK/AAIAADvg");
	this.shape_12.setTransform(-54.3,0);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.shape}]},48).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_4}]},48).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_8}]},48).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_12}]},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-89.4,-12,178.8,24.1);
...
(lib.Символ58 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-33.1,3,0.848,0.848,0,0,0,-0.1,0);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00FF00").s().p("AliAqIAAhTILFAAIAABTg");
	this.shape.setTransform(-6.5,3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ58, new cjs.Rectangle(-42,-1.2,71.1,8.4), null);
...
p.nominalBounds = new cjs.Rectangle(-45.5,-125.8,56.6,244.8);
...
(lib.Символ22 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-13,-120);
...
}).prototype = getMCSymbolPrototype(lib.Символ22, new cjs.Rectangle(-45.5,-125.8,64.8,249.8), null);
...
p.nominalBounds = new cjs.Rectangle(-41.4,-4.1,71.1,8.4);
...
p.nominalBounds = new cjs.Rectangle(-315,-164,706,652.5);
...
p.nominalBounds = new cjs.Rectangle(286,130,706,665.4);
// library properties:
lib.properties = {
	width: 600,
	height: 300,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/arrw.png?1484580448717", id:"arrw"},
		{src:"images/bey.png?1484580448717", id:"bey"},
		{src:"images/bg.jpg?1484580448717", id:"bg"},
		{src:"images/eee.png?1484580448717", id:"eee"},
		{src:"images/mech.png?1484580448717", id:"mech"},
		{src:"images/navedi.png?1484580448717", id:"navedi"},
		{src:"images/qqq.png?1484580448717", id:"qqq"},
		{src:"images/redeyes.png?1484580448717", id:"redeyes"},
		{src:"images/viking_03.png?1484580448717", id:"viking_03"},
		{src:"images/viking_06.png?1484580448717", id:"viking_06"},
		{src:"images/viking_09.png?1484580448717", id:"viking_09"},
		{src:"images/viking_12.png?1484580448717", id:"viking_12"},
		{src:"images/viking_15.png?1484580448717", id:"viking_15"},
		{src:"images/viking_20.png?1484580448717", id:"viking_20"},
		{src:"images/viking_24.png?1484580448717", id:"viking_24"},
		{src:"images/viking_28.png?1484580448717", id:"viking_28"},
		{src:"images/viking_31.png?1484580448717", id:"viking_31"},
		{src:"images/viking_321.png?1484580448717", id:"viking_321"},
		{src:"images/vraga.png?1484580448717", id:"vraga"},
		{src:"images/www.png?1484580448717", id:"www"}
	],
	preloads: []
};
