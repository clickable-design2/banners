...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Back.jpg?1477925062348", id:"Back"},
		{src:"images/dol.png?1477925062348", id:"dol"},
		{src:"images/hand_l.png?1477925062348", id:"hand_l"},
		{src:"images/hand_r.png?1477925062348", id:"hand_r"},
		{src:"images/reg.png?1477925062348", id:"reg"},
		{src:"images/ten.png?1477925062348", id:"ten"}
	]
};
...
(lib.Символ40 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(119).to({rotation:7.8,x:801,y:449.3},13,cjs.Ease.get(-1)).to({regY:350.1,scaleX:1,scaleY:1,rotation:12.6,x:760.3,y:449.9},5).to({regY:349.9,scaleX:1,scaleY:1,rotation:14.7,x:744.1,y:450},2,cjs.Ease.get(1)).to({rotation:-4.5,x:522.3,y:426.5},5,cjs.Ease.get(1)).to({rotation:-2.3,x:694.2,y:437.4},13,cjs.Ease.get(-1)).to({regY:350,rotation:0,x:866,y:448.5},13,cjs.Ease.get(1)).wait(143).to({rotation:7.8,x:801,y:449.3},13,cjs.Ease.get(-1)).to({regY:350.1,scaleX:1,scaleY:1,rotation:12.6,x:760.3,y:449.9},5).to({regY:349.9,scaleX:1,scaleY:1,rotation:14.7,x:744.1,y:450},2,cjs.Ease.get(1)).to({rotation:-4.5,x:522.3,y:426.5},5,cjs.Ease.get(1)).to({rotation:-2.3,x:694.2,y:437.4},13,cjs.Ease.get(-1)).to({regY:350,rotation:0,x:866,y:448.5},13,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(150).to({_off:false},0).wait(183).to({x:-676.7},5,cjs.Ease.get(-1)).wait(27));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(139).to({x:-1448.1},10,cjs.Ease.get(-1)).to({_off:true},1).wait(215));
