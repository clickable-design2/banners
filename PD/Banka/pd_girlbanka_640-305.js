...
(lib.Символ17 = function(mode,startPosition,loop) {
	...
	this.instance = new lib.curs();
	this.instance.parent = this;
	this.instance.setTransform(11,12,0.694,0.694);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ17, new cjs.Rectangle(11,12,47.9,54.8), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ18, new cjs.Rectangle(11,12,47.9,54.8), null);
...
(lib.Символ12 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(74,105.3,1,1,27.7,0,0,34.6,39.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:34.5,scaleX:1,scaleY:1,rotation:-42.8,x:15.8,y:7.4},14,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,rotation:-118.3,x:-46.7,y:-97.3},15,cjs.Ease.get(1)).to({scaleX:1,scaleY:1,rotation:-37.6,x:20,y:14.4},16,cjs.Ease.get(-1)).to({regX:34.6,scaleX:1,scaleY:1,rotation:27.7,x:74,y:105.3},13,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(40.4,69.9,67.9,70.9);
...
p.nominalBounds = new cjs.Rectangle(-36.7,-24.7,427.1,474.4);
...
(lib.pd_girlbanka_640305 = function(mode,startPosition,loop) {
	...
	this.cur.parent = this;
	this.cur.setTransform(822.5,239.1,0.747,0.747,0,0,0,34.9,38.6);
...
p.nominalBounds = new cjs.Rectangle(169,131.9,1023.8,474.4);
// library properties:
lib.properties = {
	width: 640,
	height: 305,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/arm.png?1484147569579", id:"arm"},
		{src:"images/armer.png?1484147569579", id:"armer"},
		{src:"images/armol.png?1484147569579", id:"armol"},
		{src:"images/back.jpg?1484147569579", id:"back"},
		{src:"images/bak.png?1484147569579", id:"bak"},
		{src:"images/bank.png?1484147569579", id:"bank"},
		{src:"images/bankaka.png?1484147569579", id:"bankaka"},
		{src:"images/bodom.png?1484147569579", id:"bodom"},
		{src:"images/body.png?1484147569579", id:"body"},
		{src:"images/curs.png?1484147569579", id:"curs"},
		{src:"images/fing.png?1484147569579", id:"fing"},
		{src:"images/goobe.png?1484147569579", id:"goobe"},
		{src:"images/hand.png?1484147569579", id:"hand"},
		{src:"images/handry.png?1484147569579", id:"handry"},
		{src:"images/head.png?1484147569579", id:"head"},
		{src:"images/heady.png?1484147569579", id:"heady"},
		{src:"images/logo.png?1484147569579", id:"logo"},
		{src:"images/rotto.png?1484147569579", id:"rotto"},
		{src:"images/shold.png?1484147569579", id:"shold"}
	],
	preloads: []
};
