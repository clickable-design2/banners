...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1478014033202", id:"back"},
		{src:"images/cards.png?1478014033202", id:"cards"},
		{src:"images/chip.png?1478014033202", id:"chip"},
		{src:"images/dol.png?1478014033202", id:"dol"},
		{src:"images/logo.png?1478014033202", id:"logo"}
	]
};
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(18).to({_off:false},0).to({y:384.6,alpha:1},9,cjs.Ease.get(1)).wait(123));
