...
(lib.Символ31 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("AuXEaQgxAAAAgzIAAnNQAAgzAxAAIcvAAQAxAAAAAzIAAHNQAAAzgxAAg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ31, new cjs.Rectangle(-96.9,-28.1,193.9,56.3), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ29, new cjs.Rectangle(-90.2,-26.7,180.5,53.5), null);
...
(lib.Символ30 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({scaleX:1.08,scaleY:1.08},0).wait(1).to({scaleX:0.96,scaleY:0.96},0).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-90.2,-26.7,180.5,53.5);
...
}).prototype = getMCSymbolPrototype(lib.Символ16, new cjs.Rectangle(-97.9,-29.1,195.9,58.3), null);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1485510387090", id:"bg"},
		{src:"images/bg2.jpg?1485510387090", id:"bg2"},
		{src:"images/bg3.jpg?1485510387090", id:"bg3"},
		{src:"images/bg4.jpg?1485510387090", id:"bg4"}
	],
	preloads: []
};
