...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/blik.png?1479999685612", id:"blik"},
		{src:"images/csgo_logo.png?1479999685612", id:"csgo_logo"},
		{src:"images/fon.jpg?1479999685612", id:"fon"},
		{src:"images/giphy_0.png?1479999685612", id:"giphy_0"},
		{src:"images/giphy_1.png?1479999685612", id:"giphy_1"},
		{src:"images/giphy_2.png?1479999685612", id:"giphy_2"},
		{src:"images/giphy_3.png?1479999685612", id:"giphy_3"},
		{src:"images/giphy_4.png?1479999685612", id:"giphy_4"},
		{src:"images/giphy_5.png?1479999685612", id:"giphy_5"},
		{src:"images/item_02.png?1479999685612", id:"item_02"},
		{src:"images/item_09.png?1479999685612", id:"item_09"},
		{src:"images/item_14.png?1479999685612", id:"item_14"},
		{src:"images/item_16.png?1479999685612", id:"item_16"},
		{src:"images/logo.png?1479999685612", id:"logo"},
		{src:"images/maxresdefault.png?1479999685612", id:"maxresdefault"},
		{src:"images/OpenCaseNow.png?1479999685612", id:"OpenCaseNow"},
		{src:"images/OpenCaseNow2.png?1479999685612", id:"OpenCaseNow2"},
		{src:"images/Pointing.png?1479999685612", id:"Pointing"},
		{src:"images/slide.png?1479999685612", id:"slide"}
	]
};
...
(lib.Символ41 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(194.7,397.7,0.646,0.646,0,0,0,145.5,36.1);
	this.instance.compositeOperation = "lighter";
...
(lib.Символ21 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(19.2,70.8,0.774,0.774,0,0,0,90.5,27.9);
	new cjs.ButtonHelper(this.instance, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-86.5,29.8,207.6,63.6);
...
p.nominalBounds = new cjs.Rectangle(13.2,72.4,207.5,63.5);
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:219.4,alpha:0},14,cjs.Ease.get(-1)).to({y:96.5,alpha:1},14,cjs.Ease.get(1)).to({y:95.9},1).wait(1));
...
p.nominalBounds = new cjs.Rectangle(2.2,72.4,218.5,203.2);
...
p.nominalBounds = new cjs.Rectangle(-86.5,29.9,207.5,63.5);
...
p.nominalBounds = new cjs.Rectangle(-138.9,29.9,329.8,259.8);
...
(lib.gamerall300x600 = function(mode,startPosition,loop) {
	...
	this.vip.setTransform(171.1,266,0.941,0.941,0,0,0,134.2,71.3);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(286.9,190,0.76,0.76,0,4.9,-175.1);
	...
	this.blood.setTransform(150.4,515.3,0.922,0.922,0,0,0,110.8,71.2);
	...
	this.vopros2.setTransform(134.2,415,0.736,0.736,0,0,0,96.1,95.9);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(29.3,441.6,0.76,0.76,-8);
