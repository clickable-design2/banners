...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/blik.png?1480000463853", id:"blik"},
		{src:"images/csgo_logo.png?1480000463853", id:"csgo_logo"},
		{src:"images/fon.jpg?1480000463853", id:"fon"},
		{src:"images/giphy_0.png?1480000463853", id:"giphy_0"},
		{src:"images/giphy_1.png?1480000463853", id:"giphy_1"},
		{src:"images/giphy_2.png?1480000463853", id:"giphy_2"},
		{src:"images/giphy_3.png?1480000463853", id:"giphy_3"},
		{src:"images/giphy_4.png?1480000463853", id:"giphy_4"},
		{src:"images/giphy_5.png?1480000463853", id:"giphy_5"},
		{src:"images/item_02.png?1480000463853", id:"item_02"},
		{src:"images/item_09.png?1480000463853", id:"item_09"},
		{src:"images/item_14.png?1480000463853", id:"item_14"},
		{src:"images/item_16.png?1480000463853", id:"item_16"},
		{src:"images/logo.png?1480000463853", id:"logo"},
		{src:"images/maxresdefault.png?1480000463853", id:"maxresdefault"},
		{src:"images/OpenCaseNow.png?1480000463853", id:"OpenCaseNow"},
		{src:"images/OpenCaseNow2.png?1480000463853", id:"OpenCaseNow2"},
		{src:"images/Pointing.png?1480000463853", id:"Pointing"},
		{src:"images/slide.png?1480000463853", id:"slide"}
	]
};
...
(lib.Символ21 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(19.2,69.8,0.774,0.774,0,0,0,90.5,27.9);
	new cjs.ButtonHelper(this.instance, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-86.5,28.8,207.6,63.6);
...
p.nominalBounds = new cjs.Rectangle(13.2,71.4,207.5,63.5);
...
p.nominalBounds = new cjs.Rectangle(2.2,71.4,218.5,204.2);
...
(lib.Символ5 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.09,scaleY:1.09,x:18.5,y:58},14,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,x:19.2,y:59.8},15).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-86.5,28.9,207.5,63.5);
...
p.nominalBounds = new cjs.Rectangle(-138.9,28.9,329.8,260.8);
...
(lib.gamerall300x600 = function(mode,startPosition,loop) {
	...
	this.vopros2.setTransform(132.8,415,0.736,0.736,0,0,0,96.1,95.9);
