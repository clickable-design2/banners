...
(lib.Символ48 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#25E8E8").s().p("");
...
(lib.Символ44 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(27).call(this.frame_27).wait(47).call(this.frame_74).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},42).wait(33));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(42).to({_off:false},0).to({alpha:0.23},5,cjs.Ease.get(1)).to({alpha:0},5,cjs.Ease.get(1)).wait(1).to({alpha:0.23},5,cjs.Ease.get(1)).to({alpha:0},5,cjs.Ease.get(1)).wait(1).to({alpha:0.23},5,cjs.Ease.get(1)).to({alpha:0},5,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.people1).to({x:301.7},14).to({x:950.9},13).wait(1).to({x:-340.3},0).to({x:333.7},14,cjs.Ease.get(1)).wait(33));
...
(lib.truetest640x305 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		  ...
		  function fl_MouseOverHandler_5()
		{
			...
			_this.main.people.gotoAndPlay(29);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/elvis.png?1490791801749", id:"elvis"},
		{src:"images/ivan.png?1490791801749", id:"ivan"},
		{src:"images/jaz.png?1490791801749", id:"jaz"},
		{src:"images/koza.png?1490791801749", id:"koza"},
		{src:"images/maxresdefault.jpg?1490791801749", id:"maxresdefault"},
		{src:"images/monr.png?1490791801749", id:"monr"},
		{src:"images/nap.png?1490791801749", id:"nap"}
	],
	preloads: []
};
