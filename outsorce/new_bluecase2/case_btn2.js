...
(lib.Символ11 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#00AFEE").s().p("");
	this.shape.setTransform(95.3,44.2);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ11, new cjs.Rectangle(7.7,19.5,175.3,49.5), null);
...
(lib.Символ9 = function(mode,startPosition,loop) {
	...
	this.instance.cache(6,18,179,54);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ9, new cjs.Rectangle(-11.3,0.5,217,91), null);
...
(lib.Символ1 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00AFEE").s().p("A7LVpMAAAgrRMA2XAAAMAAAArRg");
	this.shape.setTransform(148.6,62.2);
...
p.nominalBounds = new cjs.Rectangle(155.2,151.7,217,92);
...
(lib.case_btn2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(169,134.9,0.943,0.943,0,0,0,142,-10);
	...
	this.knife.setTransform(170.1,81.4,0.932,0.932,-6,0,0,110,89.7);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(169.7,198.2,1.368,1.368,0,0,0,80.5,50.5);
	...
	this.flash.setTransform(-47.2,92.1,0.84,0.84,0,0,0,10.6,19.6);

	this.timeline.addTween(cjs.Tween.get(this.flash).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(184.6,127.6,274.8,295.5);
// library properties:
lib.properties = {
	width: 350,
	height: 280,
	...
	opacity: 0.00,
	manifest: [
		{src:"images/blue_case.png?1501585544747", id:"blue_case"},
		{src:"images/doppler.png?1501585544747", id:"doppler"},
		{src:"images/logopngкопия2.png?1501585544747", id:"logopngкопия2"},
		{src:"images/OPEN.png?1501585544747", id:"OPEN"}
	],
	preloads: []
};
