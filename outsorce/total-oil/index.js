...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1477323227983", id:"back"},
		{src:"images/bbbo.png?1477323227983", id:"bbbo"},
		{src:"images/car.png?1477323227983", id:"car"},
		{src:"images/headerlogototal.png?1477323227983", id:"headerlogototal"},
		{src:"images/Izo1.png?1477323227983", id:"Izo1"},
		{src:"images/O1.png?1477323227983", id:"O1"}
	]
};
...
(lib.Символ4 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#787773").ss(3,1,1).p("A3WThIAAgKAXXTXIAAAKAXXTXMgutAAAMAAAgm3MAutAAAg");
	this.shape.setTransform(142.5,91);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#787773").ss(3,1,1).p("A3WTXMAAAgm3MAutAAAMAAAAm3IAAAKA3WThIAAgKAXXTXMgutAAA");
	this.shape_1.setTransform(142.5,91);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("rgba(247,68,67,0.498)").ss(3,1,1).p("A3HzgMAuZAAAIAAAKIAKAAAXSTXIAAAKAXSzWMAAAAmtMgujAAAMAAAgm3IgKAAA3bThIAAgKIAKAA");
	this.shape_2.setTransform(143,91);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.shape_1}]},81).to({state:[{t:this.shape_2}]},1).wait(74));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(8).to({scaleX:1.3,scaleY:1.3,x:95.1,y:126.1},4,cjs.Ease.get(-1)).to({scaleX:1.14,scaleY:1.14,x:95,y:126},5,cjs.Ease.get(1)).wait(31).to({scaleX:1.3,scaleY:1.3,x:95.1,y:126.1},4,cjs.Ease.get(-1)).to({scaleX:1.14,scaleY:1.14,x:95,y:126},5,cjs.Ease.get(1)).wait(22).to({regY:12.8,x:-63.6,y:126.1},2,cjs.Ease.get(-1)).to({regX:69.6,regY:12.7,x:-301.7,y:126},3,cjs.Ease.get(1)).wait(66).to({regX:69.7,regY:12.8,x:-63.6,y:126.1},3,cjs.Ease.get(-1)).to({regY:12.7,x:95,y:126},2,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(81).to({x:458.3},3).wait(68).to({x:188.3},3).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(79).to({x:31},2,cjs.Ease.get(-1)).to({x:-69},3,cjs.Ease.get(1)).wait(66).to({x:31},3).to({x:52},2).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(79).to({_off:false},0).to({y:195.1},2,cjs.Ease.get(-1)).to({regX:65.2,regY:10.3,scaleX:1.08,scaleY:1.08,x:225,y:116.1},3,cjs.Ease.get(1)).wait(19).to({scaleX:1.16,scaleY:1.16,x:225.1},4).to({scaleX:1.08,scaleY:1.08,x:225},4).wait(21).to({scaleX:1.16,scaleY:1.16,x:225.1},4).to({scaleX:1.08,scaleY:1.08,x:225},4).wait(10).to({scaleX:1.05,scaleY:1.05,x:213.4,y:166.9},2,cjs.Ease.get(-1)).to({regX:79.9,regY:14,scaleX:1,scaleY:1,x:195.9,y:243.1},3,cjs.Ease.get(0.99)).wait(1));

	// ВАШЕЙ
	this.instance_6 = new lib.Символ13();
	this.instance_6.parent = this;
	this.instance_6.setTransform(362.4,94.1,1,1,0,0,0,54.4,14);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(79).to({_off:false},0).to({x:300.4},2,cjs.Ease.get(-1)).to({regX:80.4,regY:-4,x:269.4,y:90.1},3,cjs.Ease.get(1)).wait(15).to({scaleX:1.14,scaleY:1.14,x:269.5},4).to({scaleX:1,scaleY:1,x:269.4},4).wait(21).to({scaleX:1.14,scaleY:1.14,x:269.5},4).to({scaleX:1,scaleY:1,x:269.4},4).wait(14).to({x:299.8},2,cjs.Ease.get(-1)).to({x:459.4},3,cjs.Ease.get(-1)).wait(1));

	// Слой 4
	this.instance_7 = new lib.Символ20();
	this.instance_7.parent = this;
	this.instance_7.setTransform(369.5,110.1,1,1,0,0,0,8.5,16.4);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(79).to({_off:false},0).to({x:311.5,y:102.1},2,cjs.Ease.get(-1)).to({x:239.5,y:90.1},3,cjs.Ease.get(1)).wait(11).to({regX:8.6,scaleX:1.31,scaleY:1.31,x:239.7},4).to({regX:8.5,scaleX:1,scaleY:1,x:239.5},4).wait(21).to({regX:8.6,scaleX:1.31,scaleY:1.31,x:239.7},4).to({regX:8.5,scaleX:1,scaleY:1,x:239.5},4).wait(18).to({x:269.9},2,cjs.Ease.get(-1)).to({x:429.5},3,cjs.Ease.get(-1)).wait(1));

	// ДЛЯ
	this.instance_8 = new lib.Символ14();
	this.instance_8.parent = this;
	this.instance_8.setTransform(414.3,64.1,1,1,0,0,0,32.3,14);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(79).to({_off:false},0).to({x:328.3},2,cjs.Ease.get(-1)).to({regX:-26.7,regY:26,x:196.3,y:89.1},3,cjs.Ease.get(1)).wait(7).to({regY:26.1,scaleX:1.27,scaleY:1.27,y:89.2},4).to({regY:26,scaleX:1,scaleY:1,y:89.1},4).wait(21).to({regY:26.1,scaleX:1.27,scaleY:1.27,y:89.2},4).to({regY:26,scaleX:1,scaleY:1,y:89.1},4).wait(22).to({x:226.7},2,cjs.Ease.get(-1)).to({x:386.3},3,cjs.Ease.get(-1)).wait(1));

	// ЛУЧШЕЕ
	this.instance_9 = new lib.Символ15();
	this.instance_9.parent = this;
	this.instance_9.setTransform(367.7,27.1,1,1,0,0,0,62.7,14);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(79).to({_off:false},0).to({x:301.7},2,cjs.Ease.get(-1)).to({regX:63,regY:14.2,scaleX:1.24,scaleY:1.24,x:237.4,y:23.6},3,cjs.Ease.get(1)).wait(66).to({scaleX:1.15,scaleY:1.15,x:289.5,y:25},2,cjs.Ease.get(-1)).to({regX:62.7,regY:14,scaleX:1,scaleY:1,x:367.7,y:27.1},3,cjs.Ease.get(0.99)).wait(1));

	// ВСЕ
	this.instance_10 = new lib.Символ16();
	this.instance_10.parent = this;
	this.instance_10.setTransform(250.2,-90.9,1,1,0,0,0,30.2,14);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(79).to({_off:false},0).to({y:-38.9},2,cjs.Ease.get(-1)).to({regX:7.5,regY:44.7,scaleX:1.2,scaleY:1.2,x:226.8,y:-2.3},3,cjs.Ease.get(1)).wait(66).to({scaleX:1.12,scaleY:1.12,x:236.2,y:-37.8},2,cjs.Ease.get(-1)).to({regX:30.2,regY:14,scaleX:1,scaleY:1,x:250.2,y:-90.9},3,cjs.Ease.get(0.99)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(79).to({_off:false},0).to({y:245},2,cjs.Ease.get(-1)).to({y:173},3,cjs.Ease.get(1)).wait(66).to({y:245},3,cjs.Ease.get(-1)).to({y:293},2,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(79).to({_off:false},0).to({x:-68.5,y:59.9},2,cjs.Ease.get(-1)).to({x:66.5,y:57.5},3,cjs.Ease.get(1)).wait(66).to({x:-68.5,y:59.9},3,cjs.Ease.get(-1)).to({x:-158.5,y:61.5},2,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(79).to({regY:210.9,scaleX:0.96,scaleY:0.96,rotation:44.9,x:-66.4,y:29.1},2,cjs.Ease.get(-1)).to({regY:211,scaleX:0.96,scaleY:0.96,rotation:45,x:-258.5,y:23.1},3,cjs.Ease.get(1)).wait(66).to({regY:210.9,scaleX:0.96,scaleY:0.96,rotation:44.9,x:-66.4,y:29.1},3,cjs.Ease.get(-1)).to({regY:211,scaleX:0.96,scaleY:0.96,rotation:45,x:61.5,y:33.1},2,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(79).to({_off:false},0).to({x:204.8,y:155.7},5,cjs.Ease.get(-1)).wait(72));
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-132,-61);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-80.8,-98.1,578.4,578.4);
