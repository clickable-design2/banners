...
(lib.Символ39 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#3399FF","#00CCFF"],[0.486,0.486],0,-10.1,0,10.2).s().p("AAmB6IAAi6IhLAAIAAC6IhAAAIAAj0IDLAAIAAD0g");
	this.shape.setTransform(64.2,21.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#3399FF","#00CCFF"],[0.486,0.486],0,-12,0,12.1).s().p("");
	this.shape_1.setTransform(38.2,21.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#3399FF","#00CCFF"],[0.486,0.486],0,-12.6,0,12.7).s().p("AA8B8IgOgfIhbAAIgOAfIhDAAIAAgJIBxjuIAcAAIBwDuIAAAJgAgYAoIAyAAIgag6g");
	this.shape_2.setTransform(89.2,21.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#3399FF","#00CCFF"],[0.486,0.486],0,-12,0,12.1).s().p("");
	this.shape_3.setTransform(114.9,21.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["#3399FF","#00CCFF"],[0.486,0.486],0,-10.5,0,10.6).s().p("AhpB7IAAj0IBAAAIAAB3IB/h4IAUAAIAAD1IhAAAIAAh+IiAB+g");
	this.shape_4.setTransform(141.3,21.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.lf(["#3399FF","#00CCFF"],[0.486,0.486],0,-11.9,0,12).s().p("AA4B7IAAhxIg0A2IgHAAIg0g2IAABxIhAAAIAAj1IAXAAIBgBqIBhhqIAXAAIAAD1g");
	this.shape_5.setTransform(177.5,21.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#3399FF","#00CCFF"],[0.486,0.486],0,-11.4,0,11.4).s().p("AgzB9QgbgEgRgHIAJgtQATAHAKgDQAFgBAFgFQAGgGAEgJIAIgSIhUiWIAAgIIBGAAIAuBeIACAAIApheIBEAAIAAAHIhYCzQgKAXgKANQgKAOgOAHQgHADgIACIgNABIgFAAg");
	this.shape_6.setTransform(203.6,22);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["#3399FF","#00CCFF"],[0.486,0.486],0.3,-15.4,0.3,20.1).s().p("");
	this.shape_7.setTransform(233.2,21.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.lf(["#3399FF","#00CCFF"],[0.486,0.486],0,-10.5,0,10.6).s().p("AhpB7IAAj0IBAAAIAAB3IB/h4IAUAAIAAD1IhAAAIAAh+IiAB+g");
	this.shape_8.setTransform(264.9,21.8);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.lf(["#3399FF","#00CCFF"],[0.486,0.486],0,-11,0,11).s().p("AAmB8Ig1hfQgHABgYAAIAABeIg/AAIAAj0IA/AAIAABgIATgBQAMAAAFgDQAIgEAEgMQADgJAGgZQADgMAGgJQAHgKAKgGQALgGAPgCQAQgBAVAEIAAArQgNgBgGAEQgIAEgDALQgGAXgHAPQgHAQgKAKIBGBtIAAAKg");
	this.shape_9.setTransform(291.7,21.7);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.lf(["#3399FF","#00CCFF"],[0.486,0.486],0,-12.6,0,12.7).s().p("AA8B8IgOgfIhbAAIgOAfIhDAAIAAgJIBxjuIAcAAIBwDuIAAAJgAgYAoIAyAAIgag6g");
	this.shape_10.setTransform(315.6,21.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.lf(["#3399FF","#00CCFF"],[0.486,0.486],-3,-7.5,-3,-0.6).s().p("AgYAXQgKgJAAgOQAAgGADgGQADgGAEgEQAKgJAOAAQAPAAAJAJQAFAEADAGQADAGAAAGQAAAHgDAGQgDAGgFAEQgJAJgPAAQgOAAgKgJg");
	this.shape_11.setTransform(333.6,31.4);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.lf(["#3399FF","#00CCFF"],[0.486,0.486],0,-3.5,0,3.5).s().p("AgcBZIgGixIBFAAIgECxg");
	this.shape_12.setTransform(333.5,18.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ39, new cjs.Rectangle(26.2,9.3,310.9,25.4), null);
...
(lib.Символ38 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#00CCFF","#3399FF"],[0.459,0.463],0,-1.8,0,1.9).s().p("");
	this.shape.setTransform(7.1,12.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#00CCFF","#3399FF"],[0.459,0.463],0,-1.8,0,1.8).s().p("AgdB4IAAi4Ig7AAIAAg3ICxAAIAAA3Ig6AAIAAC4g");
	this.shape_1.setTransform(29.5,12.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#00CCFF","#3399FF"],[0.459,0.463],0,-1.8,0,1.9).s().p("AhfB4IAAjvIBpAAQALAAAKACQAJACAIAEQAQAHALAOQALAMAFAQQAGAQgBARQAAARgFAOQgGAQgKAMQgMAOgPAGQgYAIgOAAIgqAAIAAA+gAghADIArAAQAMAAAIgKQAHgKAAgNQAAgOgHgKQgIgKgMAAIgrAAg");
	this.shape_2.setTransform(51.2,12.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#00CCFF","#3399FF"],[0.459,0.463],0,-1.8,0,1.9).s().p("AhLB4IAAjvICVAAIAAA2IhYAAIAAAjIBQAAIAAA2IhQAAIAAAmIBaAAIAAA6g");
	this.shape_3.setTransform(71.8,12.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["#00CCFF","#3399FF"],[0.459,0.463],-0.1,-1.8,-0.1,1.8).s().p("AhtB2IAAgtIARgBQAGAAAEgEQAFgFADgUIAQiiICoAAIAADuIg+AAIAAi3IgzAAIgJBtQgCAbgGAPQgHAQgKAIQgLAIgTABIgMAAQgNAAgRgCg");
	this.shape_4.setTransform(92.7,12.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.lf(["#00CCFF","#3399FF"],[0.459,0.463],0,-10.1,0,10.2).s().p("AAnB4IAAhMIghAAIgoBMIhCAAIAAgJIAvhNQgJgFgHgIQgHgIgEgJQgEgHgDgLQgCgKAAgKQAAgQAFgPQAGgPAKgMQAMgNAPgGIASgGQAJgBALgBIBoAAIAADvgAgWg4QgHAIABAMQgBAMAHAJQAIAKALAAIArAAIAAg8IgrAAQgMAAgHAJg");
	this.shape_5.setTransform(117.3,12.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#00CCFF","#3399FF"],[0.459,0.463],0,-10.3,0,10.4).s().p("AhmB4IAAjuIA+AAIAAB1IB8h2IATAAIAADvIg+AAIAAh6Ih9B6g");
	this.shape_6.setTransform(142.9,12.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["#00CCFF","#3399FF"],[0.459,0.463],0,-9.5,0,9.6).s().p("AheB3IAAjtIBoAAQAQAAAPAFQANAEALAKQAKAKAFANQAGAOAAARQAAALgGAMQgFALgKAHQAIADAGAGIAJALQAIAOAAAQQAAAQgGANQgEANgJAKQgLAKgOAGQgOAGgTgBgAggBBIAwAAQAIAAAEgGQAFgEABgJQAAgIgFgGQgFgGgJAAIgvAAgAgggYIAmAAQAIAAAFgGQAGgGAAgHQAAgJgGgFQgEgIgJABIgmAAg");
	this.shape_7.setTransform(176.1,12.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.lf(["#00CCFF","#3399FF"],[0.459,0.463],0,-11.7,0,11.7).s().p("AA3B4IAAhuIgzA1IgHAAIgzg1IAABuIg+AAIAAjvIAWAAIBeBoIBfhoIAWAAIAADvg");
	this.shape_8.setTransform(209.4,12.8);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.lf(["#00CCFF","#3399FF"],[0.459,0.463],-0.1,-10.3,-0.1,10.4).s().p("AhmB4IAAjuIA+AAIAAB1IB8h2IAUAAIAADvIg/AAIAAh6Ih9B6g");
	this.shape_9.setTransform(236.6,12.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.lf(["#00CCFF","#3399FF"],[0.459,0.463],0,-15.1,0,15.2).s().p("AiXB4IAAjvIA+AAIAAC2IA7AAIAAi2IA9AAIAAC2IA6AAIAAi2IA/AAIAADvg");
	this.shape_10.setTransform(267.2,12.9);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.lf(["#00CCFF","#3399FF"],[0.459,0.463],0.4,-6.1,0.4,10.1).s().p("AgcBXIgFitIBDAAIgECtg");
	this.shape_11.setTransform(312.6,9.5);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.lf(["#00CCFF","#3399FF"],[0.459,0.463],-0.1,-7.4,-0.1,-0.7).s().p("AgXAXQgKgJAAgOQAAgGADgGQACgFAFgEQAJgJAOAAQAOAAAKAJQAEAEADAFQADAGAAAGQAAAHgDAHQgDAFgEAEQgKAJgOAAQgOAAgJgJg");
	this.shape_12.setTransform(312.7,22.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.lf(["#00CCFF","#3399FF"],[0.459,0.463],0,-11.2,0,11.1).s().p("AgxB6QgbgFgRgGIAJgsQATAHAJgDQAGgBAEgFQAGgGAEgIIAIgSIhTiTIAAgHIBFAAIAtBcIACAAIAohcIBDAAIAAAGIhXCvQgJAWgKANQgKAOgNAHIgPAFIgNABIgEAAg");
	this.shape_13.setTransform(296.2,13.1);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.lf(["#00CCFF","#3399FF"],[0.459,0.463],0.1,-2.1,0.1,9.3).s().p("AgXAaQgKgDgIgIQgHgHgEgKQgDgKgBgOIAhgDQABAJAGAGQAGADAKAAQAJAAAHgDQAFgFACgKIAiADQAAAOgEAKQgFAKgGAHQgJAIgJADQgKAEgOAAQgMAAgLgEg");
	this.shape_14.setTransform(144,-3.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ38, new cjs.Rectangle(-4.7,-6.3,320.8,31.7), null);
...
(lib.Символ21 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("Eg0aAaBMAAAg0BMBo1AAAMAAAA0Bg");
	this.shape.setTransform(335.5,166.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ21, new cjs.Rectangle(0,0,671,333.1), null);
...
(lib.Символ16 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(1219,10,0.79,0.79);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-1,10,0.79,0.79);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ16, new cjs.Rectangle(-1,10,2476.1,316.2), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ8, new cjs.Rectangle(0,0,53.7,64.7), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ7, new cjs.Rectangle(0,0,121,83), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ6, new cjs.Rectangle(0,0,154,78), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ5, new cjs.Rectangle(0,0,114,108), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ4, new cjs.Rectangle(0,0,152,145), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ3, new cjs.Rectangle(0,0,104,88), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ2, new cjs.Rectangle(0,0,62,70), null);
...
(lib.Символ44 = function(mode,startPosition,loop) {
	...
	this.buble.setTransform(41.6,20.8,1,1,0,0,0,41.6,20.8);
	this.buble.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.buble).wait(4).to({alpha:1},0).wait(1));
...
p.nominalBounds = new cjs.Rectangle(26.2,9.3,310.9,25.4);
...
p.nominalBounds = new cjs.Rectangle(-4.7,-6.3,320.8,31.7);
...
(lib.Символ23 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:31.7},9).to({y:-70.3},10).wait(1));
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00051F").s().p("EggoAKSICCyAMA8jgGoICsctg");
	this.shape.setTransform(164.2,-3.6);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(20));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-44.6,-95.5,417.8,183.8);
...
(lib.Символ15 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(326.4,165.8,1,1,0,0,0,335.4,166.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(570.8,163.1,1,1,0,0,0,570.8,163.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-648.2},79).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-9,-0.7,2484.1,333.1);
...
p.nominalBounds = new cjs.Rectangle(0,0,338,250.3);
...
(lib.man = function(mode,startPosition,loop) {
	...
	// Слой 3
	this.buble = new lib.Символ44();
	this.buble.parent = this;
	this.buble.setTransform(9.1,-29.2,1,1,0,0,0,41.6,20.8);

	this.timeline.addTween(cjs.Tween.get(this.buble).wait(19));
...
p.nominalBounds = new cjs.Rectangle(-32.5,-50,157.1,190.4);
...
(lib.Символ1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(8,46.7,1,1,0,0,0,169,125.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:20},7,cjs.Ease.get(-1)).to({x:32},7,cjs.Ease.get(1)).to({x:8},10).to({x:34.2},7,cjs.Ease.get(-1)).to({x:64},8,cjs.Ease.get(1)).to({x:8},5).to({x:16},5,cjs.Ease.get(-1)).to({x:24},5,cjs.Ease.get(1)).to({x:16.6},7,cjs.Ease.get(-1)).to({x:8},8,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.man).to({x:300.2},7,cjs.Ease.get(-1)).to({x:316.2},7,cjs.Ease.get(1)).to({x:284.2},10).wait(20).to({x:304.2},5,cjs.Ease.get(-1)).to({x:324.2},5,cjs.Ease.get(1)).to({x:305.6},7,cjs.Ease.get(-1)).to({x:284.2},8,cjs.Ease.get(1)).wait(1));
...
(lib.misha = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		function fl_Clickover()
		{
			...
			_this.pers.man.buble.gotoAndPlay(1);
		...
		function fl_Clickout()
		{
			...
			_this.pers.man.buble.gotoAndPlay(5);
	...
	this.mouse.parent = this;
	this.mouse.setTransform(92.2,24.8,1,1,0,0,0,82.5,16.6);
...
p.nominalBounds = new cjs.Rectangle(304,64.4,2484.1,407.1);
// library properties:
lib.properties = {
	width: 640,
	height: 305,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bedro.png?1496220670157", id:"bedro"},
		{src:"images/bg.jpg?1496220670157", id:"bg"},
		{src:"images/bullet.png?1496220670157", id:"bullet"},
		{src:"images/galstuk.png?1496220670157", id:"galstuk"},
		{src:"images/golova.png?1496220670157", id:"golova"},
		{src:"images/kaplya.png?1496220670157", id:"kaplya"},
		{src:"images/lev1.png?1496220670157", id:"lev1"},
		{src:"images/lev2.png?1496220670157", id:"lev2"},
		{src:"images/lev3.png?1496220670157", id:"lev3"},
		{src:"images/morda.png?1496220670157", id:"morda"},
		{src:"images/noga.png?1496220670157", id:"noga"},
		{src:"images/prav1.png?1496220670157", id:"prav1"},
		{src:"images/prav2.png?1496220670157", id:"prav2"},
		{src:"images/prav3.png?1496220670157", id:"prav3"},
		{src:"images/rifle.png?1496220670157", id:"rifle"},
		{src:"images/telo.png?1496220670157", id:"telo"},
		{src:"images/tushka.png?1496220670157", id:"tushka"},
		{src:"images/w256h2561380453915MouseOptions256x25632.png?1496220670157", id:"w256h2561380453915MouseOptions256x25632"}
	],
	preloads: []
};
