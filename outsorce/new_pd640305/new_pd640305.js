...
(lib.Символ57 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(255,255,255,0)","#FFFFFF","rgba(255,255,255,0)"],[0,0.502,1],-31.2,0,31.3,0).s().p("Ak3O+IAA97IJvAAIAAd7g");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ57, new cjs.Rectangle(-31.2,-95.7,62.5,191.6), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ56, new cjs.Rectangle(-31.2,-95.7,62.5,191.6), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ37, new cjs.Rectangle(-274.4,-108.3,408.2,193.8), null);
...
(lib.Символ42 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:0.85,scaleY:0.85,y:5},7,cjs.Ease.get(1)).to({scaleX:1.1,scaleY:1.1,y:0},4).to({scaleX:0.97,scaleY:0.97},3).to({scaleX:1.02,scaleY:1.02},3).to({scaleX:0.99,scaleY:0.99},3).to({scaleX:1,scaleY:1},3).wait(27));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-274.4,-108.3,408.2,193.8);
...
(lib.Символ11 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(270.8,28.7);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(271.1,-105.7);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1494853810163", id:"bg"},
		{src:"images/card.png?1494853810163", id:"card"},
		{src:"images/dama.png?1494853810163", id:"dama"},
		{src:"images/dev2.png?1494853810163", id:"dev2"},
		{src:"images/fishka.png?1494853810163", id:"fishka"},
		{src:"images/logo.png?1494853810163", id:"logo"},
		{src:"images/ruka.png?1494853810163", id:"ruka"},
		{src:"images/ruka1.png?1494853810163", id:"ruka1"}
	],
	preloads: []
};
