...
(lib.Символ55 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ55, new cjs.Rectangle(-167.6,-33.5,335.3,67.1), null);
...
(lib.Символ53 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0.3,7.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:0.82,scaleY:0.82},19,cjs.Ease.get(1)).to({scaleX:1,scaleY:1},20,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-167.3,-26.2,335.3,67.1);
...
(lib.Символ47 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-113.3,-36.4,1.242,1.242,0,0,0,-97.2,-31.4);
...
p.nominalBounds = new cjs.Rectangle(-410.6,-282.7,594.5,492.8);
...
}).prototype = getMCSymbolPrototype(lib.Символ52, new cjs.Rectangle(-299.4,-206.8,423,350.7), null);
...
p.nominalBounds = new cjs.Rectangle(-441,-199.1,583,396.6);
...
p.nominalBounds = new cjs.Rectangle(160,71.3,815.3,458.9);
// library properties:
lib.properties = {
	width: 600,
	height: 300,
