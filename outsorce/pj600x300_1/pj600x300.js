...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bezd.png?1475681655348", id:"bezd"},
		{src:"images/cards.png?1475681655348", id:"cards"},
		{src:"images/d10.png?1475681655348", id:"d10"},
		{src:"images/dar.png?1475681655348", id:"dar"},
		{src:"images/fon.jpg?1475681655348", id:"fon"},
		{src:"images/pj123_03.png?1475681655348", id:"pj123_03"},
		{src:"images/pj_01.png?1475681655348", id:"pj_01"},
		{src:"images/pj_03.png?1475681655348", id:"pj_03"},
		{src:"images/pj_07.png?1475681655348", id:"pj_07"},
		{src:"images/pj_09.png?1475681655348", id:"pj_09"},
		{src:"images/pj_11.png?1475681655348", id:"pj_11"},
		{src:"images/pok.png?1475681655348", id:"pok"},
		{src:"images/ruka.png?1475681655348", id:"ruka"},
		{src:"images/tolko.png?1475681655348", id:"tolko"}
	]
};
...
p.nominalBounds = new cjs.Rectangle(0,0,82,60);
...
(lib.Символ41 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-47.3,-18.4,1,1,-15);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-47.3,-39.6,94.8,79.2);
...
(lib.Символ42 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("AqRg3ISfmAICEGVQsgCYlQFCg");
	mask.setTransform(1.8,-7.2);
...
p.nominalBounds = new cjs.Rectangle(-47.3,-39.6,94.8,76.5);
...
(lib.Символ24 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(29).to({y:23},15,cjs.Ease.get(1)).wait(1));
...
(lib.Символ22 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(19).to({x:0,y:19,alpha:1},15,cjs.Ease.get(1)).wait(1));
...
(lib.Символ20 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({y:16,alpha:1},15,cjs.Ease.get(1)).wait(1));
...
(lib.Символ11 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#5D120F").s().p("AkXBMQgPgDBOgfQBOggB1gZQBxgdBcgQQBbgRAHADQAIAChFALQhEAMiFAdQiEAahNAlQhIAhgQAAIgCAAg");
	this.shape.setTransform(13.9,-0.8);
	...
	this.instance.parent = this;
	this.instance.setTransform(11.5,-9.4,0.874,0.874,8.2,0,0,0.1,-0.2);
...
(lib.Символ25 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:17.5,alpha:1},9).wait(1).to({y:333.6,alpha:0},9).wait(1));

	// Слой 10
	this.instance_3 = new lib.Символ39();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-184.5,-112.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:-15},9,cjs.Ease.get(1)).wait(1).to({x:-184.5},9).wait(1));
