...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/active1.png?1486460457286", id:"active1"},
		{src:"images/hover1.png?1486460457286", id:"hover1"},
		{src:"images/normal1.png?1486460457286", id:"normal1"},
		{src:"images/OpenSteamTrade2.png?1486460457286", id:"OpenSteamTrade2"},
		{src:"images/OpenSteamTrade2pngкопия.png?1486460457286", id:"OpenSteamTrade2pngкопия"},
		{src:"images/OpenSteamTrade2pngкопия2.png?1486460457286", id:"OpenSteamTrade2pngкопия2"}
	]
};
...
(lib.OpenSteamTrade2 = function() {
	this.initialize(img.OpenSteamTrade2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,204,24);


(lib.OpenSteamTrade2pngкопия = function() {
	this.initialize(img.OpenSteamTrade2pngкопия);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,204,24);


(lib.OpenSteamTrade2pngкопия2 = function() {
	this.initialize(img.OpenSteamTrade2pngкопия2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,204,24);
...
(lib.Символ12 = function(mode,startPosition,loop) {
	...
	// Слой 5
	this.instance = new lib.OpenSteamTrade2pngкопия();
	this.instance.parent = this;
	this.instance.setTransform(12,15,0.958,0.958);
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	// Слой 3
	this.instance = new lib.OpenSteamTrade2();
	this.instance.parent = this;
	this.instance.setTransform(17,18,0.96,0.96);
...
(lib.Символ6 = function(mode,startPosition,loop) {
	...
	// Слой 5
	this.instance = new lib.OpenSteamTrade2pngкопия2();
	this.instance.parent = this;
	this.instance.setTransform(15,18,0.96,0.96);
...
(lib.Символ2 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(154.1,46.5,1,1,0,0,0,100,27.5);
