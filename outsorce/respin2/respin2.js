...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/active.png?1485957058209", id:"active"},
		{src:"images/normal.png?1485957058209", id:"normal"},
		{src:"images/ReSpin_2.png?1485957058209", id:"ReSpin_2"},
		{src:"images/strelka.png?1485957058209", id:"strelka"}
	]
};
...
(lib.ReSpin_2 = function() {
	this.initialize(img.ReSpin_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,186,77);
...
(lib.Символ4 = function(mode,startPosition,loop) {
	...
	// Слой 3
	this.instance = new lib.ReSpin_2();
	this.instance.parent = this;
	this.instance.setTransform(-19,-15,0.688,0.688);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-19,-15,128.1,53);
