...
(lib.kz1 = function() {
	this.initialize(img.kz1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,444,89);
...
(lib.Символ51 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#CA2036").s().p("");
	this.shape.setTransform(43.9,25.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ51, new cjs.Rectangle(-76,-43.8,152,87.6), null);
...
(lib.Символ49 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ49, new cjs.Rectangle(-58.1,-14.3,116.3,28.6), null);
...
(lib.Символ48 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.instance = new lib.kz1();
	this.instance.parent = this;
	this.instance.setTransform(7,-43,0.458,0.458);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ48, new cjs.Rectangle(7,-43,203.2,40.8), null);
...
(lib.Символ46 = function(mode,startPosition,loop) {
	...
	// Слой 1 - копия
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Слой 1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#610000").s().p("");
	this.shape_1.setTransform(0,1.2);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ46, new cjs.Rectangle(-63.1,-14,126.4,29.2), null);
...
(lib.Символ23 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0.09},7,cjs.Ease.get(-1)).to({alpha:0},7,cjs.Ease.get(1)).to({alpha:0.09},8,cjs.Ease.get(-1)).to({alpha:0.172},7,cjs.Ease.get(1)).wait(1));
...
(lib.Символ18 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(59.1,11.8,0.6,0.6,0,0,0,0,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ18, new cjs.Rectangle(21.2,3.4,75.8,17.5), null);
...
(lib.Символ15 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:408.3,y:221.1},22).wait(75));
...
}).prototype = getMCSymbolPrototype(lib.Символ14, new cjs.Rectangle(0,0,176,180), null);
...
(lib.Символ9 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(173.1,83,1.702,1.702,0,0,0,0.1,0.1);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(136.3,23.4);

	// Слой 2
	this.instance_1 = new lib.Символ15();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-40.1,-37.7,1,1,0,0,0,103.5,103.5);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(64.5,50);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ9, new cjs.Rectangle(71.5,7,203.2,100.2), null);
...
(lib.Символ50 = function(mode,startPosition,loop) {
	...
	// Слой 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FF0000").ss(2,1,1).p("AAAGYIAAsv");
	...
	this.instance.parent = this;
	this.instance.setTransform(94.1,7.4,0.969,0.969,0,0,0,0.1,0.1);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-83.4,5.3,0.776,0.776,0,0,0,173.1,53.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ50, new cjs.Rectangle(-310.7,-129.7,478.3,180.5), null);
...
(lib.kazah_640x305 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(261.2,41.8,1.051,1.051,0,0,0,160.6,35.5);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(242.9,88,0.888,0.888,0,0,0,0.2,10.2);

	this.instance_3 = new lib.Символ42();
	this.instance_3.parent = this;
	this.instance_3.setTransform(534.2,158.4,1,1,0,0,0,82.9,84.7);
	...
	this.instance_5.setTransform(528.1,36,0.74,0.74,0,0,0,129.1,29);

	this.card = new lib.Символ2();
	this.card.parent = this;
	this.card.setTransform(60.1,167.6,0.809,0.809,0,0,0,99.7,150.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.card},{t:this.instance_5},{t:this.instance_4}]}).wait(1));

	// Слой 7
	this.instance_6 = new lib.j();
	this.instance_6.parent = this;
	this.instance_6.setTransform(323,180.5,1,1,0,0,0,350,233.5);
	...
	this.instance_7.setTransform(320,152.6,1,1,0,0,0,322.5,157);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(128.1,-9.8,865,576.4);
// library properties:
lib.properties = {
	width: 640,
	height: 305,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back_card.png?1492601791804", id:"back_card"},
		{src:"images/bg.jpg?1492601791804", id:"bg"},
		{src:"images/btn.jpg?1492601791804", id:"btn"},
		{src:"images/chip11.png?1492601791804", id:"chip11"},
		{src:"images/king.jpg?1492601791804", id:"king"},
		{src:"images/kz1.png?1492601791804", id:"kz1"},
		{src:"images/logo.png?1492601791804", id:"logo"},
		{src:"images/queen.jpg?1492601791804", id:"queen"},
		{src:"images/uzor.png?1492601791804", id:"uzor"},
		{src:"images/valet.jpg?1492601791804", id:"valet"}
	],
	preloads: []
};
