...
(lib.Символ54 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(58.7,8.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ54, new cjs.Rectangle(-109.5,-20.3,336.4,58.4), null);
...
(lib.Символ53 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(0.3,7.4);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ53, new cjs.Rectangle(-167.3,-26.2,335.3,67.1), null);
...
(lib.Символ47 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(6.5,56.2);
	...
	this.instance_1.setTransform(-52,-10.1);
	...
	this.instance_2.setTransform(6.7,-57.4,1.019,1.019,0,0,0,0,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regY:-0.2,scaleX:1.13,scaleY:1.13,y:-57.5},6,cjs.Ease.get(-1)).to({regX:-0.1,regY:-0.1,scaleX:1.27,scaleY:1.27,x:6.5,y:-57.4},8,cjs.Ease.get(1)).to({regX:0,scaleX:1.16,scaleY:1.16,x:6.7},7,cjs.Ease.get(-1)).to({scaleX:1.02,scaleY:1.02},8,cjs.Ease.get(1)).wait(1));

	// Символ 48
	this.instance_3 = new lib.Символ48();
	this.instance_3.parent = this;
	this.instance_3.setTransform(6.6,-97.4,0.979,0.979);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({scaleX:0.91,scaleY:0.91},6,cjs.Ease.get(-1)).to({regX:0.1,regY:-0.1,scaleX:0.81,scaleY:0.81,x:6.7,y:-97.5},8,cjs.Ease.get(1)).to({scaleX:0.89,scaleY:0.89},7,cjs.Ease.get(-1)).to({regX:0,regY:0,scaleX:0.98,scaleY:0.98,x:6.6,y:-97.4},8,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-161.5,-103.6,336.4,200.7);
...
(lib.Символ52 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-7.4,-5.7,0.712,0.712,0,0,0,-0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ52, new cjs.Rectangle(-122.2,-79.5,239.4,142.8), null);
...
(lib.Символ46 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-260.1,9.6,1,1,0,0,0,-118.5,-1.7);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-120.1,alpha:1},7,cjs.Ease.get(1)).wait(1).to({x:-260.1,alpha:0},7,cjs.Ease.get(1)).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-336.4,-199.1,478.5,396.6);
...
p.nominalBounds = new cjs.Rectangle(256.1,71.3,719.2,458.9);
// library properties:
lib.properties = {
	width: 600,
	height: 300,
