...
(lib.Символ48 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
...
}).prototype = getMCSymbolPrototype(lib.Символ12, new cjs.Rectangle(-138,-99,276,198), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ47, new cjs.Rectangle(-123,-10.7,250,27), null);
...
(lib.Символ13 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-2},3,cjs.Ease.get(-1)).to({y:-4.8},4,cjs.Ease.get(1)).to({y:-2.7},3,cjs.Ease.get(-1)).to({y:0},4,cjs.Ease.get(1)).wait(1));
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	this.instance_6.setTransform(-10.9,109.1,0.91,0.91,0,0,180,0,0.1);
	...
	this.instance_7.setTransform(881.2,47);

	this.instance_8 = new lib.Символ9();
	this.instance_8.parent = this;
	this.instance_8.setTransform(239.6,47);
	...
	this.instance_9.setTransform(388,56.5,0.777,0.777);

	this.instance_10 = new lib.Символ11();
	this.instance_10.parent = this;
	this.instance_10.setTransform(-253.6,56.5,0.777,0.777);
	...
	this.instance_11.setTransform(783.2,72.1,1.35,1.35);

	this.instance_12 = new lib.Символ15();
	this.instance_12.parent = this;
	this.instance_12.setTransform(141.6,72.1,1.35,1.35);
	...
	this.instance_13.setTransform(491.6,66.1);

	this.instance_14 = new lib.Символ17();
	this.instance_14.parent = this;
	this.instance_14.setTransform(-150,66.1);
...
(lib.Символ44 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(41).call(this.frame_41).wait(70).call(this.frame_111).wait(1));

	// Слой 4
	this.instance = new lib.Символ53();
	this.instance.parent = this;
	this.instance.setTransform(248,-52.2,0.708,0.708,-11.8,0,0,0.1,0.1);

	this.instance_1 = new lib.Символ53();
	this.instance_1.parent = this;
	this.instance_1.setTransform(406.9,-66.9,0.708,0.708,33.2);

	this.instance_2 = new lib.Символ53();
	this.instance_2.parent = this;
	this.instance_2.setTransform(312.2,-59.7,0.708,0.708);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},79).wait(33));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(79).to({_off:false},0).to({alpha:0.23},5,cjs.Ease.get(1)).to({alpha:0},5,cjs.Ease.get(1)).wait(1).to({alpha:0.23},5,cjs.Ease.get(1)).to({alpha:0},5,cjs.Ease.get(1)).wait(1).to({alpha:0.23},5,cjs.Ease.get(1)).to({alpha:0},5,cjs.Ease.get(1)).wait(1));

	// Слой 1
	this.instance_4 = new lib.Символ7();
	this.instance_4.parent = this;
	this.instance_4.setTransform(333.7,-59);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:301.7},14).to({x:950.9},27).wait(1).to({x:-340.3},0).to({x:333.7},37,cjs.Ease.get(1)).wait(33));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/elvis.png?1490789069123", id:"elvis"},
		{src:"images/ivan.png?1490789069123", id:"ivan"},
		{src:"images/koza.png?1490789069123", id:"koza"},
		{src:"images/maxresdefault.jpg?1490789069123", id:"maxresdefault"},
		{src:"images/monr.png?1490789069123", id:"monr"},
		{src:"images/nap.png?1490789069123", id:"nap"}
	],
	preloads: []
};
