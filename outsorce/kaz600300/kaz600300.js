...
p.nominalBounds = new cjs.Rectangle(0,0,89,20);
...
(lib.Символ49 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ49, new cjs.Rectangle(-131.4,-12.4,262.8,24.9), null);
...
(lib.Символ26 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#E2292B").ss(2.8,1,1).p("A8n2JMBJpAAAMAAAAsTMhaDAAAMAAAgnf");
...
(lib.Символ16 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-44.5,-10);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ16, new cjs.Rectangle(-44.5,-10,89,20), null);
...
(lib.Символ39 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:9.4},16,cjs.Ease.get(-1)).to({y:20},18,cjs.Ease.get(1)).to({y:10.3},17,cjs.Ease.get(-1)).to({y:0},18,cjs.Ease.get(1)).wait(1));
...
(lib.Символ34 = function(mode,startPosition,loop) {
	...
	this.instance.cache(-26,-27,53,54);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ34, new cjs.Rectangle(-26.5,-26.8,56,56), null);
...
(lib.Символ32 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.filters = [new cjs.BlurFilter(4, 4, 1)];
	this.instance.cache(-42,-42,84,84);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ32, new cjs.Rectangle(-42,-42,88,88), null);
...
(lib.Символ31 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-34,y:24},29,cjs.Ease.get(-1)).to({x:-68,y:48.1},29,cjs.Ease.get(1)).to({x:-33.4,y:23.7},31,cjs.Ease.get(-1)).to({x:0,y:0},30,cjs.Ease.get(1)).wait(1));
...
(lib.Символ28 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.filters = [new cjs.BlurFilter(4, 4, 1)];
	this.instance.cache(-37,-37,74,74);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ28, new cjs.Rectangle(-37.2,-36.9,78,76), null);
...
(lib.Символ35 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:29.4,y:14.7},23,cjs.Ease.get(-1)).to({x:60,y:30},24,cjs.Ease.get(1)).to({x:31.9,y:16},22,cjs.Ease.get(-1)).to({x:0,y:0},25,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-26.5,-26.8,56,56);
...
(lib.Символ33 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-9.1},11,cjs.Ease.get(-1)).to({y:-20},13,cjs.Ease.get(1)).to({y:-10.4},12,cjs.Ease.get(-1)).to({y:0},13,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-42,-42,88,88);
...
(lib.Символ29 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:7.7},14,cjs.Ease.get(-1)).to({y:16},15,cjs.Ease.get(1)).to({y:8},15,cjs.Ease.get(-1)).to({y:0},15,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-37.2,-36.9,78,76);
...
(lib.Символ27 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-160.5,-74.2);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-369.5,-68);
...
}).prototype = getMCSymbolPrototype(lib.Символ27, new cjs.Rectangle(-523,-111.1,544,317.3), null);
...
// stage content:
(lib.kaz600300 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
