...
}).prototype = getMCSymbolPrototype(lib.Символ12, new cjs.Rectangle(0,0,223,183), null);
...
(lib.Символ8 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(105.6,25.9,1,1,0,0,0,105.6,25.9);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0.484},14,cjs.Ease.get(-1)).to({alpha:1},15,cjs.Ease.get(1)).to({alpha:0.5},15,cjs.Ease.get(-1)).to({alpha:0},15,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-20.3,-22.6,252,101);
...
(lib.Символ10 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#33FF00").s().p("A4KUBMAAAgoBMAwVAAAMAAAAoBg");
	this.shape.setTransform(116.7,-62.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance,p:{alpha:0}}]}).to({state:[{t:this.instance,p:{alpha:1}}]},1).to({state:[{t:this.shape}]},2).wait(1));
...
(lib.case_btn2 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(228,178.5,1,1,0,0,0,110,89.5);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(170,168,1.939,1.939,0,0,0,80.4,50.4);
	...
	this.instance_3.setTransform(165.8,231.7,1,1,0,0,0,105.6,29.1);
	new cjs.ButtonHelper(this.instance_3, 0, 1, 2, false, new lib.Символ10(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(120.2,164.3,395.8,256.7);
// library properties:
lib.properties = {
	width: 350,
	height: 280,
	...
	opacity: 0.00,
	manifest: [
		{src:"images/blue_case.png?1501492824770", id:"blue_case"},
		{src:"images/doppler.png?1501492824770", id:"doppler"},
		{src:"images/logopngкопия2.png?1501492824770", id:"logopngкопия2"},
		{src:"images/OPEN.png?1501492824770", id:"OPEN"}
	],
	preloads: []
};
