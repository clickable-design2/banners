...
(lib.Символ26 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ26, new cjs.Rectangle(-62.1,-14.1,124.2,28.4), null);
...
(lib.Символ25 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ25, new cjs.Rectangle(-62.1,-14.1,124.2,28.4), null);
...
(lib.Символ22 = function(mode,startPosition,loop) {
	...
	this.instance_1.cache(-64,-16,128,32);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ22, new cjs.Rectangle(-64.1,-14.5,132,35), null);
...
(lib.Символ15 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-5.6,49.6);

	this.instance_1 = new lib.Символ14();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-2,-60.9);
...
(lib.Символ4 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.play_btn).to({y:-18.9,alpha:0.715},5).to({y:0,alpha:1},2).wait(1).to({y:-18.9,alpha:0.711},2).to({y:45.6,alpha:0},5).wait(1));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/logo.png?1490952297648", id:"logo"}
	],
	preloads: []
};
