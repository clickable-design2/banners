...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/active.png?1485939675896", id:"active"},
		{src:"images/normal.png?1485939675896", id:"normal"},
		{src:"images/ReSpin_.png?1485939675896", id:"ReSpin_"},
		{src:"images/strelka.png?1485939675896", id:"strelka"}
	]
};
...
p.nominalBounds = new cjs.Rectangle(0,0,225,256);
...
(lib.Символ5 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(7,6,0.124,0.124);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(7,6,27.9,31.8);
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:21,rotation:75.5,y:33},0).wait(1).to({rotation:142.2,y:32.8},0).wait(1).to({rotation:200,y:32.7},0).wait(1).to({rotation:248.9,x:47,y:32.8},0).wait(1).to({rotation:288.9,y:32.9},0).wait(1).to({rotation:320,x:47.1},0).wait(1).to({rotation:342.2,x:47},0).wait(1).to({rotation:355.5},0).wait(1).to({rotation:360},0).wait(1));
...
(lib.Символ6 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:21,rotation:68.4},0).wait(1).to({rotation:129.6,x:46.8},0).wait(1).to({rotation:183.6,x:46.9,y:32.8},0).wait(1).to({rotation:230.4},0).wait(1).to({rotation:270,x:47},0).wait(1).to({rotation:302.4},0).wait(1).to({rotation:327.6,x:47.1,y:32.9},0).wait(1).to({rotation:345.6,x:47},0).wait(1).to({rotation:356.4},0).wait(1).to({rotation:360},0).wait(1));
