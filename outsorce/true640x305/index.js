...
(lib.Символ84 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#003366").s().p("Au7FJQh6ABABh6IAAmfQgBh6B6ABId3AAQB6gBgBB6IAAGfQABB6h6gBg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ84, new cjs.Rectangle(-107.7,-32.9,215.5,65.9), null);
...
(lib.Символ83 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#003366").s().p("AujE+QhlAAAAhmIAAmvQAAhmBlAAIdHAAQBlAAAABmIAAGvQAABmhlAAg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ83, new cjs.Rectangle(-103.3,-31.8,206.7,63.6), null);
...
(lib.Символ73 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFB713").s().p("");
	this.shape.setTransform(-61.2,1.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(56.7,0);
...
(lib.Символ48 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-75.9,1.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFB713").s().p("");
...
}).prototype = getMCSymbolPrototype(lib.Символ79, new cjs.Rectangle(-91.8,-28.8,186,62.4), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ82, new cjs.Rectangle(-91.8,-28.8,186,62.4), null);
...
(lib.Символ81 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({scaleX:1.2,scaleY:1.2},0).wait(1).to({scaleX:0.88,scaleY:0.88},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-91.8,-28.8,186,62.4);
...
(lib.Символ80 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({scaleX:1.15,scaleY:1.15},0).wait(1).to({scaleX:0.9,scaleY:0.9},0).wait(1));
...
}).prototype = getMCSymbolPrototype(lib.Символ67, new cjs.Rectangle(-105.3,-33.1,214,71.8), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ66, new cjs.Rectangle(-109.6,-34.4,222,73.9), null);
...
(lib.Символ44 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(53).call(this.frame_53).wait(54).call(this.frame_107).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},75).wait(33));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(75).to({_off:false},0).to({alpha:0.23},5,cjs.Ease.get(1)).to({alpha:0},5,cjs.Ease.get(1)).wait(1).to({alpha:0.23},5,cjs.Ease.get(1)).to({alpha:0},5,cjs.Ease.get(1)).wait(1).to({alpha:0.23},5,cjs.Ease.get(1)).to({alpha:0},5,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.people1).to({x:301.7},14).to({x:950.9},39).wait(1).to({x:-340.3},0).to({x:333.7},21,cjs.Ease.get(1)).wait(33));
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		  ...
		  function fl_MouseOverHandler_5()
		{
			...
			_this.main.people.gotoAndPlay(55);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/elvis.png?1490795186586", id:"elvis"},
		{src:"images/ivan.png?1490795186586", id:"ivan"},
		{src:"images/jaz.png?1490795186586", id:"jaz"},
		{src:"images/koza.png?1490795186586", id:"koza"},
		{src:"images/maxresdefault.jpg?1490795186586", id:"maxresdefault"},
		{src:"images/monr.png?1490795186586", id:"monr"},
		{src:"images/nap.png?1490795186586", id:"nap"}
	],
	preloads: []
};
