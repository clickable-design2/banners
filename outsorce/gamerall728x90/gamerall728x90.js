...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/blik.png?1480416399623", id:"blik"},
		{src:"images/csgo_logo.png?1480416399623", id:"csgo_logo"},
		{src:"images/fon.jpg?1480416399623", id:"fon"},
		{src:"images/giphy_0.png?1480416399623", id:"giphy_0"},
		{src:"images/giphy_1.png?1480416399623", id:"giphy_1"},
		{src:"images/giphy_2.png?1480416399623", id:"giphy_2"},
		{src:"images/giphy_3.png?1480416399623", id:"giphy_3"},
		{src:"images/giphy_4.png?1480416399623", id:"giphy_4"},
		{src:"images/giphy_5.png?1480416399623", id:"giphy_5"},
		{src:"images/item_02.png?1480416399623", id:"item_02"},
		{src:"images/item_09.png?1480416399623", id:"item_09"},
		{src:"images/item_14.png?1480416399623", id:"item_14"},
		{src:"images/item_16.png?1480416399623", id:"item_16"},
		{src:"images/logo.png?1480416399623", id:"logo"},
		{src:"images/maxresdefault.png?1480416399623", id:"maxresdefault"},
		{src:"images/OpenCaseNow.png?1480416399623", id:"OpenCaseNow"},
		{src:"images/OpenCaseNow2.png?1480416399623", id:"OpenCaseNow2"},
		{src:"images/Pointing.png?1480416399623", id:"Pointing"},
		{src:"images/slide.png?1480416399623", id:"slide"}
	]
};
...
(lib.Символ19 = function(mode,startPosition,loop) {
	...
	this.instance = new lib.Pointing();
	this.instance.parent = this;
	this.instance.setTransform(-7,5,0.292,0.292);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-7,5,43.8,54.5);
...
(lib.Символ4 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,-92,1.338,1.338);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-92,856.5,481.8);
...
(lib.Символ45 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(569.8,27);
	...
	this.instance.parent = this;
	this.instance.setTransform(485.3,32.7,1.475,1.768,0,-90,90,99.9,122.9);
	this.instance.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(268,-114.7,434.9,295);
...
(lib.Символ44 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(47.6,2.8);
	...
	this.instance = new lib.Символ46();
	this.instance.parent = this;
	this.instance.setTransform(-32.9,3.5,1.2,1.437,-90,0,0,100,122.9);
	this.instance.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-209.6,-116.4,353.6,239.9);
...
(lib.Символ41 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(168.3,269.8,0.392,0.392,0,0,0,146,36.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(441.3,309.5,1,1.159,90,0,0,188.4,388.8);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(334,310,1,1,0,0,0,320,180);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-9.1,38,901,481.8);
...
(lib.Символ25 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(112,16.1);
	...
	this.instance = new lib.Символ46();
	this.instance.parent = this;
	this.instance.setTransform(35.1,17.7,1.506,1.805,-90,0,0,100,122.8);
	this.instance.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-186.5,-132.9,444.1,301.3);
...
(lib.Символ24 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-554.6,-151,1,1,0,0,0,61.3,8.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:186.5},9,cjs.Ease.get(1)).wait(30).to({y:443.3},10).wait(30).to({y:676.3},10).wait(30).to({y:893.5},10).wait(30).to({y:-151},1).wait(10));

	// Слой 7
	this.instance_1 = new lib.Символ45();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-1027.2,-137.2,1,1,0,0,0,101.9,8.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:200.3},9,cjs.Ease.get(1)).wait(30).to({y:457},10).wait(30).to({y:690},10).wait(30).to({y:907.3},10).wait(30).to({y:-137.2},1).wait(10));

	// Слой 1
	this.instance_2 = new lib.Символ25();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-557.7,-248.1,1,1,0,0,0,106,8.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(39).to({y:202.1},10).wait(30).to({y:435.1},10).wait(30).to({y:652.4},10).wait(30).to({y:871.6},10).wait(1));

	// Слой 2
	this.instance_3 = new lib.Символ26();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-541.5,-327.2,1,1,0,0,0,98.8,8.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(39).to({y:-272},10).to({x:-561.3},30).to({x:-547.5,y:229.5},10).wait(30).to({y:446.8},10).wait(30).to({y:666},10).wait(1));

	// Слой 3
	this.instance_4 = new lib.Символ27();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-559.9,-306.6,1,1,0,0,0,80.2,9);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(49).to({x:-579.6},30).to({x:-565.9,y:194.9},10).wait(30).to({y:412.1},10).wait(30).to({y:631.4},10).wait(1));

	// Слой 4
	this.instance_5 = new lib.Символ28();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-581.7,-524.4,1,1,0,0,0,60.6,8.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(79).to({y:-291.4},10).to({x:-562},30).to({y:202.3},10).wait(30).to({y:421.6},10).wait(1));

	// Слой 5
	this.instance_6 = new lib.Символ29();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-570.1,-504.3,1,1,0,0,0,72.2,9);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(79).to({y:-271.3},10).to({x:-550.3},30).to({y:222.5},10).wait(30).to({y:441.7},10).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-861.1,-638.3,459.5,672.6);
...
(lib.Символ21 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(48.1,47.2,0.884,0.884,0,0,0,87.9,16.1);
	new cjs.ButtonHelper(this.instance, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-70.2,10.9,236.9,72.5);
...
(lib.Символ9 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(75.7,59.8,1,1,0,0,0,90.5,72.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-14.8,-12.6,181.1,144.8);
...
(lib.Символ8 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(116.9,94.2,1,1,0,0,0,17.2,51.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:17.4,regY:51.8,scaleX:1.03,scaleY:1.03,x:115.4,y:93.5},14).to({regX:17.2,regY:51.6,scaleX:1,scaleY:1,x:116.9,y:94.2},15).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(29.4,53.4,236.9,72.5);
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:98.4,alpha:0.98},2,cjs.Ease.get(-1)).to({y:219.4,alpha:0},12).to({y:96.5,alpha:1},15,cjs.Ease.get(1)).wait(1));

	// Слой 2
	this.instance_1 = new lib.Символ9();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-100.5,87.7,1,1,0,0,0,90.5,72.4);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:134.2,alpha:1},14,cjs.Ease.get(-1)).to({x:-100.5,alpha:0},15,cjs.Ease.get(-1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-205.8,2.7,472.1,144.8);
...
(lib.Символ6 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(170.6,52.9,1.169,1.169,0,0,0,136.7,36.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(10.7,10.7,319.7,84.4);
...
(lib.Символ5 = function(mode,startPosition,loop) {
	...
	this.instance = new lib.Символ8();
	this.instance.parent = this;
	this.instance.setTransform(-60.6,53.7,1,1,0,0,0,95.9,95.9);

	this.instance_1 = new lib.Символ8();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-60.6,176.7,1,1,0,0,0,95.9,95.9);
	this.instance_1.alpha = 0;

	this.instance_2 = new lib.Символ8();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-60.6,53.2,1,1,0,0,0,95.9,95.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-127.1,10.7,236.9,196);
...
(lib.Символ3 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(280.9,37.6,1,1,-0.5,0,0,155,41);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:155.1,rotation:0,x:4.9,y:38.4,alpha:1},14,cjs.Ease.get(-1)).to({regX:155,rotation:-0.5,x:280.9,y:37.6,alpha:0},15,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-127.1,5.8,583.8,200.9);
...
(lib.Символ20 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(139.9,-134.4,0.816,0.816,0,0,0,30.6,75);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({x:285.9,alpha:0},7).to({x:379.9,alpha:1},8).wait(15).to({x:245.9,alpha:0},7).to({x:139.9,alpha:1},8).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(109.3,-191.5,35.7,44.5);
...
p.nominalBounds = new cjs.Rectangle(109.3,-164.2,35.7,44.5);
...
// stage content:
(lib.gamerall728x90 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.hand.setTransform(131.1,266.2,1,1,0,0,0,10.1,65.9);
	...
	this.kursor.setTransform(225.8,190,0.818,0.818,0,0,0,22.9,28.7);
	...
	this.instance.parent = this;
	this.instance.setTransform(44.7,15,0.367,0.367,0,0,0,112.8,47.1);
	...
	this.vip.setTransform(226.4,55.5,0.534,0.534,0,0,0,134.4,71.3);
	...
	this.vopros1.setTransform(114.2,63.2,0.523,0.523,0,0,0,68.5,56.2);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(323.4,-2.3,0.6,0.6,0,10.2,-169.8);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(845.1,-98.3,0.708,0.708,0,0,0,105.9,8.7);
	...
	this.blood.setTransform(517.6,56.1,0.525,0.525,0,0,0,110.8,71);
	...
	this.vopros2.setTransform(631.2,61.4,0.527,0.527,0,0,0,96.2,95.8);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(409.2,-2.3,0.551,0.551,-8);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(621.3,8.8,0.576,0.576,0,0,0,167.4,6.7);
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(151.7,72.5,0.854,0.854,0,0,0,190.5,338.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(336.3,-511.5,778.4,783.8);
