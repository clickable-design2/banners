...
}).prototype = getMCSymbolPrototype(lib.Символ26, new cjs.Rectangle(9,0,802,69), null);
...
(lib.Символ48 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(325.6,28.1,0.812,0.812,0,0,0,401,34.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(27).to({y:34.9},2).to({y:23.7},2).to({y:39.3},2).to({y:28.1},2).to({y:34.9},2).to({y:28.1},2).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(7.3,0,651.1,56);
...
(lib.Символ2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(399.5,-286.6,1,1,0,0,0,325.5,28);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(405.5,197.9,1,1,0,0,0,331.5,37.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:42.5},9,cjs.Ease.get(1)).to({y:64.7},3,cjs.Ease.get(1)).wait(94).to({y:42.5},3,cjs.Ease.get(1)).to({y:175.7},8,cjs.Ease.get(-1)).to({_off:true},13).wait(180));

	// popad.png
	this.instance_2 = new lib.Символ25();
	this.instance_2.parent = this;
	this.instance_2.setTransform(411.6,196.8,1,1,0,0,0,328,48);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(117).to({_off:false},0).to({y:41.4},9,cjs.Ease.get(1)).to({y:63.6},3,cjs.Ease.get(1)).wait(80).to({y:41.4},3,cjs.Ease.get(1)).to({y:174.6},8,cjs.Ease.get(-1)).to({_off:true},1).wait(2).to({_off:false,y:196.8},0).to({y:41.4},9,cjs.Ease.get(1)).to({y:63.6},3,cjs.Ease.get(1)).wait(9).to({y:54.8},2).to({y:68},2).to({y:59.2},2).to({y:70.2},2).to({y:63.6},2).wait(17).to({y:54.8},2).to({y:68},2).to({y:59.2},2).to({y:70.2},2).to({y:63.6},2).wait(17).to({y:41.4},3,cjs.Ease.get(1)).to({y:174.6},8,cjs.Ease.get(-1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(74,-314.6,663,550);
...
(lib.byxta600300 = function(mode,startPosition,loop) {
	...
	this.tek.setTransform(296.9,253.5,0.675,0.675,0,0,0,401,55.5);
	...
	this.instance.parent = this;
	this.instance.setTransform(517.4,216.8,0.808,0.808,0,0,0,13.8,13.1);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/anchor.png?1479298287323", id:"anchor"},
		{src:"images/arm.png?1479298287323", id:"arm"},
		{src:"images/backgr.jpg?1479298287323", id:"backgr"},
		{src:"images/body.png?1479298287323", id:"body"},
		{src:"images/bodygirl.png?1479298287323", id:"bodygirl"},
		{src:"images/bra.png?1479298287323", id:"bra"},
		{src:"images/chip.png?1479298287323", id:"chip"},
		{src:"images/coin.png?1479298287323", id:"coin"},
		{src:"images/getbonus.png?1479298287323", id:"getbonus"},
		{src:"images/gun.png?1479298287323", id:"gun"},
		{src:"images/handpir.png?1479298287323", id:"handpir"},
		{src:"images/headgirl.png?1479298287323", id:"headgirl"},
		{src:"images/headpir.png?1479298287323", id:"headpir"},
		{src:"images/hleft.png?1479298287323", id:"hleft"},
		{src:"images/pistol.png?1479298287323", id:"pistol"},
		{src:"images/popad.png?1479298287323", id:"popad"},
		{src:"images/shold.png?1479298287323", id:"shold"},
		{src:"images/skirt.png?1479298287323", id:"skirt"},
		{src:"images/sword.png?1479298287323", id:"sword"}
	],
	preloads: []
};
