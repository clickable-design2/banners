...
(lib.Символ36 = function(mode,startPosition,loop) {
	...
	this.instance = new lib.chip();
	this.instance.parent = this;
	this.instance.setTransform(-53,-24,0.578,0.578);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ36, new cjs.Rectangle(-53,-24,46.8,47.4), null);
...
(lib.Символ26 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#E2292B").ss(1,1,1).p("AsXyDMAiEAAAMAAAAj5AVtSEMgrZAAAMAAAghg");
	this.shape.setTransform(-150,-24.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ26, new cjs.Rectangle(-289.8,-141,279.7,233.1), null);
...
(lib.Символ24 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("A5AXSMAAAgujMAyBAAAMAAAAujg");
	this.shape.setTransform(-160.1,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ24, new cjs.Rectangle(-320.2,-149,320.3,298), null);
...
(lib.Символ16 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-46,-10,0.341,0.341);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ16, new cjs.Rectangle(-46,-10,54.6,12.3), null);
...
p.nominalBounds = new cjs.Rectangle(-53,-24,46.8,47.4);
...
p.nominalBounds = new cjs.Rectangle(-289.3,-140.5,278.7,232.1);
...
(lib.Символ27 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-258.6,-107.2);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-541.7,-39.6,1,1,45);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(-482.5,161);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(-193.3,68.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ27, new cjs.Rectangle(-576.5,-142.1,423.7,326.6), null);
...
(lib.Символ47 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:0.1,regY:-0.2,scaleX:1.09,scaleY:1.09,x:7.7,y:-57.5},6,cjs.Ease.get(-1)).to({regX:0,regY:-0.1,scaleX:1.17,scaleY:1.17,x:8.9,y:-57.4},8,cjs.Ease.get(1)).to({regY:-0.2,scaleX:1.1,scaleY:1.1,x:7.8,y:-57.5},7,cjs.Ease.get(-1)).to({regY:-0.1,scaleX:1.02,scaleY:1.02,x:6.7,y:-57.4},8,cjs.Ease.get(1)).wait(1));
...
(lib.Символ46 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-101.2,43.5,0.814,0.814);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-8.9,alpha:1},7,cjs.Ease.get(1)).wait(1).to({x:-101.2,alpha:0},7,cjs.Ease.get(1)).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-428.9,-199.1,571,410.1);


// stage content:
(lib.kaz600500 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(119.6,46.2,1.977,1.977);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(598.4,303.7,1.977,1.977);
	...
	this.main.setTransform(298.1,250.2,1.395,1.395,0,0,0,-2.5,30.5);
	...
	this.fon.setTransform(6.1,7.8,1.734,1.734,0,0,0,-542.4,-113.7);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(301.5,409.6,1.106,1.106,0,0,0,0.1,0.1);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(87.1,485.2,1.039,1.039,0,0,0,0.1,0.2);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(630,250.2,2.021,1.977,0,0,0,0.1,0.1);
	...
	this.instance_5.setTransform(209.8,245.5,1.829,1.829,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-39,179.8,1097.1,655.7);
// library properties:
lib.properties = {
	width: 600,
	height: 500,
