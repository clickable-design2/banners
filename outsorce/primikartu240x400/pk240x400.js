...
(lib.pk240x400 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(189).to({_off:false},0).wait(19).to({y:446.8},0).to({y:350.8,alpha:1},8,cjs.Ease.get(1)).wait(23).to({y:462.8,alpha:0},10,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(189).to({_off:false},0).wait(17).to({y:204.9},0).to({y:236.9,alpha:1},5,cjs.Ease.get(1)).wait(27).to({x:-88,alpha:0},10,cjs.Ease.get(1)).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(189).to({_off:false},0).wait(15).to({y:182.2},0).to({y:214.2,alpha:1},5,cjs.Ease.get(1)).wait(28).to({alpha:0},10,cjs.Ease.get(1)).to({_off:true},1).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(189).to({_off:false},0).wait(13).to({y:159.6},0).to({y:191.6,alpha:1},5,cjs.Ease.get(1)).wait(29).to({x:328,alpha:0},10,cjs.Ease.get(1)).to({_off:true},1).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(189).to({_off:false},0).wait(11).to({y:138.8},0).to({y:170.8,alpha:1},5,cjs.Ease.get(1)).wait(30).to({x:-71.8,alpha:0},10,cjs.Ease.get(1)).to({_off:true},1).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(189).to({_off:false},0).wait(9).to({y:115},0).to({y:147,alpha:1},5,cjs.Ease.get(1)).wait(31).to({alpha:0},10,cjs.Ease.get(1)).to({_off:true},1).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(189).to({_off:false},0).wait(7).to({y:91.7},0).to({y:123.7,alpha:1},5,cjs.Ease.get(1)).wait(32).to({x:360,alpha:0},10,cjs.Ease.get(1)).to({_off:true},1).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(189).to({_off:false},0).wait(5).to({y:68.2},0).to({y:100.2,alpha:1},5,cjs.Ease.get(1)).wait(33).to({alpha:0},10,cjs.Ease.get(1)).to({_off:true},1).wait(7));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(189).to({_off:false},0).wait(3).to({y:43.7},0).to({y:75.7,alpha:1},5,cjs.Ease.get(1)).wait(34).to({x:-136,alpha:0},10,cjs.Ease.get(1)).to({_off:true},1).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(189).to({_off:false},0).wait(1).to({y:24.7},0).to({y:56.7,alpha:1},5,cjs.Ease.get(1)).wait(35).to({x:344,alpha:0},10,cjs.Ease.get(1)).to({_off:true},1).wait(9));

	// Символ 15
	this.instance_10 = new lib.Символ15();
	this.instance_10.parent = this;
	this.instance_10.setTransform(203.8,232.8);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(134).to({_off:false},0).wait(13).to({scaleY:0.42,y:242.4},0).to({scaleY:1.16,y:230.2,alpha:1},4,cjs.Ease.get(1)).to({scaleY:1,y:232.8},2).wait(22).to({scaleX:1.13,scaleY:1.13,x:214.4,y:221.3},2,cjs.Ease.get(1)).to({regX:0.1,regY:0.1,scaleX:0.65,scaleY:0.65,x:174.4,y:290.1,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(66));

	// Символ 13
	this.instance_11 = new lib.Символ13();
	this.instance_11.parent = this;
	this.instance_11.setTransform(113.3,232.9);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(134).to({_off:false},0).wait(6).to({x:341.7,y:233.1},0).to({x:113.3,y:232.9,alpha:1},7,cjs.Ease.get(1)).wait(31).to({scaleX:1.13,scaleY:1.13,x:112.5,y:221.4},2,cjs.Ease.get(1)).to({regX:0.1,scaleX:0.65,scaleY:0.65,x:115.5,y:290.1,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(63));

	// Символ 14
	this.instance_12 = new lib.Символ14();
	this.instance_12.parent = this;
	this.instance_12.setTransform(117.3,189);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(134).to({_off:false},0).wait(1).to({y:141.8},0).to({y:189,alpha:1},7,cjs.Ease.get(1)).wait(39).to({scaleX:1.13,scaleY:1.13,x:117,y:172},2,cjs.Ease.get(1)).to({regX:0.1,scaleX:0.65,scaleY:0.65,x:118.1,y:261.6,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(60));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(67).to({_off:false},0).wait(19).to({x:301.3},0).to({x:149.3,alpha:1},7,cjs.Ease.get(1)).wait(33).to({y:228.1},3,cjs.Ease.get(1)).to({y:319.3,alpha:0},5,cjs.Ease.get(1)).to({_off:true},1).wait(115));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(67).to({_off:false},0).wait(19).to({x:-31.3},0).to({x:56.7,alpha:1},7,cjs.Ease.get(1)).wait(30).to({y:228.7},3,cjs.Ease.get(1)).to({y:319.9,alpha:0},5,cjs.Ease.get(1)).to({_off:true},1).wait(118));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(67).to({_off:false},0).wait(15).to({y:228},0).to({y:212,alpha:1},7,cjs.Ease.get(1)).wait(31).to({y:193.6},3,cjs.Ease.get(1)).to({y:284.8,alpha:0},5,cjs.Ease.get(1)).to({_off:true},1).wait(121));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(67).to({_off:false},0).wait(11).to({y:199.9},0).to({y:175.9,alpha:1},7,cjs.Ease.get(1)).wait(32).to({y:157.5},3,cjs.Ease.get(1)).to({y:248.7,alpha:0},5,cjs.Ease.get(1)).to({_off:true},1).wait(124));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(5).to({_off:false},0).wait(25).to({x:119.7,alpha:1},8,cjs.Ease.get(1)).wait(20).to({y:258},2,cjs.Ease.get(1)).to({y:294,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(182));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(5).to({_off:false},0).wait(17).to({x:118.7,alpha:1},8,cjs.Ease.get(1)).wait(26).to({y:215.5},2,cjs.Ease.get(1)).to({y:251.5,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(184));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(5).to({_off:false},0).wait(9).to({x:119.7,alpha:1},8,cjs.Ease.get(1)).wait(32).to({y:179.2},2,cjs.Ease.get(1)).to({y:215.2,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(186));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(5).to({_off:false},0).wait(1).to({y:154.1,alpha:1},8,cjs.Ease.get(1)).wait(38).to({y:142.1},2,cjs.Ease.get(1)).to({y:178.1,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(188));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_21).to({scaleX:1.24,scaleY:1.24,x:120.1,y:200.1},59).to({scaleX:1.29,scaleY:1.29,x:120,y:200,alpha:0},10).to({_off:true},1).wait(180));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(59).to({scaleX:1.27,scaleY:1.27,y:200.1},60).to({scaleX:1.32,scaleY:1.32,y:200,alpha:0},10).to({_off:true},1).wait(120));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(119).to({scaleX:1.29,scaleY:1.29,x:120.1},60).to({scaleX:1.34,scaleY:1.34,x:120,alpha:0},10).to({_off:true},1).wait(60));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(179).to({scaleX:1.28,scaleY:1.28,y:200.1},60).to({scaleX:1.33,scaleY:1.33,y:200,alpha:0},10).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(250));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1485508897322", id:"bg"},
		{src:"images/bg2.jpg?1485508897322", id:"bg2"},
		{src:"images/bg3.jpg?1485508897322", id:"bg3"},
		{src:"images/bg4.jpg?1485508897322", id:"bg4"}
	],
	preloads: []
};
