...
(lib.case_btn2 = function(mode,startPosition,loop) {
	...
	this.knife.setTransform(171.1,113.5,1,1,-11.2,0,0,110,89.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(167.1,194,1.629,1.629,0,0,0,80.4,50.5);
	...
	this.flash.setTransform(-91,67.7,1,1,0,0,0,10.7,19.6);

	this.timeline.addTween(cjs.Tween.get(this.flash).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(152.5,144.4,323.3,287.5);
// library properties:
lib.properties = {
	width: 350,
	height: 280,
	...
	opacity: 0.00,
	manifest: [
		{src:"images/blue_case.png?1501580163064", id:"blue_case"},
		{src:"images/doppler.png?1501580163064", id:"doppler"},
		{src:"images/logopngкопия2.png?1501580163064", id:"logopngкопия2"},
		{src:"images/OPEN.png?1501580163064", id:"OPEN"}
	],
	preloads: []
};
