...
}).prototype = getMCSymbolPrototype(lib.Символ51, new cjs.Rectangle(-943.2,-78.6,1882.5,157.3), null);
(lib.Символ50 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	// Символ 24
	this.instance = new lib.Символ24();
	this.instance.parent = this;
	this.instance.setTransform(-0.1,-51.1,3.196,1.046);
	this.instance.alpha = 0.711;
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));
	// Символ 2
	this.instance_1 = new lib.Символ2();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-8.2,66.1,3.211,3.211,0,0,0,-0.1,0.2);
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.main.setTransform(300.1,104,0.72,0.72,0,0,0,-1,8.9);
	this.timeline.addTween(cjs.Tween.get(this.main).wait(1));
	// Слой 8
	this.fon = new lib.Символ27();
	this.fon.parent = this;
	this.fon.setTransform(311.4,100.6,0.685,0.685,0,0,0,-167.8,41.5);
	...
	this.money.setTransform(306.1,272.5);
