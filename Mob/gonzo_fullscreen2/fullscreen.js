...
(lib.Символ6_1 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.instance_1 = new lib.plecho2();
	this.instance_1.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ6_1, new cjs.Rectangle(0,0,19,47), null);
...
(lib.Символ7_1 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(32,72.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:18.3,y:37.7},29,cjs.Ease.get(-1)).to({x:4,y:2.1},30,cjs.Ease.get(1)).to({x:18,y:37.1},30,cjs.Ease.get(-1)).to({x:25.2,y:54.9},9,cjs.Ease.get(1)).to({x:32,y:72.1},21).wait(1));
...
(lib.Символ1_1 = function(mode,startPosition,loop) {
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(108.5,-50.2,0.84,0.84);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(-145.6,-31.5,0.84,0.84,0,0,0,-0.1,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ1_1, new cjs.Rectangle(-302,-270,527.7,544.6), null);
...
(lib.fullscreen = function(mode,startPosition,loop) {
	...
	this.man.setTransform(798,349.8,1,1,0,0,0,-25.9,47);

	this.timeline.addTween(cjs.Tween.get(this.man).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(702,416.7,859.5,686.3);
// library properties:
lib.properties = {
	width: 1024,
	height: 768,
