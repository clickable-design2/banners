...
(lib.Символ33копия = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgMCcIgLgHIgHgLQgDgGAAgHQAAgHADgHIAHgKQAFgFAGgDQAGgCAGAAQAHAAAGACQAHADAEAFIAHAKQADAHAAAHQAAAHgDAGQgCAGgFAFQgEAEgHADQgGADgHAAQgGAAgGgDgAgSA+QgFAAgDgDQgEgDAAgFIAAjFQAAgGADgDQADgDAGAAIAmAAQAFAAADADQADADAAAGIAADFQAAAFgDADQgDADgFAAg");
	this.shape.setTransform(254.3,113.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("ABgCcIgFgCIgEgEIgUgyIiFAAIgUAyQgCAGgGAAIgsAAQgFAAgCgCQgCgCAAgEIAfhKIBdjeIAEgFQACgCAGAAIAXAAQAFAAACACIAEAFIB9EmIAAACIgCAFQgCADgHAAgAAsArIgshrIgsBrIBYAAg");
	this.shape_1.setTransform(232.2,113.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgUCcIgDgBIgEgDIgCgDIgBgEIAAjzIhNAAQgDAAgEgCQgDgEAAgFIAAgkQAAgEADgDQAEgDADAAIDWAAIAHACQADADABAFIAAAkQAAAFgDADQgCAEgGgBIhMAAIAADzIgBAEIgCADIgDADIgEABg");
	this.shape_2.setTransform(201.7,113.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(171.2,113.6);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AiGCbQgCgCAAgFIAAgjQAAgJAIAAQAHAAAEgDIAJgGIAHgKIACgLIAAjeIACgGQACgDAEAAIDbAAIAGACQADACAAAEIAAEnQAAAIgIAAIgrAAIgGgCQgCgCAAgEIAAj3Ih2AAIAACgQAAATgGASQgFASgMANQgKAOgRAIQgQAJgWAAQgDAAgDgDg");
	this.shape_4.setTransform(136.3,113.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(103.6,113.6);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(72.5,113.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhlCcQgFAAgDgDQgDgEAAgFIAAkfQAAgGADgDQADgDAFAAIAnAAQALAAAAAMIAABkIBEAAQAVAAARAJQATAHANAOQAMANAIASQAHASAAAUQAAATgIASQgHASgNAPQgNAOgSAHQgSAJgVAAgAgzBmIA6AAQAJAAAJgEQAHgFAGgGQAGgHADgHQAEgIAAgJQAAgJgEgIQgDgIgGgHQgGgGgHgEQgJgDgJAAIg6AAg");
	this.shape_7.setTransform(207.6,56);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgUCcIgDgBIgEgCIgCgEIgBgDIAAjzIhMAAQgFAAgCgEQgEgDAAgEIAAgmQAAgEAEgCQACgDAFAAIDVAAIAHADQADACABAEIAAAmQAAAEgDADQgDADgFABIhMAAIAADzIgBADIgCAEIgDACIgEABg");
	this.shape_8.setTransform(178.2,56);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("ABgCcIgFgBIgEgGIgUgwIiFAAIgUAwQgCAHgGAAIgsAAQgFAAgCgCQgCgCAAgEIAfhKIBdjeIAEgFQACgCAGAAIAXAAQAFAAACACIAEAFIB9EnIAAAAIgCAHQgCACgHAAgAAsArIgshsIgsBsIBYAAg");
	this.shape_9.setTransform(150,56);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("ABpDBQgHAAAAgHIAAhDIjFAAIAABEQAAAGgHAAIgnAAQgHAAAAgGIAAh0QAAgIAIAAIAaAAQAMgTAIgTQAIgTAGgTQAFgVADgXIAFg2IAAgjIAAgmQAAgIAHAAICuAAIAFACQADACAAADIAAD4IAbAAIAFACQADACAAAEIAABzQAAAHgHAAgAgRhUQgCAmgJAmQgKAkgQAjIBxAAIAAjGIhKAAg");
	this.shape_10.setTransform(117.2,59.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ33копия, new cjs.Rectangle(19.5,26.5,281,117.1), null);
...
(lib.Символ33 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgMCcIgLgHIgHgLQgDgGAAgHQAAgHADgGIAHgLQAFgFAGgCQAGgDAGAAQAHAAAGADQAHACAEAFIAHALQADAGAAAHQAAAHgDAGQgCAHgFAEQgEAFgHACQgGADgHAAQgGAAgGgDgAgSA+QgFAAgDgDQgEgDAAgFIAAjGQAAgFADgDQADgDAGAAIAmAAQAFAAADADQADADAAAFIAADGQAAAEgDAEQgDADgFAAg");
	this.shape.setTransform(278.8,115.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AB/CcQgFAAgDgDQgDgDgBgFIgTi7IhEC1IgEAHQgEADgDAAIgiAAQgDAAgDgDIgEgGIgihcIgihaIgTC7QgBAFgDADQgDADgFAAIgmAAQgLAAAAgLIAdkhQABgEADgDQADgEAFAAIAxAAQAEAAADADIAFAGIARAyIASAwIAmBpIBKjLIAAABQABgFAEgCQADgDAEAAIAxAAQAEAAAEAEQADADAAAEIAeEhQAAAGgDACQgDADgFAAg");
	this.shape_1.setTransform(252.7,114.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(215.6,114.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(181.9,114.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("ABUCcQgKAAABgJIAAjPIiRDRIgFAFIgEACIgtAAQgLAAAAgJIAAklQAAgEAEgCIAHgDIAqAAIAGABQACACABAEIAADCICKjCIAFgFIAHgCIAxAAQAEAAADADQADACAAAEIAAElQAAAJgKAAg");
	this.shape_4.setTransform(149.4,114.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(112.5,114.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("ABgCcIgFgBIgEgGIgUgwIiFAAIgUAwQgCAHgGAAIgsAAQgFAAgCgCQgCgCAAgEIAfhKIBdjeIAEgFQACgCAGAAIAXAAQAFAAACACIAEAFIB9EnIAAAAIgCAHQgCACgHAAgAAsArIgshsIgsBsIBYAAg");
	this.shape_6.setTransform(79.2,114.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhlCcQgFAAgDgDQgEgCAAgGIAAkgQAAgFAEgDQADgEAFAAIB1AAQAVAAASAIQASAJANAOQANANAHATQAIASAAAUQgBATgGASQgIARgMAOQgOANgSAJQgRAIgVAAIhEAAIAABlQABALgMAAgAgzgKIA6AAQAJAAAJgDQAHgEAGgGQAGgHADgIQAEgIAAgJQAAgIgEgIQgDgIgGgHQgGgGgHgEQgJgEgJAAIg6AAg");
	this.shape_7.setTransform(50.4,114.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgUCcIgDgBIgEgCIgCgEIgBgDIAAjzIhNAAQgDAAgDgEQgEgCAAgGIAAglQAAgEAEgCQADgDADAAIDWAAIAHADQAEACAAAEIAAAlQAAAFgDADQgDAEgFAAIhMAAIAADzIgBADIgCAEIgDACIgEABg");
	this.shape_8.setTransform(21,114.9);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AhlCcQgFAAgDgEQgDgDgBgFIAAkgQABgFADgDQADgDAFAAIAnAAQALAAAAALIAABlIBEAAQAVAAARAIQATAJANAOQAMAMAIASQAGASABATQAAAUgIATQgHARgNAOQgNAOgSAJQgSAIgVAAgAgzBlIA6AAQAJAAAJgEQAHgEAGgFQAGgIADgIQAEgHAAgKQAAgIgEgIQgDgJgGgFQgGgHgHgDQgJgFgJAAIg6AAg");
	this.shape_9.setTransform(279.1,57.3);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgUCcIgDgBIgEgDIgCgDIgBgEIAAjzIhNAAQgEAAgCgCQgEgEAAgFIAAgkQAAgEAEgDQACgDAEAAIDWAAIAHACQAEADAAAFIAAAkQAAAFgDADQgDAEgFgBIhMAAIAADzIgBAEIgCADIgDADIgEABg");
	this.shape_10.setTransform(249.7,57.3);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("ABUCcQgKAAAAgJIAAjPIiQDRIgFAFIgEACIgtAAQgKAAAAgJIAAkkQgBgFAEgDIAHgCIArAAIAEABQADACACAEIAADBICJjBIAFgFIAHgCIAxAAQAFAAACADQACADABAEIAAEkQAAAJgKAAg");
	this.shape_11.setTransform(220.3,57.3);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AB/CcQgFAAgDgDQgDgDgBgFIgTi8IhEC2IgEAGQgEAEgDAAIgiAAQgDAAgDgDIgEgGIgihbIgihcIgTC8QgBAFgDADQgDADgFAAIgmAAQgLAAAAgMIAdkgQABgFADgDQADgDAFAAIAxAAQAEAAADACIAFAIIARAwIASAyIAmBoIBKjKIAAAAQABgFAEgDQADgCAEAAIAxAAQAEAAAEADQADADAAAFIAeEhQAAAFgDADQgDADgFAAg");
	this.shape_12.setTransform(183.7,57.3);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AhlCcQgGAAgDgDQgCgDAAgFIAAkgQAAgGACgDQADgDAGAAIB1AAQAVAAASAJQASAHANAOQANAOAHATQAHASABAUQAAATgIASQgHARgMAOQgNANgTAJQgRAIgVAAIhDAAIAABlQAAALgMAAgAgygKIA5AAQAJAAAIgDQAJgEAGgHQAFgGAEgHQADgJAAgJQAAgJgDgIQgEgHgFgHQgGgGgJgFQgIgDgJAAIg5AAg");
	this.shape_13.setTransform(151.5,57.3);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("");
	this.shape_14.setTransform(118.8,57.3);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("");
	this.shape_15.setTransform(85.2,57.3);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("");
	this.shape_16.setTransform(51.6,57.3);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("ABICcQgEAAgDgDQgCgCAAgEIAAj3Ih8AAIAAD3QAAAEgDACQgDADgEAAIgpAAQgEAAgCgDQgDgCAAgDIAAkmQAAgJAIAAIDjAAIAGACQACACAAAFIAAElQAAAEgDACQgCADgEAAg");
	this.shape_17.setTransform(18.1,57.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ33, new cjs.Rectangle(0,27.8,293.4,117.1), null);
...
(lib.Символ56 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AAuBKIgDAAIgBgDIgKgXIg/AAIgKAXQAAABAAABQgBAAAAAAQgBABAAAAQgBAAAAAAIgVAAQgBAAgBAAQAAAAgBAAQAAAAAAAAQAAgBgBAAIgBgCIAQgkIAshpIABgCIAEgBIALAAIADABIACACIA8CMIAAAAIgBADQgBAAAAAAQgBABAAAAQgBAAAAAAQgBAAgBAAgAAVAVIgVgzIgUAzIApAAg");
	this.shape.setTransform(123.8,16.2);
	...
	this.shape_1.setTransform(108.7,16.2);
	...
	this.shape_2.setTransform(93.9,16.2);
	...
	this.shape_3.setTransform(78,16.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(61.6,16.2);
	...
	this.shape_5.setTransform(46.2,16.2);
...
(lib.Символ56_1 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAuBKIgDAAIgBgDIgKgXIg/AAIgKAXQAAABAAABQgBAAAAAAQgBABAAAAQgBAAAAAAIgVAAQgBAAgBAAQAAAAgBAAQAAAAAAAAQAAgBgBAAIgBgCIAQgkIAshpIABgCIAEgBIALAAIADABIACACIA8CMIAAAAIgBADQgBAAAAAAQgBABAAAAQgBAAAAAAQgBAAgBAAgAAVAVIgVgzIgUAzIApAAg");
	this.shape_6.setTransform(123.8,16.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("");
	this.shape_7.setTransform(108.7,16.2);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AAiBKIgDgBQAAAAgBgBQAAAAAAAAQAAgBAAAAQAAgBAAAAIAAh1Ig6AAIAAB1IgCADIgDABIgUAAIgDgBQAAAAAAAAQAAgBgBAAQAAAAAAgBQAAAAAAgBIAAiLQAAgEAEAAIBrAAIADABIABADIAACLIgBADIgEABg");
	this.shape_8.setTransform(93.9,16.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("");
	this.shape_9.setTransform(78,16.2);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("");
	this.shape_10.setTransform(61.6,16.2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("");
	this.shape_11.setTransform(46.2,16.2);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/boka.png?1491828939916", id:"boka"},
		{src:"images/dent.png?1491828939916", id:"dent"},
		{src:"images/face1.png?1491828939916", id:"face1"},
		{src:"images/foot_left.png?1491828939916", id:"foot_left"},
		{src:"images/foot_right.png?1491828939916", id:"foot_right"},
		{src:"images/glass.png?1491828939916", id:"glass"},
		{src:"images/gold1.png?1491828939916", id:"gold1"},
		{src:"images/gold2.png?1491828939916", id:"gold2"},
		{src:"images/hair.png?1491828939916", id:"hair"},
		{src:"images/hand1.png?1491828939916", id:"hand1"},
		{src:"images/hvost.png?1491828939916", id:"hvost"},
		{src:"images/konec.png?1491828939916", id:"konec"},
		{src:"images/lip.png?1491828939916", id:"lip"},
		{src:"images/lokot.png?1491828939916", id:"lokot"},
		{src:"images/nog_left.png?1491828939916", id:"nog_left"},
		{src:"images/nog_right.png?1491828939916", id:"nog_right"},
		{src:"images/pirojenko.png?1491828939916", id:"pirojenko"},
		{src:"images/ple40.png?1491828939916", id:"ple40"},
		{src:"images/ple4o.png?1491828939916", id:"ple4o"},
		{src:"images/shadow.png?1491828939916", id:"shadow"},
		{src:"images/waves.png?1491828939916", id:"waves"},
		{src:"images/zoloto.png?1491828939916", id:"zoloto"}
	],
	preloads: []
};
