...
(lib.Символ33 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgNCjIgLgHIgIgLQgCgHgBgHQABgIACgGIAIgLQAFgFAGgDQAHgDAGAAQAHAAAHADQAHADAEAFIAIALQACAGAAAIQAAAHgCAHQgDAGgFAFQgEAFgHACQgHADgHAAQgGAAgHgDgAgTBBQgFAAgEgEQgDgDAAgFIAAjOQAAgGADgDQADgDAGAAIAnAAQAGAAADADQADADAAAGIAADOQAAAFgDADQgDAEgGAAg");
	this.shape.setTransform(552.8,31.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(527.2,30.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgVCkIgDgBIgEgDIgCgEIgBgDIAAj/IhQAAQgEAAgEgDQgEgEABgEIAAgnQgBgFAEgCQAEgDAEAAIDgAAIAHADQADABAAAGIAAAnQAAAEgCAEQgDADgFAAIhQAAIAAD/IgBADIgCADIgEAEIgDABg");
	this.shape_2.setTransform(493.1,30.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(464.7,30.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("ABYCkQgLAAABgKIAAjZIiYDbIgFAGIgEACIgvAAQgLAAAAgKIAAkyQAAgFAEgCIAHgDIAsAAIAGABQADABABAEIAADLICQjLIAFgEIAHgCIA0AAQAFAAACADQADACAAAFIAAEyQAAAKgKAAg");
	this.shape_4.setTransform(418.8,30.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AiMCjQgDgDAAgEIAAglQAAgKAKAAQAGAAAFgDIAKgHIAGgKIADgLIAAjpIACgGQACgDAEAAIDlAAIAHACQADACAAAEIAAE1QAAAJgJAAIgsAAIgGgCQgDgCAAgFIAAkDIh8AAIAACoQAAAUgGATQgGASgLAPQgMAOgRAJQgRAIgWAAQgFAAgCgCg");
	this.shape_5.setTransform(383.2,31);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(352.2,30.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhsCkIgHgCQgDgDAAgEIAAkyQAAgLAKAAIDTAAQAGAAACADQADADAAAFIAAAnQAAADgDAEQgDADgFAAIicAAIAABDIB4AAQAEAAADACQACACAAAGIAAAmIgCAHQgCAEgFgBIh4AAIAABQICiAAQAGABACACQACACAAAGIAAApQAAAJgKAAg");
	this.shape_7.setTransform(323.3,30.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AAAA3IgDgBIgLgIQgDgCAAgEQABgEACgCIACgFIADgFIADgIIgMgFIgJgIIgGgKIgDgMQAAgIADgGQADgHAFgFQAFgFAHgCQAGgDAHAAQAIAAAGADQAHACAEAFQAGAGACAHQADAHAAAJQAAARgEAOQgDAOgGAJQgFAJgGAFQgGAEgDAAg");
	this.shape_8.setTransform(288.8,46.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("ABYCkQgLAAABgKIAAjZIiYDbIgFAGIgEACIgvAAQgLAAAAgKIAAkyQAAgFAEgCIAHgDIAsAAIAGABQADABABAEIAADLICQjLIAFgEIAHgCIA0AAQAFAAACADQADACAAAFIAAEyQAAAKgKAAg");
	this.shape_9.setTransform(264.9,30.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("ABtDKQgHAAAAgHIAAhGIjOAAIAABGQAAAHgHAAIgpAAQgHAAAAgHIAAh4QAAgJAIAAIAbAAQAMgUAJgUQAJgTAGgUQAFgWAEgZIAEg4IAAgmIABgnQAAgIAHAAIC3AAIAFACQACACAAAEIAAEDIAcAAIAHACQACACAAAFIAAB4QAAAHgHAAgAgShYQgCAogKAnQgKAngRAkIB3AAIAAjQIhOAAg");
	this.shape_10.setTransform(229.4,34.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("");
	this.shape_11.setTransform(193.3,30.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("ABTCkQgFgBgDgCIgGgGIgjg0IgigyIghAyIgjA0IgGAGQgDACgFABIgzAAQgIAAAAgHIACgFIAEgGIBkiSIgWggIgWgiIgagmIgfgtIgDgIQAAgDADgBIAHgBIAyAAQAFAAAEADIAIAKIA+BeIBChhQAGgJAKgBIAvAAIAIABQACABAAADIAAAEIgCAEIhkCVIBlCUIACAGIACADQAAAHgHAAg");
	this.shape_12.setTransform(161.2,30.8);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("ABlCkIgHgCIgDgGIgWgzIiKAAIgWAzQgBAIgHAAIgtAAQgGAAgCgCQgDgCAAgFIAhhOIBijoIADgFQADgCAGAAIAZAAQAEAAADACIAEAFICDE1IAAABIgCAGQgCADgIAAgAAvAuIgvhyIguByIBdAAg");
	this.shape_13.setTransform(128.9,30.8);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("");
	this.shape_14.setTransform(98.4,31);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("");
	this.shape_15.setTransform(51,30.8);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AgVCkIgDgBIgEgDIgCgEIgBgDIAAj/IhQAAQgEAAgEgDQgEgEABgEIAAgnQgBgFAEgCQAEgDAEAAIDgAAIAHADQADABAAAGIAAAnQAAAEgCAEQgDADgFAAIhRAAIAAD/IAAADIgCADIgEAEIgDABg");
	this.shape_16.setTransform(15.2,30.8);
...
(lib.Символ36копия = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	this.shape.setTransform(99,74.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("");
	this.shape_1.setTransform(113.4,75.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("");
	this.shape_2.setTransform(129,75.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("");
	this.shape_3.setTransform(144.4,75.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("");
	this.shape_4.setTransform(162.4,75.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#333333").s().p("");
	this.shape_5.setTransform(188.7,75.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#333333").s().p("");
	this.shape_6.setTransform(204.9,75.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#333333").s().p("");
	this.shape_7.setTransform(220.8,75.2);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#333333").s().p("AAvBPQgIgFgGgHQgGgIgDgIQgDgKAAgKIAAhTIg9AAIAACBIgBADIgDABIgWAAQgFAAAAgEIAAiaQAAAAAAgBQAAAAABgBQAAAAAAgBQAAAAABgBIADgBIByAAQABABAAAAQABAAAAAAQAAAAABAAQAAABAAAAIABAEIAABzIACAFIADAGIAFADIAFABQAFAAAAAGIAAASIgBADIgEABQgLAAgJgDg");
	this.shape_8.setTransform(71.9,44.3);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#333333").s().p("");
	this.shape_9.setTransform(89.6,44.2);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#333333").s().p("");
	this.shape_10.setTransform(107.2,44.2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#333333").s().p("");
	this.shape_11.setTransform(125,44.2);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#333333").s().p("");
	this.shape_12.setTransform(142.1,44.3);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#333333").s().p("");
	this.shape_13.setTransform(162.5,44.2);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#333333").s().p("");
	this.shape_14.setTransform(178.9,44.2);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#333333").s().p("");
	this.shape_15.setTransform(204.4,44.2);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#333333").s().p("");
	this.shape_16.setTransform(222.3,44.2);
...
(lib.Символ36 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("AgIBsIgIgGIgFgHIgBgJQAAgFABgEIAFgIIAIgEIAIgCQAFAAAEACQAFABADADIAFAIQABAEAAAFIgBAJIgFAHQgDAEgFACQgEACgFAAQgEAAgEgCgAgMAqQgDAAgDgCQgCgCAAgDIAAiIQAAgDACgCQACgCAEAAIAZAAQAEAAACACQACACAAADIAACIQAAADgCACQgCACgEAAg");
	this.shape.setTransform(214.9,78.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AhFBsQgFAAgBgDQgCgCAAgDIAAjHQAAgEACgCQABgCAFAAIAbAAQAHAAAAAIIAABGIAvAAQAOAAANAFQAMAGAIAKQAKAIAFANQAEAMAAANQAAAOgFANQgFAMgJAKQgJAJgMAGQgMAGgPAAgAgjBGIAoAAQAGAAAGgDQAFgCAEgFQAFgEABgGQADgGAAgFQAAgHgDgFQgBgGgFgEQgDgFgHgCQgFgDgGAAIgoAAg");
	this.shape_1.setTransform(202.4,78.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("");
	this.shape_2.setTransform(181.9,78.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("AhHBsIgEgCQgBAAAAgBQgBAAAAgBQAAAAAAgBQAAgBAAAAIAAjKQAAgHAGAAICLAAQAEAAABACQACADAAADIAAAZQAAADgCACQgCACgDAAIhmAAIAAAsIBOAAQADAAACABQABACAAADIAAAaIgBAEQgBABAAAAQgBAAAAABQgBAAAAAAQgBAAgBAAIhOAAIAAA1IBpAAQAEAAACACQABACAAADIAAAbQAAAGgGAAg");
	this.shape_3.setTransform(162.9,78.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("");
	this.shape_4.setTransform(141.1,80.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#333333").s().p("");
	this.shape_5.setTransform(120.5,78.5);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#333333").s().p("");
	this.shape_6.setTransform(91.8,78.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#333333").s().p("AgIBrIgIgEIgFgHIgBgKQAAgEABgFIAFgIIAIgEIAIgCQAFAAAEACQAFACADACIAFAIQABAFAAAEIgBAKIgFAHQgDADgFABQgEACgFABQgEgBgEgCgAgMAqQgDAAgDgBQgCgCAAgEIAAiIQAAgDACgDQACgCAEAAIAZAAQAEAAACACQACADAAADIAACIQAAAEgCACQgCABgEAAg");
	this.shape_7.setTransform(178,38.2);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#333333").s().p("");
	this.shape_8.setTransform(165.4,38.3);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#333333").s().p("");
	this.shape_9.setTransform(146.4,38);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#333333").s().p("AguASQgDAAgDgCQgCgCAAgEIAAgUQAAgDACgCQADgCADAAIBeAAQADAAACACQACACAAADIAAAUQAAACgCADQgCADgDAAg");
	this.shape_10.setTransform(128.4,40.5);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#333333").s().p("");
	this.shape_11.setTransform(112.4,38.3);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#333333").s().p("");
	this.shape_12.setTransform(93.4,38);
...
(lib.Символ56 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AAoBKQgFAAAAgEIAAhiIhEBjIgCACIgCABIgWAAQgEAAAAgEIAAiLQAAAAAAgBQAAAAAAgBQAAAAABAAQAAgBAAAAIADgBIAVAAIACAAIACADIAABcIBBhcIACgCIAEgBIAXAAQABAAAAAAQABAAAAAAQAAAAABABQAAAAAAAAIABADIAACLQAAAEgEAAg");
	this.shape.setTransform(108.8,-0.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(93.8,-0.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(79.8,-2.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAuBKIgDAAIgBgDIgLgXIg+AAIgKAXQAAABAAABQgBAAAAABQgBAAAAAAQgBAAAAAAIgVAAQgBAAgBAAQAAAAgBAAQAAAAAAAAQAAAAgBgBIgBgCIAQgkIAshpIABgCIAEgBIALAAIADABIACACIA8CMIAAAAIgBADQgBAAAAAAQgBABAAAAQgBAAAAAAQgBAAgBAAgAAVAVIgVgzIgUAzIApAAg");
	this.shape_3.setTransform(64.3,-0.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(50.4,-0.1);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/boka.png?1491912643407", id:"boka"},
		{src:"images/dent.png?1491912643407", id:"dent"},
		{src:"images/face.png?1491912643407", id:"face"},
		{src:"images/foot_left.png?1491912643407", id:"foot_left"},
		{src:"images/foot_right.png?1491912643407", id:"foot_right"},
		{src:"images/glass.png?1491912643407", id:"glass"},
		{src:"images/hair.png?1491912643407", id:"hair"},
		{src:"images/hand11.png?1491912643407", id:"hand11"},
		{src:"images/hvost.png?1491912643407", id:"hvost"},
		{src:"images/konec.png?1491912643407", id:"konec"},
		{src:"images/lip.png?1491912643407", id:"lip"},
		{src:"images/lokot.png?1491912643407", id:"lokot"},
		{src:"images/nog_left.png?1491912643407", id:"nog_left"},
		{src:"images/nog_right.png?1491912643407", id:"nog_right"},
		{src:"images/ple40.png?1491912643407", id:"ple40"},
		{src:"images/ple4o.png?1491912643407", id:"ple4o"},
		{src:"images/waves.png?1491912643407", id:"waves"}
	],
	preloads: []
};
