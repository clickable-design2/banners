...
(lib.Символ14 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00FF00").s().p("AhZBaQglglAAg1QAAg0AlglQAmglAzAAQA1AAAlAlQAlAlAAA0QAAA1glAlQglAlg1AAQgzAAgmglgAhKhKQgfAfAAArQAAAsAfAfQAfAfArAAQAsAAAfgfQAfgfAAgsQAAgrgfgfQgfgfgsAAQgrAAgfAfg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ14, new cjs.Rectangle(-12.7,-12.6,25.4,25.4), null);
...
(lib.Символ21 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(9).to({_off:false},0).to({scaleX:0.81,scaleY:0.81,alpha:0},9).wait(1));

	// Слой 2 - копия: 2
	this.instance_1 = new lib.Символ14();
	this.instance_1.parent = this;
	this.instance_1.setTransform(0,0,0.413,0.413);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(6).to({_off:false},0).to({scaleX:0.81,scaleY:0.81,alpha:0},9).to({_off:true},1).wait(3));

	// Слой 2 - копия
	this.instance_2 = new lib.Символ14();
	this.instance_2.parent = this;
	this.instance_2.setTransform(0,0,0.413,0.413);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(3).to({_off:false},0).to({scaleX:0.81,scaleY:0.81,alpha:0},9).to({_off:true},1).wait(6));

	// Слой 2
	this.instance_3 = new lib.Символ14();
	this.instance_3.parent = this;
	this.instance_3.setTransform(0,0,0.413,0.413);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({scaleX:0.81,scaleY:0.81,alpha:0},9).to({_off:true},1).wait(9));
...
(lib.Символ6 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,0,3.648,3.648);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00FF00").s().p("AhMBNQghgfAAguQAAgsAhggQAgghAsAAQAuAAAfAhQAhAgAAAsQAAAughAfQgfAhguAAQgsAAggghgAgcgbQgKAMgBAPQABAQAKANQANAKAPABQAQgBANgKQAKgNABgQQgBgPgKgMQgNgLgQgBQgPABgNALg");

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ6, new cjs.Rectangle(-19.1,-19,38.3,38.2), null);
...
(lib.Символ59 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-231.7,12.5);
...
}).prototype = getMCSymbolPrototype(lib.Символ59, new cjs.Rectangle(-310.4,-109.1,680.8,218.3), null);
...
(lib.Символ23 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-1014.6,478.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-1018,y:408},5).to({x:-989.4,y:331.5},9).to({x:-974.1,y:357.2},4).to({x:-970.3,y:436.9},6).to({x:-938.2,y:529.1},6).to({x:-943.5,y:402.5},7).to({x:-903.2,y:330.9},8).to({x:-874,y:377.3},9).to({x:-844.8,y:554.4},9).to({x:-801.2,y:359.8},8).to({x:-788.8,y:296.7},8).to({x:-750.2,y:510.7},12).to({x:-733.4,y:342.7},8).to({x:-678,y:318.7},8).to({x:-568.1,y:326.1},7).to({x:-515.9,y:277.2},6).to({x:-518.3,y:128.5},9).to({x:-511.6,y:84},11).to({x:-487.6,y:173.5},10).to({x:-491.4,y:262.6},9).to({x:-461.6,y:113.5},11).to({x:-437.1,y:95.8},9).to({x:-409.1,y:262.4},15).to({x:-365.2,y:243},7).to({x:-364.1,y:120},8).to({x:-367.2,y:79.7},10).to({x:-347.4,y:242.4},7).to({x:-335.9,y:266.2},3).to({x:-320.7,y:268.4},4).to({x:-274.2,y:102},6).wait(1));

	// Слой 2 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("EhyvAosMAAAhRXMC3qAAAMAAABRXg");
	mask.setTransform(-734.4,195.1);

	// Слой 1
	this.instance_1 = new lib.Символ17();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-305.9,153);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-1329.7,y:685},239).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1033.7,-65.3,740.4,562.6);
...
(lib.Символ5 = function(mode,startPosition,loop) {
	...
	this.graf1.setTransform(-201,471.9,0.81,0.81,0,0,0,-293.2,455.4);

	this.timeline.addTween(cjs.Tween.get(this.graf1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ5, new cjs.Rectangle(-1153.3,-329.7,2021.1,865.6), null);
...
(lib.fullscreen = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		var _this = this;
		    ...
		    _this.btn.x = w < h ? iw * 0.5 : iw * 0.7;
		    _this.btn.y = w < h ? ((w < 321) ? ih * 0.37 : ih * 0.37) : ih * 0.65;
			
			_this.man.x = w < h ? iw * 0.5 : ((w > 1020) ? iw * 0.25 : ((w < 481) ? iw * 0.25 : iw * 0.2));
		    _this.man.y = ((w < h && w < 321) ? ih * 1.2 : ((w > 1020) ? ih * 0.93 : ih * 1.1));
			
			_this.txt.x = w < h ? iw * 0.5 : iw * 0.7;
		    _this.txt.y = w < h ? ((w < 321) ? ih * 0.17 : ih * 0.14) : ih * 0.3;
			
			_this.dollars_niz.x = w < h ? iw * 0.5 : ((w > 1020) ? iw * 0.25 : iw * 0.2);
			_this.dollars_niz.y = ((w > 1020) ? ih * 0.9 : ih);
		    
			_this.dollars_verh.x = w < h ? iw * 0.5 : ((w > 1020) ? iw * 0.25 : iw * 0.2);
			_this.dollars_verh.y = w < h ? ih * 0.5 : ((w > 1020) ? ih * 0.15 : 0);
		    ...
		    function setScale(scale) {
		        ...
		        _this.btn.scaleX = _this.btn.scaleY = ((w < h) ? scale * 0.9 :  (w > 1020) ? scale : scale * 0.7);
				_this.man.scaleX = _this.man.scaleY = w < h ? scale * 0.9 : ((w > 1020) ? scale * 0.9 : ((w > 950) ? scale * 0.9 : scale * 0.65));
				_this.txt.scaleX = _this.txt.scaleY = ((w < h) ? scale * 0.9 : (w > 1020) ? scale : scale * 0.7);
				_this.dollars_verh.scaleX = _this.dollars_verh.scaleY = ((w < h) ? scale : scale * 0.6);;
				_this.dollars_niz.scaleX = _this.dollars_niz.scaleY = w < h ? scale : scale * 0.6;
	...
	this.graf.setTransform(1024,765.4,1,1,0,0,0,-203.3,469.6);

	this.timeline.addTween(cjs.Tween.get(this.graf).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(586,-192,2021.1,1407.6);
// library properties:
lib.properties = {
	width: 1024,
	height: 768,
