...
(lib.Символ1 = function(mode,startPosition,loop) {
	...
	this.man1.setTransform(-78.7,50.4,1.191,1.191,0,0,0,-61.4,87);

	this.timeline.addTween(cjs.Tween.get(this.man1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ1, new cjs.Rectangle(-257.4,-429.9,336.4,500.3), null);
	...
	this.frame_0 = function() {
		...
		window._setCanvasSize = function() {
		    ...
		    function setScale(scale) {
		        ...
		        _this.btn.scaleX = _this.btn.scaleY = ((w < h && w > 599 || w > h && w > 1020) ? scale * 0.8 : scale);
				_this.man.scaleX = _this.man.scaleY = ((w > h) ? scale * 1.2 : scale);
				_this.txt.scaleX = _this.txt.scaleY = ((w < h && w > 599 || w > h && w > 1020) ? scale * 0.7 : scale);
