...
(lib.Символ15 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-815,-111);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ15, new cjs.Rectangle(-815,-111,1630,370), null);
...
(lib.Символ12 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(3).to({x:-81},0).to({x:26.2,alpha:0.711},3,cjs.Ease.get(1)).to({scaleY:1.12,skewX:-27.1,x:32.8,alpha:1},4,cjs.Ease.get(1)).to({scaleY:1,skewX:0,x:-1},4,cjs.Ease.get(1)).wait(35).to({rotation:6.5,x:-0.9,y:-21.6},3,cjs.Ease.get(1)).to({rotation:0,x:-1,y:85.4,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// txt.png - копия
	this.instance_1 = new lib.Символ13();
	this.instance_1.parent = this;
	this.instance_1.setTransform(10.4,-58.3);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({x:90.4},0).to({x:-26.8,alpha:0.711},3,cjs.Ease.get(1)).to({scaleY:1.1,skewX:-24.4,x:-30.4,alpha:1},4,cjs.Ease.get(1)).to({scaleY:1,skewX:0,x:10.4},4,cjs.Ease.get(1)).wait(37).to({rotation:-4,y:-78.3},3,cjs.Ease.get(1)).to({rotation:0,y:28.7,alpha:0},7,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(19).to({y:81.8},0).to({y:61.8,alpha:1},8,cjs.Ease.get(1)).wait(22).to({scaleX:0.89,scaleY:0.89,rotation:-5,y:41.8},3,cjs.Ease.get(1)).to({scaleX:1,scaleY:1,rotation:0,y:148.8,alpha:0},7,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-218,-87,434.5,173.6);
...
(lib.Символ19 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,-0.5,0.93,0.93);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ19, new cjs.Rectangle(-202.7,-81.4,404.1,161.4), null);
...
(lib.Символ1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(183.7,-398);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-48,-1003);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(-73.2,6.6,1.486,1.486,0,0,0,-49.7,57.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ1, new cjs.Rectangle(-383,-1091.5,654,1130.5), null);
...
(lib.fullscreen = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		window._setCanvasSize = function() {
			...
			_this.txt.x = w < h ? iw / 2 : ((w > 950) ? iw * 0.8 : iw * 0.77);
		    _this.txt.y = w < h ? ((w < h && w > 599) ? ih * 0.23 : ih * 0.18) : ih * 0.5;
			
			_this.dark.x = iw * 0.5;
			_this.dark.y = w < h ? 0 : ih;
		    
			/* Функция ресайза */
		    function setScale(scale) {
				
				_this.man.scaleX = _this.man.scaleY = ((w > h) ? scale * 1.1 : scale);
				_this.txt.scaleX = _this.txt.scaleY = ((w < h && w > 599 || w > h && w > 1023) ? scale * 0.8 : scale);
	...
	this.man.setTransform(743.7,315.6,1,1,0,0,0,-80.2,12.8);

	this.timeline.addTween(cjs.Tween.get(this.man).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(168.9,-404.7,1630,1251.8);
// library properties:
lib.properties = {
	width: 1024,
	height: 768,
