...
(lib.Символ4 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("ПОКУПАЙ", "100px 'KULAG'", "#00FF00");
	this.text.textAlign = "center";
	this.text.lineHeight = 122;
	this.text.lineWidth = 360;
	this.text.parent = this;
	this.text.setTransform(182,2);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ4, new cjs.Rectangle(0,0,363.9,124), null);
...
(lib.Символ3 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("УДОБНО", "100px 'KULAG'", "#00FF00");
	this.text.textAlign = "center";
	this.text.lineHeight = 122;
	this.text.lineWidth = 303;
	this.text.parent = this;
	this.text.setTransform(153.3,2);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ3, new cjs.Rectangle(0,0,306.5,124), null);
...
(lib.Символ2 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("ПРИЛОЖЕНИЕ", "100px 'KULAG'", "#00FF00");
	this.text.textAlign = "center";
	this.text.lineHeight = 122;
	this.text.lineWidth = 498;
	this.text.parent = this;
	this.text.setTransform(251.2,2);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ2, new cjs.Rectangle(0,0,502.5,124), null);
...
(lib.Symbol42 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("УСТАНОВИ", "100px 'KULAG'", "#00FF00");
	this.text.textAlign = "center";
	this.text.lineHeight = 122;
	this.text.lineWidth = 349;
	this.text.parent = this;
	this.text.setTransform(176.5,2);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol42, new cjs.Rectangle(0,0,352.9,124), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ1, new cjs.Rectangle(0,0,352.9,124), null);
...
(lib.Symbol43 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(40).to({_off:false},0).to({regX:153.2,regY:62,scaleX:0.79,scaleY:0.79,x:425.8,y:145.6},9).to({regX:153.3,regY:62.1,scaleX:1.58,scaleY:1.58,x:425.9,y:145.7},10).to({regX:153.2,regY:62,scaleX:0.79,scaleY:0.79,x:425.8,y:145.6},10).to({regX:153.3,regY:62.1,scaleX:1.58,scaleY:1.58,x:425.9,y:145.7},10).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(40).to({_off:false},0).to({regY:62,scaleX:1.39,scaleY:1.39,y:145.5},9).to({regY:62.1,scaleX:0.75,scaleY:0.75,y:145.6},10).to({regY:62,scaleX:1.39,scaleY:1.39,y:145.5},10).to({regY:62.1,scaleX:0.75,scaleY:0.75,y:145.6},10).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regX:176.5,regY:62.1,scaleX:1.39,scaleY:1.39,x:-4.3,y:145.6},9).to({regX:176.4,regY:62,scaleX:0.71,scaleY:0.71,x:-4.4,y:145.4},10).to({regX:176.5,regY:62.1,scaleX:1.39,scaleY:1.39,x:-4.3,y:145.6},10).to({regX:176.4,regY:62,scaleX:0.71,scaleY:0.71,x:-4.4,y:145.4},10).to({_off:true},1).wait(40));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({scaleX:0.75,scaleY:0.75},9).to({scaleX:1.36,scaleY:1.36},10).to({scaleX:0.75,scaleY:0.75},10).to({scaleX:1.36,scaleY:1.36},10).to({_off:true},1).wait(40));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-130.1,61.1,914.3,168.7);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(480.2,85.6,0.709,0.709,0,0,0,176.5,62);
...
p.nominalBounds = new cjs.Rectangle(425.7,309,1218.3,1177);
// library properties:
lib.properties = {
	width: 1024,
	height: 768,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1485768139048", id:"back"},
		{src:"images/bubles.png?1485768139048", id:"bubles"},
		{src:"images/Button.png?1485768139048", id:"Button"},
		{src:"images/cofii.png?1485768139048", id:"cofii"},
		{src:"images/gamepad.png?1485768139048", id:"gamepad"},
		{src:"images/hand.png?1485768139048", id:"hand"},
		{src:"images/Iphone.png?1485768139048", id:"Iphone"},
		{src:"images/knopka.png?1485768139048", id:"knopka"},
		{src:"images/Layer13.png?1485768139048", id:"Layer13"},
		{src:"images/Layer14.png?1485768139048", id:"Layer14"},
		{src:"images/Layer5.png?1485768139048", id:"Layer5"},
		{src:"images/light.png?1485768139048", id:"light"},
		{src:"images/logotxt.png?1485768139048", id:"logotxt"},
		{src:"images/mikrovoln.png?1485768139048", id:"mikrovoln"},
		{src:"images/nout.png?1485768139048", id:"nout"},
		{src:"images/plita.png?1485768139048", id:"plita"},
		{src:"images/ring.png?1485768139048", id:"ring"},
		{src:"images/smartphone.png?1485768139048", id:"smartphone"},
		{src:"images/stirka.png?1485768139048", id:"stirka"},
		{src:"images/wifi.png?1485768139048", id:"wifi"},
		{src:"images/wifirou.png?1485768139048", id:"wifirou"}
	],
	preloads: []
};
