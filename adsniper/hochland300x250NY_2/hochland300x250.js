...
(lib.Символ3 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A8lKZIAA0xMA5LAAAIAAUxg");
	mask.setTransform(8.6,65);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(284).to({alpha:0},15).wait(585).to({alpha:1},15).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(584).to({alpha:0},15).wait(301));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1482237881947", id:"bg"},
		{src:"images/blik.png?1482237881947", id:"blik"},
		{src:"images/cake.jpg?1482237881947", id:"cake"},
		{src:"images/chern.png?1482237881947", id:"chern"},
		{src:"images/kon_02.jpg?1482237881947", id:"kon_02"},
		{src:"images/kur.jpg?1482237881947", id:"kur"},
		{src:"images/logo_03.png?1482237881947", id:"logo_03"},
		{src:"images/pack_03.png?1482237881947", id:"pack_03"},
		{src:"images/plash_02.png?1482237881947", id:"plash_02"}
	],
	preloads: []
};
