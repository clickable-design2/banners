...
(lib.Символ3 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(19).to({x:-47},7).to({x:-67,y:119},3).wait(240).to({y:121.5},0).to({x:-47},3).to({x:-359.1},7).wait(40).to({x:-47},7).to({x:-67,y:119},3).wait(240).to({y:121.5},0).to({x:-47},3).to({x:-359.1},7).wait(40).to({x:-47},7).to({x:-67,y:119},3).wait(229).to({y:121.5},0).to({x:-47},3).to({x:-359.1},7).wait(20).to({regX:-0.2,regY:0.1,scaleX:0.65,scaleY:0.65,rotation:-15,x:-8.3,y:70.7},11,cjs.Ease.get(1)).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1482219772099", id:"bg"},
		{src:"images/blik.png?1482219772099", id:"blik"},
		{src:"images/cake.jpg?1482219772099", id:"cake"},
		{src:"images/kon_02.jpg?1482219772099", id:"kon_02"},
		{src:"images/kur.jpg?1482219772099", id:"kur"},
		{src:"images/logo_03.png?1482219772099", id:"logo_03"},
		{src:"images/pack_03.png?1482219772099", id:"pack_03"},
		{src:"images/plash_02.png?1482219772099", id:"plash_02"}
	],
	preloads: []
};
