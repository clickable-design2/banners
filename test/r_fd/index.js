...
(lib.team_2 = function(mode,startPosition,loop) {
	...
	this.text.setTransform(443.9,-11.4);
...
}).prototype = getMCSymbolPrototype(lib.team_2, new cjs.Rectangle(14,-13.4,653,211.3), null);
...
(lib.team_1 = function(mode,startPosition,loop) {
	...
	this.text.lineWidth = 233;
	this.text.parent = this;
	this.text.setTransform(-162.8,-13);
...
(lib.koeff_2 = function(mode,startPosition,loop) {
	...
	this.text.parent = this;
	this.text.setTransform(52.8,-31.7);
...
}).prototype = getMCSymbolPrototype(lib.koeff_2, new cjs.Rectangle(-42.8,-36.1,292.9,73.8), null);
...
(lib.koeff_1 = function(mode,startPosition,loop) {
	...
	this.text.lineWidth = 100;
	this.text.parent = this;
	this.text.setTransform(-11.2,-31.9);
...
}).prototype = getMCSymbolPrototype(lib.koeff_1, new cjs.Rectangle(-203.5,-36.1,292.9,89.4), null);
...
(lib.team_two = function(mode,startPosition,loop) {
	...
	this.koeff_2.setTransform(274,20.8,1,1,0,0,0,65.2,20.8);

	this.timeline.addTween(cjs.Tween.get(this.koeff_2).wait(5).to({regX:103.6,regY:0.8,x:180.5,y:0.8},0).wait(1).to({x:97.9},0).wait(1).to({x:40.8},0).wait(1).to({x:-2.1},0).wait(1).to({x:-37.2},0).wait(1).to({x:-67.3},0).wait(1).to({x:-92.3},0).wait(1).to({x:-111.9},0).wait(1).to({x:-127},0).wait(1).to({x:-138.4},0).wait(1).to({x:-147},0).wait(1).to({x:-153.7},0).wait(1).to({x:-159.1},0).wait(1).to({x:-163.5},0).wait(1).to({regX:65.2,regY:20.8,x:-205.8,y:20.8},0).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-313.9,-36.1,964,263.8);
...
(lib.team_one = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.koeff_1).wait(5).to({regX:-57.1,regY:7.6,x:-228.6,y:7.6},0).wait(1).to({x:-154.5},0).wait(1).to({x:-99.3},0).wait(1).to({x:-56.6},0).wait(1).to({x:-20.9},0).wait(1).to({x:11.3},0).wait(1).to({x:40.4},0).wait(1).to({x:65},0).wait(1).to({x:84.7},0).wait(1).to({x:100.3},0).wait(1).to({x:112.8},0).wait(1).to({x:123},0).wait(1).to({x:131.9},0).wait(1).to({x:139.7},0).wait(1).to({regX:65.2,regY:20.8,x:269.2,y:20.8},0).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-670.7,-36.1,964,262.3);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.btn.setTransform(302.8,263.4,1.181,1.181,0,0,0,96.9,28.8);
	...
	this.sign_two.setTransform(497.5,79.9,1.089,1.089,0,0,0,54.2,53.8);

	this.sign_one = new lib.sign_one();
	this.sign_one.parent = this;
	this.sign_one.setTransform(92,80.1,1.089,1.089,0,0,0,54,54);

	this.koeff_3 = new lib.koeff_3();
	this.koeff_3.parent = this;
	this.koeff_3.setTransform(301.1,203.7,1.631,1.631,0,0,0,62.3,28.6);
	...
	this.date.parent = this;
	this.date.setTransform(299.2,34,0.871,0.871,0,0,0,111.5,41.8);
	...
	this.team_two.setTransform(534.7,156.9,0.612,0.612,0,0,0,65.2,18.8);

	this.team_one = new lib.team_one();
	this.team_one.parent = this;
	this.team_one.setTransform(160.7,156.9,0.612,0.612,0,0,0,65.2,18.8);
	...
	this.instance.parent = this;
	this.instance.setTransform(299.5,-63.3,1.139,1.139,0,0,0,135.1,69.7);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(80.6,266.7,1.117,1.117,0,0,0,59.6,17.9);
	...
	this.black.setTransform(300.2,173.2,0.481,1.675,0,0,0,394,230.2);
	...
	this.bg.parent = this;
	this.bg.setTransform(299.7,149.7,0.519,0.519,0,0,0,300.4,150.1);

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(10.6,27.8,1181.9,597.3);
// library properties:
lib.properties = {
	width: 600,
	height: 300,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1490886663708", id:"bg"},
		{src:"images/light.png?1490886663708", id:"light"},
		{src:"images/logo.png?1490886663708", id:"logo"},
		{src:"images/zagl_1.png?1490886663708", id:"zagl_1"},
		{src:"images/zagl_2.png?1490886663708", id:"zagl_2"}
	],
	preloads: []
};
