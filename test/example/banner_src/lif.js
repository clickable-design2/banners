...
(lib.Символ2 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(185).call(this.frame_185).wait(68));

	// Слой 2
	this.instance = new lib.Символ16();
	this.instance.parent = this;
	this.instance.setTransform(-298.5,180,0.473,0.473,15,0,0,384.6,450.4);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(175).to({_off:false},0).to({regX:384.8,regY:450.2,scaleX:2.17,scaleY:2.17,rotation:-18.9,x:-552.5,y:352.5},5).to({_off:true},15).wait(58));

	// Слой 3 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AwLZjMAAAgytIABAAIAAglIfRAAIAEgDIACAWMAABAzOgARMZiMAAAgzSMAgYAAAMAABAzTgEgxkAZjMAAAgzTIfUAAIAAAMIgBAAMAAAAzHg");
	mask.setTransform(-312.9,240.2);

	// Слой 7
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000000","rgba(0,0,0,0)"],[0.141,1],45.4,0,-25,0).s().p("Aj5ZtMAAAgzYIHzAAMAAAAzYg");
	this.shape.setTransform(-441.3,239.7);
	...
	// Слой 6
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#000000","rgba(0,0,0,0)"],[0.141,1],-45.3,0,25.1,0).s().p("Aj5ZtMAAAgzYIHzAAMAAAAzYg");
	this.shape_1.setTransform(-400.3,239.7);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(253));

	// head.png
	this.instance_1 = new lib.Символ4();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-397.9,171.1,1,1,-6.5,0,0,44,70.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:43.9,rotation:-2,x:-397.7,y:173.1},12,cjs.Ease.get(-1)).to({regX:44,rotation:2.5,x:-397.2,y:175.3},13,cjs.Ease.get(1)).to({regY:70.9,rotation:-1.8,x:-397.6,y:173.2},13,cjs.Ease.get(-1)).to({regY:70.8,rotation:-6.5,x:-397.9,y:171.1},13,cjs.Ease.get(1)).to({regX:43.9,rotation:-2,x:-397.7,y:173.1},12,cjs.Ease.get(-1)).to({regX:44,rotation:2.5,x:-397.2,y:175.3},13,cjs.Ease.get(1)).to({regY:70.9,rotation:-1.8,x:-397.6,y:173.2},13,cjs.Ease.get(-1)).to({regY:70.8,rotation:-6.5,x:-397.9,y:171.1},13,cjs.Ease.get(1)).to({regX:43.9,rotation:-2,x:-397.7,y:173.1},12,cjs.Ease.get(-1)).to({regX:44,rotation:2.5,x:-397.2,y:175.3},13,cjs.Ease.get(1)).to({regY:70.9,rotation:-1.8,x:-397.6,y:173.2},13,cjs.Ease.get(-1)).to({regY:70.8,rotation:-6.5,x:-397.9,y:171.1},13,cjs.Ease.get(1)).to({_off:true},38).wait(62));

	// hand.png
	this.instance_2 = new lib.Символ8();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-323.4,259.8,1,1,0,0,0,86.5,6.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({rotation:-7.3,x:-319.3,y:258.9},12,cjs.Ease.get(-1)).to({rotation:-15.2,x:-314.8,y:257.9},13,cjs.Ease.get(1)).to({regX:86.4,regY:6.9,rotation:-7.5,x:-319.2,y:258.9},13,cjs.Ease.get(-1)).to({regX:86.5,regY:6.8,rotation:0,x:-323.4,y:259.8},13,cjs.Ease.get(1)).to({rotation:-7.3,x:-319.3,y:258.9},12,cjs.Ease.get(-1)).to({rotation:-15.2,x:-314.8,y:257.9},13,cjs.Ease.get(1)).to({regX:86.4,regY:6.9,rotation:-7.5,x:-319.2,y:258.9},13,cjs.Ease.get(-1)).to({regX:86.5,regY:6.8,rotation:0,x:-323.4,y:259.8},13,cjs.Ease.get(1)).to({rotation:-7.3,x:-319.3,y:258.9},12,cjs.Ease.get(-1)).to({rotation:-15.2,x:-314.8,y:257.9},13,cjs.Ease.get(1)).to({regX:86.4,regY:6.9,rotation:-7.5,x:-319.2,y:258.9},13,cjs.Ease.get(-1)).to({regX:86.5,regY:6.8,rotation:0,x:-323.4,y:259.8},13,cjs.Ease.get(1)).wait(13).to({regY:6.9,rotation:36.8,x:-321,y:261.1},4).to({regX:86.4,regY:6.7,rotation:-117,x:-282.4,y:218.4},5).to({_off:true},16).wait(62));

	// Слой 2 - копия
	this.instance_3 = new lib.Символ16();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-390.5,220.1,0.115,0.115,30,0,0,384.4,450.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(170).to({_off:false},0).to({regX:384.5,scaleX:0.18,scaleY:0.18,rotation:26.8,x:-366.5,y:212.1},2).to({regX:384.6,scaleX:0.27,scaleY:0.27,rotation:22.8,x:-344.5,y:201.4},1).to({scaleX:0.37,scaleY:0.37,rotation:18.8,x:-321.5,y:190.7},1).to({_off:true},1).wait(78));

	// tits.png
	this.instance_4 = new lib.Символ7();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-403.9,232,1,1,0,0,0,44,31);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({y:234.2},12,cjs.Ease.get(-1)).to({y:236.5},13,cjs.Ease.get(1)).to({y:234.3},13,cjs.Ease.get(-1)).to({y:232},13,cjs.Ease.get(1)).to({y:234.2},12,cjs.Ease.get(-1)).to({y:236.5},13,cjs.Ease.get(1)).to({y:234.3},13,cjs.Ease.get(-1)).to({y:232},13,cjs.Ease.get(1)).to({y:234.2},12,cjs.Ease.get(-1)).to({y:236.5},13,cjs.Ease.get(1)).to({y:234.3},13,cjs.Ease.get(-1)).to({y:232},13,cjs.Ease.get(1)).to({_off:true},38).wait(62));

	// ple4o.png
	this.instance_5 = new lib.Символ9();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-353.7,197.5,1,1,0,0,0,2.2,13.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({scaleY:1,rotation:-4.5,x:-354.9,y:199.3},12,cjs.Ease.get(-1)).to({regX:2.1,regY:13.7,scaleY:0.99,rotation:-9.7,x:-356,y:201.1},13,cjs.Ease.get(1)).to({regX:2,scaleY:1,rotation:-4.8,x:-354.9,y:199.5},13,cjs.Ease.get(-1)).to({regX:2.2,regY:13.5,scaleY:1,rotation:0,x:-353.7,y:197.5},13,cjs.Ease.get(1)).to({scaleY:1,rotation:-4.5,x:-354.9,y:199.3},12,cjs.Ease.get(-1)).to({regX:2.1,regY:13.7,scaleY:0.99,rotation:-9.7,x:-356,y:201.1},13,cjs.Ease.get(1)).to({regX:2,scaleY:1,rotation:-4.8,x:-354.9,y:199.5},13,cjs.Ease.get(-1)).to({regX:2.2,regY:13.5,scaleY:1,rotation:0,x:-353.7,y:197.5},13,cjs.Ease.get(1)).to({scaleY:1,rotation:-4.5,x:-354.9,y:199.3},12,cjs.Ease.get(-1)).to({regX:2.1,regY:13.7,scaleY:0.99,rotation:-9.7,x:-356,y:201.1},13,cjs.Ease.get(1)).to({regX:2,scaleY:1,rotation:-4.8,x:-354.9,y:199.5},13,cjs.Ease.get(-1)).to({regX:2.2,regY:13.5,scaleY:1,rotation:0,x:-353.7,y:197.5},13,cjs.Ease.get(1)).wait(13).to({scaleY:1,skewX:-4.1,x:-352.7},4).to({scaleY:1.02,skewX:-48.4,skewY:-60,x:-344.5,y:199.3},5).to({_off:true},16).wait(62));

	// kist.png
	this.instance_6 = new lib.Символ10();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-427.7,265.8,1,1,0,0,0,24.2,11.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({y:262.2},12,cjs.Ease.get(-1)).to({y:258.3},13,cjs.Ease.get(1)).to({y:262.1},13,cjs.Ease.get(-1)).to({y:265.8},13,cjs.Ease.get(1)).to({y:262.2},12,cjs.Ease.get(-1)).to({y:258.3},13,cjs.Ease.get(1)).to({y:262.1},13,cjs.Ease.get(-1)).to({y:265.8},13,cjs.Ease.get(1)).to({y:262.2},12,cjs.Ease.get(-1)).to({y:258.3},13,cjs.Ease.get(1)).to({y:262.1},13,cjs.Ease.get(-1)).to({y:265.8},13,cjs.Ease.get(1)).to({_off:true},38).wait(62));

	// body.png
	this.instance_7 = new lib.Символ3();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-390.4,259.5,1,1,0,0,0,50.5,97.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({scaleY:0.99,x:-390.7,y:260.3},12,cjs.Ease.get(-1)).to({scaleY:0.98,x:-390.9,y:261},13,cjs.Ease.get(1)).to({regY:97.6,scaleY:0.99,x:-390.7,y:260.3},13,cjs.Ease.get(-1)).to({regY:97.5,scaleY:1,x:-390.4,y:259.5},13,cjs.Ease.get(1)).to({scaleY:0.99,x:-390.7,y:260.3},12,cjs.Ease.get(-1)).to({scaleY:0.98,x:-390.9,y:261},13,cjs.Ease.get(1)).to({regY:97.6,scaleY:0.99,x:-390.7,y:260.3},13,cjs.Ease.get(-1)).to({regY:97.5,scaleY:1,x:-390.4,y:259.5},13,cjs.Ease.get(1)).to({scaleY:0.99,x:-390.7,y:260.3},12,cjs.Ease.get(-1)).to({scaleY:0.98,x:-390.9,y:261},13,cjs.Ease.get(1)).to({regY:97.6,scaleY:0.99,x:-390.7,y:260.3},13,cjs.Ease.get(-1)).to({regY:97.5,scaleY:1,x:-390.4,y:259.5},13,cjs.Ease.get(1)).to({_off:true},38).wait(62));

	// leg.png
	this.instance_8 = new lib.Символ5();
	this.instance_8.parent = this;
	this.instance_8.setTransform(-370.1,345.2,1,1,0,0,0,22.8,20.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({scaleY:0.96,x:-370.8,y:343.9},12,cjs.Ease.get(-1)).to({scaleY:0.92,x:-371.6,y:342.5},13,cjs.Ease.get(1)).to({scaleY:0.96,x:-370.9,y:343.8},13,cjs.Ease.get(-1)).to({scaleY:1,x:-370.1,y:345.2},13,cjs.Ease.get(1)).to({scaleY:0.96,x:-370.8,y:343.9},12,cjs.Ease.get(-1)).to({scaleY:0.92,x:-371.6,y:342.5},13,cjs.Ease.get(1)).to({scaleY:0.96,x:-370.9,y:343.8},13,cjs.Ease.get(-1)).to({scaleY:1,x:-370.1,y:345.2},13,cjs.Ease.get(1)).to({scaleY:0.96,x:-370.8,y:343.9},12,cjs.Ease.get(-1)).to({scaleY:0.92,x:-371.6,y:342.5},13,cjs.Ease.get(1)).to({scaleY:0.96,x:-370.9,y:343.8},13,cjs.Ease.get(-1)).to({scaleY:1,x:-370.1,y:345.2},13,cjs.Ease.get(1)).to({_off:true},38).wait(62));

	// leg-1.png
	this.instance_9 = new lib.Символ6();
	this.instance_9.parent = this;
	this.instance_9.setTransform(-428.9,337.4,1,1,0,0,0,35,22.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({scaleY:0.99,x:-428.4,y:336.4},12,cjs.Ease.get(-1)).to({regY:22.5,scaleY:0.98,x:-427.9,y:335.4},13,cjs.Ease.get(1)).to({scaleY:0.99,x:-428.4,y:336.4},13,cjs.Ease.get(-1)).to({regY:22.4,scaleY:1,x:-428.9,y:337.4},13,cjs.Ease.get(1)).to({scaleY:0.99,x:-428.4,y:336.4},12,cjs.Ease.get(-1)).to({regY:22.5,scaleY:0.98,x:-427.9,y:335.4},13,cjs.Ease.get(1)).to({scaleY:0.99,x:-428.4,y:336.4},13,cjs.Ease.get(-1)).to({regY:22.4,scaleY:1,x:-428.9,y:337.4},13,cjs.Ease.get(1)).to({scaleY:0.99,x:-428.4,y:336.4},12,cjs.Ease.get(-1)).to({regY:22.5,scaleY:0.98,x:-427.9,y:335.4},13,cjs.Ease.get(1)).to({scaleY:0.99,x:-428.4,y:336.4},13,cjs.Ease.get(-1)).to({regY:22.4,scaleY:1,x:-428.9,y:337.4},13,cjs.Ease.get(1)).to({_off:true},38).wait(62));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-466.3,75.2,157.4,330);
...
(lib.Символ19 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(3).call(this.frame_3).wait(67).call(this.frame_70).wait(6).call(this.frame_76).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({alpha:1},6).wait(65).to({alpha:0},5).wait(1));
...
(lib.Символ13 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:59.6},6,cjs.Ease.get(-1)).to({y:64.3},8).to({y:70.5},15,cjs.Ease.get(1)).to({y:64.5},15,cjs.Ease.get(-1)).to({y:58.5},15,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-190.3,-25.9,634.6,404.8);
...
}).prototype = getMCSymbolPrototype(lib.Символ15, new cjs.Rectangle(5.7,-11.9,634.6,404.8), null);
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/body.png?1496066232271", id:"body"},
		{src:"images/brassiere.png?1496066232271", id:"brassiere"},
		{src:"images/girl_lif_s.jpg?1496066232271", id:"girl_lif_s"},
		{src:"images/hand.png?1496066232271", id:"hand"},
		{src:"images/handdd.png?1496066232271", id:"handdd"},
		{src:"images/head1.png?1496066232271", id:"head1"},
		{src:"images/kist.png?1496066232271", id:"kist"},
		{src:"images/leg1.png?1496066232271", id:"leg1"},
		{src:"images/leg.png?1496066232271", id:"leg"},
		{src:"images/ple4o.png?1496066232271", id:"ple4o"},
		{src:"images/tits.png?1496066232271", id:"tits"}
	],
	preloads: []
};
