...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/back.jpg?1475573434156", id:"back"},
		{src:"images/chr.png?1475573434156", id:"chr"},
		{src:"images/dia.png?1475573434156", id:"dia"},
		{src:"images/shade.png?1475573434156", id:"shade"},
		{src:"images/spade.png?1475573434156", id:"spade"}
	]
};
...
(lib.Символ48 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
...
(lib.Символ43 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("AA1E6IgIgaIgBiWQgBgtgPgSQgOgSghAAIgiAAIAAEBIhjAAIAApzICWAAQAkABAcAIQAbAKASARQASASAIAbQAJAbAAAkIAAAyQAAAxgRAfQgQAgggAOQASAHANAMQANANAHARQAOAiABAyIABCKIAJAkgAg1geIAmAAQAaAAAQgOQAPgOABgmIAAg/QgBghgMgQQgMgPgXAAIgwAAg");
...
(lib.Символ42 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("AiFE6IAApzIELAAIAABaIioAAIAACvICFAAIAABXIiFAAIAAC5ICoAAIAABag");
...
(lib.Символ41 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("AA+E6Ihej7IgfA5IAADCIhjAAIAApzIBjAAIAAESICAkSIBhAAIiJEXICJFcg");
...
(lib.Символ40 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("Ag+E2QgcgKgTgUQgogpAAhMIAAlFQAAhMAogpQATgUAcgKQAcgLAiAAQBJAAAmApQATAVAKAdQAJAdAAAmIAAFFQAAAmgJAdQgKAegTAUQgUAUgbAKQgcALgkAAQgiAAgcgLgAgjjYQgOAOAAAiIAAFRQAAAiAOAPQANANAWAAQAXAAAOgNQAOgPAAgiIAAlRQAAgigOgOQgOgOgXAAQgWAAgNAOg");
...
(lib.Символ39 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("AiRE6IAApzICRAAQBKAAAjAnQAkApAABLIAABSQAABMgkAmQgRATgcALQgbAJglAAIguAAIAADtgAgugKIAuAAQAWAAAMgNQAOgMAAgjIAAheQAAgigOgNQgMgMgWAAIguAAg");
...
(lib.Символ35 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0,794,1,1,-90);
...
(lib.Символ33 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EhEcA0WMAAAhorMCI5AAAMAAABorg");
	this.shape.setTransform(438.1,335.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,876.2,670.2);
...
(lib.Символ25 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("AAHBmQgGgCgBgGIgTg6IgdAnQgCADgEAAIgBAAQgEgCAAgFIAAioQAAgEAEgBQADgBAEACIBqCAQAEADgEAEQAAADgGAAIgugJIAUA4QACAGgCAFQgDAGgFABIgGACIgFgCg");
...
(lib.Символ4 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#666666").s().p("ACOKtIuquqQFKjVDVlKIOqOqQBwBwAACfQAACfhwBxQhxBwifAAQifAAhwhwg");
	this.shape.setTransform(30.6,30.6,0.093,0.093);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#666666").s().p("");
	...
	this.shape_2.graphics.f("#FFFFFF").s().p("AhQBRQgigiAAgvQAAguAigiQAigiAuAAQAvAAAiAiQAiAiAAAuQAAAvgiAiQgiAigvAAQguAAgigig");
...
(lib.Символ3 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF0000").s().p("");
	this.shape.setTransform(63.6,31.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#666666").s().p("");
...
(lib.Символ34 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:396.9,scaleX:1.07,scaleY:1.07,rotation:-15,x:374.9,y:419.1},249).wait(251));
...
(lib.Символ22 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#CCCCCC").s().p("AkLEDIAAoFIIXAAIAAIFg");
	this.shape.setTransform(26.9,26);
...
(lib.Символ32 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(159.1,257.1,1,1,0,0,0,438.1,335.1);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(189).to({_off:false},0).to({alpha:1},10).wait(301));

	// Слой 1
	this.instance_1 = new lib.Символ31();
	this.instance_1.setTransform(16.4,16.4,1,1,0,0,0,16.4,16.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(184).to({regY:14.3,scaleX:53.8,scaleY:53.8,rotation:167.5,x:-84.8,y:226,alpha:0},15,cjs.Ease.get(-1)).wait(301));
...
(lib.poker_video640320 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_3.setTransform(231.5,64.5,1,1,0,0,0,16.4,16.4);
	...
	this.instance_7.setTransform(379.8,56.9,1.293,1.293,0,0,0,137.2,18.9);
	...
	this.instance_9.setTransform(339.5,148.5,0.954,0.954,0,0,0,397,397);
	this.instance_9.alpha = 0.102;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(233.2,-50.5,805.3,825.4);
