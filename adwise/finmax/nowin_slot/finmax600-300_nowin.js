...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/finmax600_300_nowin_atlas_.png?1478089307912", id:"finmax600_300_nowin_atlas_"}
	]
};
...
lib.ssMetadata = [
		{name:"finmax600_300_nowin_atlas_", frames: [[0,469,700,467],[0,0,700,467],[866,0,109,109],[834,223,109,109],[834,334,109,101],[866,111,109,109],[702,438,310,60],[702,0,162,221],[702,223,130,213],[702,500,109,104],[945,222,50,65]]}
];
...
p.nominalBounds = new cjs.Rectangle(-35.9,-2.7,141.7,200.8);
...
p.nominalBounds = new cjs.Rectangle(10,20,140.5,191.7);
...
(lib.Символ35 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#666600").s().p("A45FYQguAAAAguIAApTQAAgtAugBMAxzAAAQAuABAAAtIAAJTQAAAuguAAg");
	this.shape.setTransform(164.1,49.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,10,328.2,74.3);
...
(lib.Символ23 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(264).to({_off:false},0).to({x:51.1,y:567.4},14,cjs.Ease.get(1)).wait(126).to({y:706.4},10,cjs.Ease.get(-1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(262).to({_off:false},0).to({x:535.3,y:557.4},14,cjs.Ease.get(1)).wait(125).to({y:687.5},10,cjs.Ease.get(-1)).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(213).to({_off:false},0).wait(191).to({rotation:-21,x:339.3,y:1015.7},10,cjs.Ease.get(-1)).wait(1));

	// Слой 1
	this.instance_3 = new lib.Символ24();
	this.instance_3.parent = this;
	this.instance_3.setTransform(290.1,135,1,1,0,0,0,304.1,135);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(199).to({y:479.1},10,cjs.Ease.get(-1)).to({y:469.1},2).to({y:479.1},2).wait(191).to({rotation:-21,x:367.4,y:1073.8},10,cjs.Ease.get(-1)).wait(1));
