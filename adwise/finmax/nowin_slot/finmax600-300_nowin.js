...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/finmax600_300_nowin_atlas_.png?1478078616666", id:"finmax600_300_nowin_atlas_"}
	]
};
...
lib.ssMetadata = [
		{name:"finmax600_300_nowin_atlas_", frames: [[0,469,700,467],[0,0,700,467],[702,111,109,109],[702,0,109,109],[702,439,109,101],[702,222,109,109],[0,938,310,60],[702,333,109,104],[702,542,50,65]]}
];
...
(lib.back = function() {
	this.spriteSheet = ss["finmax600_300_nowin_atlas_"];
	this.gotoAndStop(0);
...
p.nominalBounds = new cjs.Rectangle(0,0,217,42);
...
(lib.Символ31 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,255,255,0.796)").s().p("AgzBKQgVgVAAgiIAAglQAAghAUgWQAUgUAggBQAiABATAQQAUAQgBAfIAAABIgqAAQAAgRgHgHQgIgIgPABQgOAAgHALQgIALAAAUIAAAlQAAAUAIALQAJAMAOgBQAPAAAGgGQAHgIAAgRIApAAIABAAQAAAggSAQQgTARghgBQggAAgVgUg");
	this.shape.setTransform(7.3,9.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,14.6,19);
...
(lib.Символ30 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,255,255,0.796)").s().p("");
	this.shape.setTransform(99.3,9.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,198.7,19);
...
(lib.Символ29 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,255,255,0.796)").s().p("");
	this.shape.setTransform(59.3,9.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,118.5,19);
...
(lib.Символ28 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,0,0,0.796)").s().p("");
	this.shape.setTransform(57.9,9.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,115.8,19);
...
(lib.Символ27 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,0,0,0.796)").s().p("AhFBcIAAi3IA9AAQAgAAATANQAUAMgBAaQAAANgFALQgGAKgNAFQAQABAIALQAIAMAAAPQAAAagTAOQgRAOgiAAgAgaA7IAaAAQANAAAIgFQAGgGAAgLQAAgMgGgGQgGgGgOgBIgbAAgAgagOIARAAQAOAAAHgFQAIgFAAgLQgBgMgGgFQgIgGgNAAIgSAAg");
	this.shape.setTransform(7.1,9.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,14.1,18.5);
...
(lib.Символ26 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,0,0,0.796)").s().p("");
	this.shape.setTransform(106.8,9.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,213.5,19);
...
(lib.Символ20 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(0,0,0,0.796)","rgba(0,0,0,0.51)","rgba(0,0,0,0.761)"],[0,0.565,0.902],-388.5,0,388.5,0).s().rr(-388.5,-144.5,777,289,5.5);
...
(lib.Анимация3 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF3300").s().p("");
	this.shape.setTransform(-8.3,132.6);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-188.7,98,360.9,69.1);
...
p.nominalBounds = new cjs.Rectangle(-48.4,-3,556.5,106.6);
...
(lib.Символ35 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#666600").s().p("A45FYQguAAAAgvIAApSQAAgtAugBMAxzAAAQAuABAAAtIAAJSQAAAvguAAg");
	this.shape.setTransform(164.1,39.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,328.2,74.3);
...
p.nominalBounds = new cjs.Rectangle(13.7,-60.3,317.2,28.2);
...
(lib.Символ23 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(284.7,414.8,1,1,0,0,0,250.6,27.4);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(213).to({_off:false},0).wait(191).to({rotation:-21,x:339.3,y:1015.7},10,cjs.Ease.get(-1)).wait(1));

	// Слой 1
	this.instance_1 = new lib.Символ24();
	this.instance_1.parent = this;
	this.instance_1.setTransform(290.1,135,1,1,0,0,0,304.1,135);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(199).to({y:479.1},10,cjs.Ease.get(-1)).to({y:469.1},2).to({y:479.1},2).wait(191).to({rotation:-21,x:367.4,y:1073.8},10,cjs.Ease.get(-1)).wait(1));
...
(lib.finmax600300_nowin = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(312.2,-155,1,1,0,0,0,304.1,135);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(406,285.6,1,1,0,0,0,25,32.5);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(296.5,-80.9,0.903,0.903,0,0,0,237.6,-106.4);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(300.2,150.6,1,1,0,0,0,292.1,141.6);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(536.2,276.6,1,1,0,0,0,43.2,7);
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(301.2,97.2,1,1,0,0,0,301.2,201);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(285.1,-817,634.1,1634.9);
