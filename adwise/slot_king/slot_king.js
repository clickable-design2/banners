...
(lib.Символ20 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(11.9,96.2,0.888,0.888,0,0,0,41.5,32.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:41.4,scaleX:0.94,scaleY:0.94,x:11.8},4,cjs.Ease.get(-1)).to({regX:41.5,scaleX:1,scaleY:1,x:11.7,y:96.1},5,cjs.Ease.get(1)).to({scaleX:0.94,scaleY:0.94,x:11.8,y:96.2},5,cjs.Ease.get(-1)).to({scaleX:0.89,scaleY:0.89,x:11.9},5,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:0.96,scaleY:0.96,x:113.6,y:96.4},4,cjs.Ease.get(-1)).to({regX:41.6,scaleX:0.92,scaleY:0.92,x:113.7,y:96.9},5,cjs.Ease.get(1)).to({scaleX:0.96,scaleY:0.96,y:96.5},5,cjs.Ease.get(-1)).to({regX:41.5,scaleX:1,scaleY:1,x:113.5,y:95.9},5,cjs.Ease.get(1)).wait(1));
...
(lib.slot_king = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(236,3,0.608,0.608);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1502186376888", id:"bg"},
		{src:"images/btn1.png?1502186376888", id:"btn1"},
		{src:"images/btn2.png?1502186376888", id:"btn2"},
		{src:"images/logo.png?1502186376888", id:"logo"},
		{src:"images/money.png?1502186376888", id:"money"},
		{src:"images/rootframes.png?1502186376888", id:"rootframes"},
		{src:"images/shine.png?1502186376888", id:"shine"},
		{src:"images/slot1.png?1502186376888", id:"slot1"},
		{src:"images/slot2.png?1502186376888", id:"slot2"},
		{src:"images/slot3.png?1502186376888", id:"slot3"},
		{src:"images/slot4.png?1502186376888", id:"slot4"},
		{src:"images/slot5.png?1502186376888", id:"slot5"},
		{src:"images/slotmachine.png?1502186376888", id:"slotmachine"},
		{src:"images/text.png?1502186376888", id:"text"}
	],
	preloads: []
};
