...
(lib.Символ42 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-29.9,31.6,1,1,0,0,0,-29.9,31.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:4.3,y:31.7},9,cjs.Ease.get(-1)).to({regX:-30,rotation:9,x:-30,y:31.6},10,cjs.Ease.get(1)).to({regX:-29.9,rotation:4.3,x:-29.9,y:31.7},10,cjs.Ease.get(-1)).to({rotation:0,y:31.6},10,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-32.5,-51.5,65,103);
