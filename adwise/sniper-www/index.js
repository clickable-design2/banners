...
(lib.gilza = function() {
	this.initialize(img.gilza);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,59,28);


(lib.hand2 = function() {
	this.initialize(img.hand2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,339,123);
...
(lib.Tween6 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.gilza();
	this.instance.parent = this;
	this.instance.setTransform(-29.5,-14);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-29.5,-14,59,28);
...
(lib.Tween4 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-156.6,-89.2,1,1,9.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-177.4,-89.2,354.9,178.6);
...
(lib.Tween3 = function(mode,startPosition,loop) {
	...
	this.instance = new lib.hand2();
	this.instance.parent = this;
	this.instance.setTransform(-140.3,-113.2,1,1,19);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-180.2,-113.2,360.6,226.5);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(19).call(this.frame_19).wait(36).call(this.frame_55).wait(7));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(55).to({_off:false},0).to({_off:true},1).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:127.5},9).to({y:117.5},10).wait(1).to({rotation:-19.2,x:156.5,y:147.5},4).wait(21).to({rotation:0,x:176.5,y:117.5},4).to({regX:176.4,regY:117.4,scaleX:1.8,scaleY:1.8,x:38.4,y:32.5},5).to({_off:true},1).wait(1).to({_off:false},0).to({regX:176.5,regY:117.5,scaleX:1,scaleY:1,x:176.5,y:117.5},5).wait(1));

	// Layer 5
	this.instance_2 = new lib.Tween5("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(206.5,97);
	this.instance_2._off = true;

	this.instance_3 = new lib.Tween6("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(396.5,-103);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},35).to({state:[{t:this.instance_3}]},9).to({state:[]},1).wait(17));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(35).to({_off:false},0).to({_off:true,rotation:360,x:396.5,y:-103},9).wait(18));

	// Layer 4
	this.instance_4 = new lib.Tween3("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(509.5,180.5);
	this.instance_4._off = true;

	this.instance_5 = new lib.Tween4("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(310.5,150.5);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(22).to({_off:false},0).to({_off:true,x:310.5,y:150.5},12).to({_off:false,x:509.5,y:180.5},3).to({_off:true},3).wait(22));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(22).to({_off:false},12).to({_off:true,x:509.5,y:180.5},3).wait(25));
