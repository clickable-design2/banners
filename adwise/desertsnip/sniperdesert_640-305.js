...
(lib.Symbol55 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFF00").s().p("");
	this.shape.setTransform(48.5,19.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFCC00").s().p("");
	this.shape_1.setTransform(49.1,13.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF6600").s().p("");
	this.shape_2.setTransform(50.7,12.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol55, new cjs.Rectangle(0,0,101.4,27.4), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol54, new cjs.Rectangle(0,0,838,400), null);
...
(lib.Symbol52 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("AgzAVQghgJAAgMQAAgMAhgJQAigIAvAAQAeAAAZAEIAAA0QgZADgeAAQgvAAgigJg");
	this.shape.setTransform(8.5,3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol52, new cjs.Rectangle(0,0,17,6), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol51, new cjs.Rectangle(0,0,201,201), null);
...
(lib.Symbol53 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(50.7,13.7,1,1,0,0,0,50.7,13.7);
	this.instance.filters = [new cjs.BlurFilter(4, 4, 1)];
	this.instance.cache(-2,-2,105,31);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol53, new cjs.Rectangle(-2,-2,109,35), null);
...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-595.5,53.8,0.057,0.489,0,0,0,50.8,13.7);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90).to({_off:false},0).to({regX:50.7,scaleX:1,scaleY:1,y:53.7,alpha:1},3).to({scaleX:1.21,scaleY:0.64,y:58.7,alpha:0},3).wait(4));

	// Layer 2
	this.instance_2 = new lib.Symbol52();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-600.5,19,0.588,0.588,0,0,0,8.4,3);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(77).to({_off:false},0).to({regY:2.9,rotation:-88.9,y:54.1},12).to({_off:true},1).wait(10));
...
(lib.Symbol4 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:105.7},9,cjs.Ease.get(-1)).to({y:111.5},10,cjs.Ease.get(1)).to({y:106},10,cjs.Ease.get(-1)).to({y:100.5},10,cjs.Ease.get(1)).wait(1));
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(418.9,200,1,1,0,0,0,418.9,200);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(89).to({x:420},0).wait(1).to({x:417.8,y:201.1},0).wait(1).to({x:420,y:198.9},0).wait(1).to({x:418.9,y:200},0).wait(8));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,838,400);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90).to({y:117.5},0).wait(1).to({y:116.4},0).wait(1).to({y:115.3},0).wait(1).to({y:116.4},0).wait(7));

	// Layer 1
	this.instance_1 = new lib.back1();
	this.instance_1.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90).to({y:1.1},0).wait(1).to({y:0},0).wait(1).to({y:-1.1},0).wait(1).to({y:0},0).wait(7));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-6.4,841,297.4);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/armo.png?1485346679680", id:"armo"},
		{src:"images/back1.png?1485346679680", id:"back1"},
		{src:"images/back2.jpg?1485346679680", id:"back2"},
		{src:"images/dust.png?1485346679680", id:"dust"},
		{src:"images/health.png?1485346679680", id:"health"},
		{src:"images/helic.png?1485346679680", id:"helic"},
		{src:"images/pric.png?1485346679680", id:"pric"},
		{src:"images/sniper.png?1485346679680", id:"sniper"},
		{src:"images/soldir.png?1485346679680", id:"soldir"},
		{src:"images/zzzok.png?1485346679680", id:"zzzok"}
	],
	preloads: []
};
