...
(lib.br_01 = function() {
	this.initialize(img.br_01);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,97,84);


(lib.br_04 = function() {
	this.initialize(img.br_04);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,118,130);


(lib.br_09 = function() {
	this.initialize(img.br_09);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,127,90);


(lib.br_12 = function() {
	this.initialize(img.br_12);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,42,84);


(lib.br_16 = function() {
	this.initialize(img.br_16);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,76,118);


(lib.br_20 = function() {
	this.initialize(img.br_20);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,144,119);


(lib.br_24 = function() {
	this.initialize(img.br_24);
}).prototype = p = new cjs.Bitmap();
...
(lib.Символ56 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#6B360F").s().p("AheAeQgFgQAAgIQAAgHAIgGQAIgFASgBQARgCAIAMQAJALAAAJQAAAIgKAHQgLAGgTAEIgHABQgNAAgDgNgAAlgBQgFgQAAgIQAAgIADgBIAYgIQACAhATgGQATgGAAAIQABAHgKAGQgLAGgTAEIgHABQgNAAgDgMg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ56, new cjs.Rectangle(-9.9,-4.3,19.9,8.6), null);
...
(lib.Символ54 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.instance = new lib.br_04();
	this.instance.parent = this;
	this.instance.setTransform(-59,-65);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ54, new cjs.Rectangle(-59,-65,118,130), null);
...
(lib.Символ52 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.instance = new lib.br_09();
	this.instance.parent = this;
	this.instance.setTransform(-63.5,-45);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ52, new cjs.Rectangle(-63.5,-45,127,90), null);
...
(lib.Символ50 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.instance = new lib.br_12();
	this.instance.parent = this;
	this.instance.setTransform(-21,-42);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ50, new cjs.Rectangle(-21,-42,42,84), null);
...
(lib.Символ48 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.instance = new lib.br_16();
	this.instance.parent = this;
	this.instance.setTransform(-38,-59);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ48, new cjs.Rectangle(-38,-59,76,118), null);
...
(lib.Символ42 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(75.5,39);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ42, new cjs.Rectangle(6.9,8.9,137.3,60.1), null);
...
(lib.Символ34 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FF0000").ss(3,1,1).p("");
...
(lib.Символ32 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(164.1,33.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ32, new cjs.Rectangle(4.1,7.6,320,51.8), null);
...
(lib.Символ20 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.instance = new lib.br_20();
	this.instance.parent = this;
	this.instance.setTransform(-72,-59.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ20, new cjs.Rectangle(-72,-59.5,144,119), null);
...
(lib.Символ18 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.instance = new lib.br_24();
	this.instance.parent = this;
	this.instance.setTransform(-34,-35.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ18, new cjs.Rectangle(-34,-35.5,68,71), null);
...
(lib.Символ16 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.instance = new lib.br_01();
	this.instance.parent = this;
	this.instance.setTransform(-48.5,-42);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ16, new cjs.Rectangle(-48.5,-42,97,84), null);
...
(lib.Символ60 = function(mode,startPosition,loop) {
	...
	this.instance.cache(-12,-6,24,13);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ60, new cjs.Rectangle(-10.9,-5.3,24,14), null);
...
(lib.Символ57 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("AmPAAIL1iwIAqCxIr1Cwg");
	var mask_graphics_1 = new cjs.Graphics().p("AmPAAIL1iwIAqCxIr1Cwg");
	var mask_graphics_2 = new cjs.Graphics().p("AmPAAIL1iwIAqCxIr1Cwg");
	var mask_graphics_3 = new cjs.Graphics().p("AmPAAIL1iwIAqCxIr1Cwg");
	var mask_graphics_4 = new cjs.Graphics().p("AmPAAIL1iwIAqCxIr1Cwg");
	var mask_graphics_5 = new cjs.Graphics().p("AmPAAIL1iwIAqCxIr1Cwg");
	var mask_graphics_6 = new cjs.Graphics().p("AmPAAIL1iwIAqCxIr1Cwg");
	var mask_graphics_7 = new cjs.Graphics().p("AmPAAIL1iwIAqCxIr1Cwg");
	var mask_graphics_8 = new cjs.Graphics().p("AmPAAIL1iwIAqCxIr1Cwg");
	var mask_graphics_9 = new cjs.Graphics().p("AmPAAIL1iwIAqCxIr1Cwg");
	var mask_graphics_10 = new cjs.Graphics().p("AmPAAIL1iwIAqCxIr1Cwg");
	var mask_graphics_11 = new cjs.Graphics().p("AmPAAIL1iwIAqCxIr1Cwg");
	var mask_graphics_12 = new cjs.Graphics().p("AmPAAIL1iwIAqCxIr1Cwg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-3.2,y:-13.3}).wait(1).to({graphics:mask_graphics_1,x:-2.3,y:-9.9}).wait(1).to({graphics:mask_graphics_2,x:-1.4,y:-6.6}).wait(1).to({graphics:mask_graphics_3,x:-0.5,y:-3.2}).wait(1).to({graphics:mask_graphics_4,x:-1.4,y:-6.6}).wait(1).to({graphics:mask_graphics_5,x:-2.3,y:-9.9}).wait(1).to({graphics:mask_graphics_6,x:-3.2,y:-13.3}).wait(1).to({graphics:mask_graphics_7,x:-2.3,y:-9.9}).wait(1).to({graphics:mask_graphics_8,x:-1.4,y:-6.6}).wait(1).to({graphics:mask_graphics_9,x:-0.5,y:-3.2}).wait(1).to({graphics:mask_graphics_10,x:-1.4,y:-6.6}).wait(1).to({graphics:mask_graphics_11,x:-2.3,y:-9.9}).wait(1).to({graphics:mask_graphics_12,x:-3.2,y:-13.3}).wait(28));
...
p.nominalBounds = new cjs.Rectangle(-10.9,-5.3,24,9.6);
...
}).prototype = getMCSymbolPrototype(lib.Символ55, new cjs.Rectangle(-59,-65,118,130), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ53, new cjs.Rectangle(-63.5,-45,127,90), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ51, new cjs.Rectangle(-21,-42,42,84), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ49, new cjs.Rectangle(-38,-59,76,118), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ47, new cjs.Rectangle(-72,-59.5,144,119), null);
...
p.nominalBounds = new cjs.Rectangle(6.9,8.9,137.3,60.1);
...
(lib.Символ38 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(47).to({_off:false},0).to({alpha:1},3).wait(1).to({regX:60.2,scaleX:0.07},9).to({regX:60,scaleX:0.45},10).wait(20).to({alpha:0},3).to({_off:true},1).wait(141));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(94).to({_off:false},0).to({alpha:1},3).wait(1).to({regX:60.2,scaleX:0.07},9).to({regX:60,scaleX:0.45},10).wait(20).to({alpha:0},3).to({_off:true},1).wait(94));

	// Слой 1 - копия
	this.instance_2 = new lib.Символ39();
	this.instance_2.parent = this;
	this.instance_2.setTransform(212.2,118.9,0.449,0.449,0,0,0,60,59.6);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(188).to({_off:false},0).to({x:211.1,alpha:1},3).wait(1).to({regX:60.1,scaleX:0.11},9).to({regX:60,scaleX:0.45},10).wait(20).to({x:212.2,alpha:0},3).wait(1));

	// Слой 1 - копия
	this.instance_3 = new lib.Символ39();
	this.instance_3.parent = this;
	this.instance_3.setTransform(301,140.6,0.449,0.449,0,0,0,60,59.6);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(141).to({_off:false},0).to({alpha:1},3).wait(1).to({regX:60.2,scaleX:0.07},9).to({regX:60,scaleX:0.45},10).wait(20).to({alpha:0},3).to({_off:true},1).wait(47));

	// Слой 1
	this.instance_4 = new lib.Символ39();
	this.instance_4.parent = this;
	this.instance_4.setTransform(70,63.6,0.449,0.449,0,0,0,60,59.6);
	this.instance_4.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({alpha:1},3).wait(1).to({regX:60.2,scaleX:0.07},9).to({regX:60,scaleX:0.45},10).wait(20).to({alpha:0},3).to({_off:true},1).wait(188));
...
(lib.Символ31 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
...
}).prototype = getMCSymbolPrototype(lib.Символ31, new cjs.Rectangle(4.1,7.6,320,51.8), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ19, new cjs.Rectangle(-34,-35.5,68,71), null);
...
(lib.Символ58 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-14.5,6.4);
...
}).prototype = getMCSymbolPrototype(lib.Символ58, new cjs.Rectangle(-57.6,-42,106.2,84), null);
...
(lib.Символ17 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(20.3,17.3,1,1,0,0,0,20.7,16.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:-2.8,x:20.4,y:17.4},17,cjs.Ease.get(-1)).to({rotation:-6,y:17.3},17,cjs.Ease.get(1)).to({regY:17,rotation:-2.8,y:17.4},18,cjs.Ease.get(-1)).to({regY:16.9,rotation:0,x:20.3,y:17.3},17,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-58,-41.6,106.2,84);
...
(lib.Символ61 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-13.7,-26.5,0.532,0.532,0,0,0,-0.1,-0.1);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(8.4,14,0.532,0.532,0,0,0,0,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ61, new cjs.Rectangle(-44.5,-48.5,84.3,97.2), null);
...
p.nominalBounds = new cjs.Rectangle(-410.7,-32.5,912.8,474.6);
...
(lib.Символ14 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(16.9,-11.8,1,1,0,0,0,36.8,33.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:33.1,rotation:-6.3,x:18.7,y:-5.8},9,cjs.Ease.get(-1)).to({regY:33.2,rotation:-13.2,x:20.6,y:1},10,cjs.Ease.get(1)).to({regY:33.1,rotation:-6.5,x:18.8,y:-5.4},10,cjs.Ease.get(-1)).to({regY:33.2,rotation:0,x:16.9,y:-11.8},10,cjs.Ease.get(1)).wait(1));

	// br_24.png
	this.instance_1 = new lib.Символ19();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-10.5,134.5,0.532,0.532,0,0,0,-33,19.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({rotation:8.3,x:-10.6},9,cjs.Ease.get(-1)).to({regX:-32.9,rotation:17.4,x:-10.5},10,cjs.Ease.get(1)).to({regX:-32.8,regY:19.8,rotation:8.6,y:134.6},10,cjs.Ease.get(-1)).to({regX:-33,regY:19.7,rotation:0,y:134.5},10,cjs.Ease.get(1)).wait(1));

	// br_09.png
	this.instance_2 = new lib.Символ53();
	this.instance_2.parent = this;
	this.instance_2.setTransform(1.4,21.9,0.532,0.532,0,0,0,-34,27.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regY:27.6,scaleX:0.55,scaleY:0.55,rotation:-6.3,x:3.7,y:29.1},9,cjs.Ease.get(-1)).to({regX:-33.8,regY:27.7,scaleX:0.57,scaleY:0.57,rotation:-13.5,x:6.3,y:36.9},10,cjs.Ease.get(1)).to({regY:27.8,scaleX:0.55,scaleY:0.55,rotation:-6.8,x:3.9,y:29.5},10,cjs.Ease.get(-1)).to({regX:-34,regY:27.5,scaleX:0.53,scaleY:0.53,rotation:0,x:1.4,y:21.9},10,cjs.Ease.get(1)).wait(1));

	// br_16.png
	this.instance_3 = new lib.Символ49();
	this.instance_3.parent = this;
	this.instance_3.setTransform(14.7,108.4,0.532,0.532,0,0,0,27.4,39.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regY:39.3,rotation:4.3,x:18.1,y:112.3},9,cjs.Ease.get(-1)).to({regY:39.5,rotation:9.2,x:22,y:116.4},10,cjs.Ease.get(1)).to({regY:39.6,rotation:4.5,x:18.4,y:112.5},10,cjs.Ease.get(-1)).to({regY:39.2,rotation:0,x:14.7,y:108.4},10,cjs.Ease.get(1)).wait(1));

	// br_20.png
	this.instance_4 = new lib.Символ47();
	this.instance_4.parent = this;
	this.instance_4.setTransform(3.1,58.4,0.532,0.532,0,0,0,-16.4,38.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:-16.3,rotation:-5,x:10.4,y:61.3},9,cjs.Ease.get(-1)).to({regX:-16.2,rotation:-10.7,x:18.4,y:64.4},10,cjs.Ease.get(1)).to({regY:38.7,rotation:-5.3,x:10.9,y:61.5},10,cjs.Ease.get(-1)).to({regX:-16.4,regY:38.6,rotation:0,x:3.1,y:58.4},10,cjs.Ease.get(1)).wait(1));

	// br_12.png
	this.instance_5 = new lib.Символ51();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-17.8,35.9,0.532,0.532,0,0,0,0.4,33.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:0.3,rotation:-5.5,x:-12.4,y:40.6},9,cjs.Ease.get(-1)).to({regX:0.4,regY:34,rotation:-11.7,x:-6.3,y:45.9},10,cjs.Ease.get(1)).to({rotation:-5.8,x:-12.1,y:41},10,cjs.Ease.get(-1)).to({regY:33.9,rotation:0,x:-17.8,y:35.9},10,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-64.5,-93.6,117.8,236.5);
...
(lib.Символ21 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:60.1,regY:59.6,scaleX:1.41,scaleY:1.41,x:173.6,y:109.1,alpha:1},4).to({regX:60,regY:59.5,scaleX:1,scaleY:1,x:223,y:114.5,alpha:0},5).wait(1));

	// Слой 2
	this.instance_1 = new lib.Символ14();
	this.instance_1.parent = this;
	this.instance_1.setTransform(344,181,0.22,0.22);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:1,scaleY:1,alpha:1},4,cjs.Ease.get(1)).to({scaleX:0.22,scaleY:0.22,alpha:0},5,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({scaleX:1.41,scaleY:1.41,x:345.6,y:201,alpha:1},4).to({scaleX:1,scaleY:1,x:345.5,y:180,alpha:0},5).wait(1));

	// Слой 1
	this.instance_3 = new lib.Символ36();
	this.instance_3.parent = this;
	this.instance_3.setTransform(345.5,180,1,1,0,0,0,345.5,180);
...
// stage content:
(lib.brazzil640x305 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(187.9,118.5,912.8,476.1);
// library properties:
lib.properties = {
	width: 640,
	height: 305,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1481706778453", id:"back"},
		{src:"images/back1.jpg?1481706778453", id:"back1"},
		{src:"images/blick.png?1481706778453", id:"blick"},
		{src:"images/br_01.png?1481706778453", id:"br_01"},
		{src:"images/br_04.png?1481706778453", id:"br_04"},
		{src:"images/br_09.png?1481706778453", id:"br_09"},
		{src:"images/br_12.png?1481706778453", id:"br_12"},
		{src:"images/br_16.png?1481706778453", id:"br_16"},
		{src:"images/br_20.png?1481706778453", id:"br_20"},
		{src:"images/br_24.png?1481706778453", id:"br_24"},
		{src:"images/g1.png?1481706778453", id:"g1"},
		{src:"images/g2.png?1481706778453", id:"g2"},
		{src:"images/g5.png?1481706778453", id:"g5"},
		{src:"images/g6.png?1481706778453", id:"g6"},
		{src:"images/g7.png?1481706778453", id:"g7"},
		{src:"images/g8.png?1481706778453", id:"g8"},
		{src:"images/g9.png?1481706778453", id:"g9"},
		{src:"images/mish.png?1481706778453", id:"mish"},
		{src:"images/mouse.png?1481706778453", id:"mouse"}
	],
	preloads: []
};
