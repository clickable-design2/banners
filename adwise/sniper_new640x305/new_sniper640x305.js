...
(lib.Символ65 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFCC00").s().p("AAVDIQgQgDgIgOQgyAhgNg4QgEgQADgRQAIgugEgvQgGg3AsghIACgEQg3AFAIg0QABgOAFgNQAKgcAPgYQAKgQASAAQBPAlgLBbQgJBFAOBGIAIAnQALA4glAhQgHAGgJAAIgHgBg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ65, new cjs.Rectangle(-7.2,-20.1,14.5,40.3), null);
...
(lib.Символ63 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFCC00").s().p("AAJCmQABgUgDgUQgHAtgpAIQgKACgFgKQgQgeAUgdQACgCgCgFQgSg5Afg3QAFgIABgKQABgQADgPQgnACgEgjQgCgTARgMQAFgEgBgJQgFgwApgQQAtAEADAuQAAADADACQAvAigKA9QgDAYgBAXQgCBdgIBbQAAALgMACIgJABQgcAAABgggAAFBlIABACIAEg9QABgFgBgDQgXAhASAig");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ63, new cjs.Rectangle(-7.2,-19.7,14.6,39.6), null);
...
(lib.Символ52 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFCC00").s().p("");
...
(lib.Символ48 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFCC00").s().p("");
...
(lib.Символ47 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFCC00").s().p("");
...
(lib.Символ14 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFCC00").s().p("AALCbIgGAJQgMASgVgEQghgHAOgfQARgmgKgqQgCgKAFgKQAagxgMgzQgPADgPgEQgQgEAAgQQAAgjAdgaIgBgCQgQgnAqgIQAoAHgEAoQAOAGAEANQAKAdAMAbQAZA2gpAfQgCAVAAAVQAAANAFAKQATAqACAtQAAAOgMAFQgMAFgJAAQgZAAAAglg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ14, new cjs.Rectangle(-7,-19.2,14.1,38.3), null);
...
(lib.Символ64 = function(mode,startPosition,loop) {
	...
	this.instance_1.cache(-9,-22,19,44);
...
}).prototype = getMCSymbolPrototype(lib.Символ26, new cjs.Rectangle(-8.8,-21.5,21,47), null);
...
(lib.Символ13 = function(mode,startPosition,loop) {
	...
	this.instance_1._off = true;
	this.instance_1.filters = [new cjs.BlurFilter(4, 4, 1)];
	this.instance_1.cache(-9,-21,18,42);
...
(lib.Символ11 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0.3,-170.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-159},24,cjs.Ease.get(-1)).to({y:-147.3},25,cjs.Ease.get(1)).to({y:-158.3},24,cjs.Ease.get(-1)).to({y:-170.3},26,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-194.7,-341.3,389.5,682.7);
...
}).prototype = getMCSymbolPrototype(lib.Символ30, new cjs.Rectangle(-8.8,-21.2,21,47), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ27, new cjs.Rectangle(-8.5,-21.2,21,46), null);
...
(lib.Символ25 = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#FFD940").ss(2.3,1,1).p("AgEALQgBAIAFgRQADgDACgL");
	this.shape_1.setTransform(-7.1,55);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FFE680").ss(3.5,1,1).p("AgHAhQgEAKAKgnQAFgQAFgW");
	this.shape_2.setTransform(-15.2,112.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#FFF2BF").ss(4.8,1,1).p("AgJA2QgHAMAOg7QAHggAIge");
	...
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#FFCC00").ss(2.3,1,1).p("AgEALQgBAIAFgRQAEgDABgL");
	this.shape_7.setTransform(-1.5,55);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#FFCC00").ss(3.5,1,1).p("AgHAhQgEAKAKgnQAFgQAFgW");
	this.shape_8.setTransform(-3.9,112.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#FFCC00").ss(4.8,1,1).p("AgJA2QgHAMANg7QAIggAHge");
	...
	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#FFD940").ss(2.3,1,1).p("AgEALQgBAIAFgRQAEgDABgL");
	this.shape_13.setTransform(-6.2,55);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#FFE680").ss(3.5,1,1).p("AgGAhQgFAKAKgnQAFgQAFgW");
	this.shape_14.setTransform(-13.3,112.5);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#FFF2BF").ss(4.8,1,1).p("AgJA2QgHAMANg7QAIggAHge");
	...
	this.shape_19.graphics.f().s("#FFCC00").ss(2.3,1,1).p("AgEALQgBAIAFgRQAEgDABgL");
	this.shape_19.setTransform(-4.3,55);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f().s("#FFCC00").ss(3.5,1,1).p("AgGAhQgFAKAKgnQAFgQAFgW");
	this.shape_20.setTransform(-9.6,112.5);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f().s("#FFCC00").ss(4.8,1,1).p("AgJA2QgHAMAOg7QAHggAIge");
...
(lib.Символ12 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:9.9},29,cjs.Ease.get(-1)).to({x:20},30,cjs.Ease.get(1)).to({x:10},30,cjs.Ease.get(-1)).to({x:0},30,cjs.Ease.get(1)).wait(1));
...
(lib.Символ10 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-31.5,189.1);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1485348711418", id:"bg"},
		{src:"images/patr.png?1485348711418", id:"patr"},
		{src:"images/pri.png?1485348711418", id:"pri"},
		{src:"images/pri1.png?1485348711418", id:"pri1"},
		{src:"images/shot.png?1485348711418", id:"shot"},
		{src:"images/snip.png?1485348711418", id:"snip"},
		{src:"images/ter.png?1485348711418", id:"ter"}
	],
	preloads: []
};
