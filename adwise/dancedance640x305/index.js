...
}).prototype = getMCSymbolPrototype(lib.Символ74, null, null);
...
(lib.Символ80 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(218.7,237.2);

	this.instance_1 = new lib.Символ79();
	this.instance_1.parent = this;
	this.instance_1.setTransform(317,232,0.71,0.71);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ80, new cjs.Rectangle(134.3,214.2,200.5,38.2), null);
...
(lib.Символ81 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(7).to({_off:false},0).to({alpha:0},6).wait(1));

	// Слой 1 - копия
	this.instance_3 = new lib.Символ80();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-12.2,-5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:-0.1,scaleX:0.83,x:-29.7},2).to({regX:0,scaleX:1,x:244.2},4).wait(1).to({regX:-0.1,scaleX:0.83,x:-29.7},4).to({regX:0,scaleX:1,x:-12.2},2).wait(1));

	// Слой 4
	this.instance_4 = new lib.Символ95();
	this.instance_4.parent = this;
	this.instance_4.setTransform(16.5,101.9);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(7).to({_off:false},0).wait(7));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-246.6,-17.8,569.1,265.3);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1490199776990", id:"bg"},
		{src:"images/mish.png?1490199776990", id:"mish"},
		{src:"images/ruka.png?1490199776990", id:"ruka"},
		{src:"images/sg1_03.png?1490199776990", id:"sg1_03"},
		{src:"images/sg1_06.png?1490199776990", id:"sg1_06"},
		{src:"images/sg1_10.png?1490199776990", id:"sg1_10"},
		{src:"images/sg1_14.png?1490199776990", id:"sg1_14"},
		{src:"images/sg1_19.png?1490199776990", id:"sg1_19"},
		{src:"images/sg2_03.png?1490199776990", id:"sg2_03"},
		{src:"images/sg2_07.png?1490199776990", id:"sg2_07"},
		{src:"images/sg2_10.png?1490199776990", id:"sg2_10"},
		{src:"images/sg2_14.png?1490199776990", id:"sg2_14"},
		{src:"images/sg2_17.png?1490199776990", id:"sg2_17"},
		{src:"images/sg4_02.png?1490199776990", id:"sg4_02"},
		{src:"images/sg4_05.png?1490199776990", id:"sg4_05"},
		{src:"images/sg4_10.png?1490199776990", id:"sg4_10"},
		{src:"images/sg4_13.png?1490199776990", id:"sg4_13"},
		{src:"images/sg4_16.png?1490199776990", id:"sg4_16"},
		{src:"images/sg_03.png?1490199776990", id:"sg_03"},
		{src:"images/sg_06.png?1490199776990", id:"sg_06"},
		{src:"images/sg_09.png?1490199776990", id:"sg_09"},
		{src:"images/sg_14.png?1490199776990", id:"sg_14"},
		{src:"images/sg_18.png?1490199776990", id:"sg_18"},
		{src:"images/spi.png?1490199776990", id:"spi"},
		{src:"sounds/Kick.mp3?1490199776990", id:"Kick"},
		{src:"sounds/Snare27wav.mp3?1490199776990", id:"Snare27wav"}
	],
	preloads: []
};
