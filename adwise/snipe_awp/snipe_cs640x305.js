...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/arm.png?1485359173750", id:"arm"},
		{src:"images/awp.png?1485359173750", id:"awp"},
		{src:"images/bullet.png?1485359173750", id:"bullet"},
		{src:"images/hp.png?1485359173750", id:"hp"},
		{src:"images/maps.png?1485359173750", id:"maps"},
		{src:"images/maxresdefault.jpg?1485359173750", id:"maxresdefault"},
		{src:"images/pricel.png?1485359173750", id:"pricel"},
		{src:"images/ter.png?1485359173750", id:"ter"},
		{src:"images/ui.png?1485359173750", id:"ui"},
		{src:"images/ui3.png?1485359173750", id:"ui3"}
	]
};
...
(lib.Символ8_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:437.2},14).to({y:442.9},15).wait(16));
