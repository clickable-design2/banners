...
(lib.mousethinroundedbuttonoutline = function() {
	this.initialize(img.mousethinroundedbuttonoutline);
}).prototype = p = new cjs.Bitmap();
...
(lib.Symbol53 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.mousethinroundedbuttonoutline();
	this.instance.parent = this;
...
(lib.Symbol37 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,10.4,0,-10.3).s().p("AAbCjIAAiZIAAAAIg2CZIhLAAIAAlFIBMAAIgBCVIABAAIA1iVIBNAAIAAFFg");
	this.shape.setTransform(149.3,39.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,10.3,0,-10.2).s().p("AhlCjQAEgDAAgNIAAhIQAAgQADgNQAEgMAHgHQAFgGAHgCQgGgDgGgFQgHgIgEgJQgDgLAAgPIAAhLQAAgPAFgKQAFgKAJgIQARgMAaAAICJAAIAAFFIhRAAIAAhzIgVAAQgIABgEAFQgEAGAAALIgBBWQgCAGgFAAgAgQhQIAAAwQAAAWALAAIAaAAIAAhdIgaAAQgLAAAAAXg");
	this.shape_1.setTransform(125.5,39.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,11,0,-11).s().p("AAeCjIgejyIAAAAIgdDyIhQAAIAylFIB3AAIAyFFg");
	this.shape_2.setTransform(102.1,39.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,9,0,-8.9).s().p("AhYCjIAAlFICyAAIAAA8IhhAAIAAA+IBRAAIAAA7IhRAAIAABUIBhAAIAAA8g");
	this.shape_3.setTransform(80.3,39.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,10.1,0,-10).s().p("AhkCjIAAlFICKAAQAaAAARANQAJAHAFAKQAGAKAAAPIAABMQgBAbgFAQQgEARgLAIQgIAHgPADQgMACgaAAIglAAIAABygAgSgKIAaAAQALAAAAgVIAAgxQAAgWgLAAIgaAAg");
	this.shape_4.setTransform(58.4,39.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,10.4,0,-10.3).s().p("AgoCjIAAkJIg+AAIAAg8IDNAAIAAA8Ig+AAIAAEJg");
	this.shape_5.setTransform(35.6,39.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,10.1,0,-10).s().p("");
	this.shape_6.setTransform(13,39.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],-8.1,0,8.2,0).s().p("AgjAfQgPgEgKgKQgKgJgGgNQgEgNAAgSIA+AAQAAAOAEAEQAEAEAKAAQAKAAAFgEQAEgEAAgOIA/AAQAAASgGANQgFANgKAJQgLAKgOAEQgQAGgUAAQgTAAgQgGg");
...
(lib.Symbol36 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,10,0,-9.9).s().p("AhiCjIAAlFICFAAQAaAAARANQAKAHAEAKQAGAKAAAPIAAAwQAAASgFALQgHAPgPAHIAAAAQAQAFAGAQQAGANAAAWIAAA8QAAAOgFALQgFAKgKAHQgRANgZAAgAgTBnIAaAAQALAAAAgWIAAgnQgBgSgKAAIgaAAgAgTgjIAaAAQAKAAABgRIAAgcQAAgWgLAAIgaAAg");
...
(lib.Symbol35 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],-3.6,0,3.7,0).s().p("AgjAhIAAhAIBIAAIAABAg");
	this.shape.setTransform(189.4,52.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,4.1,0,-4.1).s().p("AgeB1IgKjpIBRAAIgJDpg");
	this.shape_1.setTransform(189.4,34.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,10,0,-9.9).s().p("AhiCjIAAlFICFAAQAaAAARANQAKAHAEAKQAGAKAAAPIAAAwQAAASgFALQgHAPgPAHIAAAAQAQAFAGAQQAGANAAAWIAAA8QAAAOgFALQgFAKgKAHQgRANgZAAgAgTBnIAaAAQALAAAAgWIAAgnQgBgSgKAAIgaAAgAgTgjIAaAAQAKAAABgRIAAgcQAAgWgLAAIgaAAg");
	this.shape_2.setTransform(172.5,39.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,10.1,0,-10).s().p("AgvCjQgTgFgMgJQgLgJgFgOQgFgNgBgSIAAi9QABgSAFgNQAFgOALgJQAMgJATgFQATgFAcAAQAdAAATAFQATAFAMAJQAMAJAEAOQAFANABASIAAC9QgBASgFANQgEAOgMAJQgMAJgTAFQgTAFgdAAQgcAAgTgFgAgNhlQgFAEAAAOIAACnQAAAOAFAEQADAEAKAAQALAAADgEQAFgEAAgOIAAinQAAgOgFgEQgDgEgLAAQgKAAgDAEg");
	this.shape_3.setTransform(149.4,39.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,10.4,0,-10.3).s().p("AAWCjIAAiLIgrAAIAACLIhRAAIAAlFIBRAAIAAB6IArAAIAAh6IBRAAIAAFFg");
	this.shape_4.setTransform(125.9,39.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,10.4,0,-10.3).s().p("AAbCjIAAiZIAAAAIg2CZIhLAAIAAlFIBMAAIgBCVIABAAIA1iVIBNAAIAAFFg");
	this.shape_5.setTransform(102.1,39.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,11,0,-11).s().p("AAeCjIgejyIAAAAIgdDyIhQAAIAylFIB3AAIAyFFg");
	this.shape_6.setTransform(78.3,39.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,10.1,0,-10).s().p("AhkCjIAAlFIDCAAIAAA8IhwAAIAAA2IAlAAQAZAAANACQAOADAKAHQAJAIAFARQAGAQAAAbIAABMQgBAOgFALQgFAKgJAHQgRANgaAAgAgSBnIAbAAQAKAAAAgWIAAgxQAAgVgKAAIgbAAg");
	this.shape_7.setTransform(55,39.3);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,10.1,0,-10).s().p("AgvCjQgTgFgMgJQgLgJgGgOQgEgNAAgSIAAi9QAAgSAEgNQAGgOALgJQAMgJATgFQATgFAcAAQAcAAAUAFQATAFAMAJQAMAJAEAOQAGANgBASIAAC9QABASgGANQgEAOgMAJQgMAJgTAFQgUAFgcAAQgcAAgTgFgAgOhlQgEAEAAAOIAACnQAAAOAEAEQAFAEAJAAQALAAADgEQAFgEAAgOIAAinQAAgOgFgEQgDgEgLAAQgJAAgFAEg");
	this.shape_8.setTransform(31.8,39.3);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,8.2,0,-8.1).s().p("AhRCjIAAlFICiAAIAAA8IhRAAIAAEJg");
	this.shape_9.setTransform(11.2,39.3);
...
(lib.Symbol31 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,5.9,0,-5.8).s().p("AgrClIgOlKIB0AAIgOFKg");
	this.shape.setTransform(209.8,49.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,14.7,0,-14.6).s().p("AAmDnIABjaIgBAAIhMDaIhsAAIAAnNIBtAAIgBDTIABAAIBMjTIBsAAIAAHNg");
	this.shape_1.setTransform(185,55.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,15.7,0,-15.6).s().p("AAuDnIgJhNIhIAAIgKBNIhuAAIBFnNICtAAIBFHNgAgZBFIAzAAIgajPIAAAAg");
	this.shape_2.setTransform(151.4,55.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,14.3,0,-14.2).s().p("");
	this.shape_3.setTransform(118.4,55.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,15.7,0,-15.6).s().p("AAuDnIgJhNIhIAAIgKBNIhuAAIBFnNICtAAIBFHNgAgZBFIAzAAIgajPIAAAAg");
	this.shape_4.setTransform(85.3,55.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,14.7,0,-14.6).s().p("AAfDnIAAlxIg9AAIAAFxIh0AAIAAnNIElAAIAAHNg");
	this.shape_5.setTransform(51.7,55.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,14.3,0,-14.2).s().p("");
	this.shape_6.setTransform(18.4,55.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],-5.1,0,5.2,0).s().p("AgzAuIAAhbIBnAAIAABbg");
	this.shape_7.setTransform(209.8,74.4);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],-11.5,0,11.6,0).s().p("AgyAtQgVgGgPgOQgOgNgHgTQgHgTAAgZIBYAAQAAAUAGAGQAGAFAPAAQAPAAAFgFQAGgGAAgUIBYAAQAAAZgGATQgIATgOANQgPAOgWAGQgVAHgcAAQgcAAgXgHg");
	this.shape_8.setTransform(185.1,25.2);
...
(lib.Symbol26 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,12.7,0,-12.7).s().p("Ah+DnIAAnNID9AAIAABUIiKAAIAABZIBzAAIAABUIhzAAIAAB4ICKAAIAABUg");
	this.shape.setTransform(46.3,55.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,12.7,0,-12.7).s().p("Ah+DnIAAnNID9AAIAABUIiKAAIAABZIBzAAIAABUIhzAAIAAB4ICKAAIAABUg");
...
(lib.Symbol25 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,12.8,0,-12.7).s().p("AhRCpIAAgyQAAgjAMgUQALgSAVgGQARgGAcAAQATAAAAgfIAAg1QAAgTgGgGQgFgFgNAAQgNAAgGAFQgHAHAAASIAAAYIhoAAIAAgnQAAgZAIgTQAHgTAQgOQAPgMAYgHQAZgHAgAAQAhAAAZAHQAYAHAPAMQAQAOAHATQAIATAAAZIAABEQAAAhgHAYQgHAXgNAOQgMAOgUAGQgSAGgZAAIAAAAQgNAAgFAFQgFAHAAASIAAAQg");
	this.shape.setTransform(173.1,49);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,14.6,0,-14.6).s().p("Ag5DnIAAl5IhYAAIAAhUIEjAAIAABUIhZAAIAAF5g");
	this.shape_1.setTransform(142.9,55.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,12.7,0,-12.7).s().p("Ah+DnIAAnNID9AAIAABUIiJAAIAABZIByAAIAABUIhyAAIAAB4ICJAAIAABUg");
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,12.7,0,-12.7).s().p("Ah+DnIAAnNID9AAIAABUIiKAAIAABZIBzAAIAABUIhzAAIAAB4ICKAAIAABUg");
	this.shape_4.setTransform(50.9,55.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,14.7,0,-14.6).s().p("AAeDnIAAjFIg8AAIAADFIhzAAIAAnNIBzAAIAACtIA8AAIAAitIB0AAIAAHNg");
	this.shape_5.setTransform(19,55.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],-5.2,0,5.2,0).s().p("AgzAuIAAhbIBnAAIAABbg");
	this.shape_6.setTransform(169.1,74.4);
...
(lib.Symbol24 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,15.7,0,-15.6).s().p("AAuDnIgJhNIhIAAIgKBNIhuAAIBFnNICtAAIBFHNgAgZBFIAzAAIgajPIAAAAg");
	this.shape.setTransform(128.2,55.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,19.3,0,-19.2).s().p("ABUENIAAhMIioAAIAABMIhsAAIAAihIAuAAIAAl5IEkAAIAAF5IAvAAIAAChgAgeBsIA8AAIAAkcIg8AAg");
	this.shape_1.setTransform(91,59.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,14.3,0,-14.2).s().p("AhDDkQgbgHgRgNQgQgNgHgUQgIgSABgaIAAgqIBzAAIAAAbQAAATAGAHQAGAEAOABQAPgBAFgEQAHgHAAgTIAAhCIg1AAQgkAAgRgCQgVgFgNgKQgPgLgGgXQgIgXABgoIAAiqIBzAAIAACqQAAAfAPAAIAmAAIAAjJIBzAAIAAFtQAAAagGASQgIAUgQANQgRANgbAHQgcAHgoAAQgnAAgcgHg");
	this.shape_2.setTransform(54.1,56.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,10.2,0,-10.2).s().p("AgUDnIhRjtIBNjgIB4AAIhWDXIBcD2g");
	this.shape_3.setTransform(26.3,55.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["#DEC2C2","#FFFFFF"],[0,1],0,5.7,0,-5.6).s().p("Ag3DnIAAnNIBvAAIAAHNg");
	this.shape_4.setTransform(10,55.9);
...
(lib.Symbol22 = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(298.9,-61.6,1,1,0,0,0,80.5,35.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:68.9},9).to({x:298.9},10).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-9.5,-76.2,833.9,186.6);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1483004957208", id:"back"},
		{src:"images/elka.png?1483004957208", id:"elka"},
		{src:"images/girl1.png?1483004957208", id:"girl1"},
		{src:"images/girl2.png?1483004957208", id:"girl2"},
		{src:"images/girl3.png?1483004957208", id:"girl3"},
		{src:"images/girl4.png?1483004957208", id:"girl4"},
		{src:"images/girl5.png?1483004957208", id:"girl5"},
		{src:"images/gob1.png?1483004957208", id:"gob1"},
		{src:"images/gob2.png?1483004957208", id:"gob2"},
		{src:"images/gob3.png?1483004957208", id:"gob3"},
		{src:"images/gob4.png?1483004957208", id:"gob4"},
		{src:"images/gob5.png?1483004957208", id:"gob5"},
		{src:"images/gob6.png?1483004957208", id:"gob6"},
		{src:"images/gob7.png?1483004957208", id:"gob7"},
		{src:"images/gorl6.png?1483004957208", id:"gorl6"},
		{src:"images/gun.png?1483004957208", id:"gun"},
		{src:"images/Ieg.png?1483004957208", id:"Ieg"},
		{src:"images/mousethinroundedbuttonoutline.png?1483004957208", id:"mousethinroundedbuttonoutline"}
	],
	preloads: []
};
