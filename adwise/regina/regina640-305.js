...
(lib.Символ76 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#660066").s().p("");
	this.shape.setTransform(104,57.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ76, new cjs.Rectangle(0,0,208,115.8), null);
...
(lib.Символ73 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(10,13.4);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ73, new cjs.Rectangle(0,0,19.9,26.9), null);
...
(lib.Символ72 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AArBVIgrgzIgqAzIhQAAIBVhbIhEhOIBLAAIAeAkIAfgkIBNAAIhGBOIBUBbg");
	this.shape.setTransform(12.3,8.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ72, new cjs.Rectangle(0,0,24.5,16.9), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ71, new cjs.Rectangle(0,0,39.7,43.2), null);
...
(lib.Символ69 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#009900").s().p("");
	this.shape.setTransform(67.4,8.2);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ69, new cjs.Rectangle(0,0,134.9,16.4), null);
...
(lib.Символ66 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333300").s().p("AANApIAAhSIAgAAQAKABAGACQAHAEAEAFQADAHABAJQgBAHgBAFQgCAFgEADQgDADgGADQgGABgGAAIgNAAIAAAbgAAigDIAMAAQADAAACgCQACgDAAgFQAAgFgCgCQgCgCgDgBIgIAAIgEAAgAgWApIAAgiIgfAAIAAAiIgWAAIAAhSIAWAAIAAAhIAfAAIAAghIAWAAIAABSg");
	this.shape.setTransform(7.6,4.2);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ66, new cjs.Rectangle(0,0,15.1,8.3), null);
...
(lib.Символ65 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(15.6,4.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ65, new cjs.Rectangle(0,0,31.3,9), null);
...
(lib.Символ59 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FF6699","#FF33FF"],[0,1],0,-9.8,0,9.8).s().p("AhhBsIA1jkQANgBAVACIBsDqQgZAEgnABIgTg2IgzACIgJA2QgbgEgZgKgAgeAaIAlgGIgag9g");
...
(lib.Символ58 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FF6699","#FF33FF"],[0,1],0,-12.4,0,12.5).s().p("ABYBhIhlABIAAgBIhoAAIgHjiIBUgFIgFCgIAMABIAhgCIgEigIBTAFIgFC6IAwAAIADBGIgqAKg");
...
(lib.Символ57 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FF6699","#FF33FF"],[0,1],0.1,-11.1,0.1,11.1).s().p("AAoAeIhRBRIg9gFIgIjcIBDAGIAJBuIBNhnIA6gIIAKDdIhHADg");
	this.shape.setTransform(11.1,13.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#FF6699","#FF33FF"],[0,1],-3.3,0,3.4,0).s().p("AgdAGQgIgGAIgEQAIgGAUgCQAXABAIAFQAIAFgIAHQgIAHgWAAQgVAAgIgHg");
...
(lib.Символ53 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FF6699","#FF33FF"],[0,1],0.1,-7.2,0.1,7.3).s().p("AhEB1IgEhfIAGiKIBigEQAWAAARAEIAAA1Ig/AFIAAAcIAzgDIAAABIgJA4IgnAFIAAABIAGAeIA3gDIAABAg");
...
(lib.Символ52 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FF6699","#FF33FF"],[0,1],0,-8.4,0,8.4).s().p("AhTB3IAKj2IA6AAIAAACIBcgCIgKAyIhWgHIgIBaQARgCAQAEQASAEAOAHQAPAGAOAKQAPAJACARQABAQgNAPQgOAPgQAHQgQAIgiAEIgUACQgaAAgdgJgAghAiIgFAuQAWAAALgLQAKgLgGgQQgFgLgNAAQgGAAgIADg");
...
(lib.Символ51 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FF6699","#FF33FF"],[0,1],0,-10.8,0,10.8).s().p("Ag/BpQgdgXgKghQgJgiAGgbQAGgbAQgXQAPgYAZgOQAZgPAZgFQAZgEAUAIQATAIAXAgIgnAyQgGgIgYgGQgXgGgRAOQgRAOAAAXQABAYANAIQANAIAJgBQALgCAIgEQAIgEAYgTIA1AqQgNATgKAHIggATQgWALggAHQgIACgHAAQgZAAgWgRg");
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-16.7,22.8,0.686,1,0,0,-9.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ7, new cjs.Rectangle(-16.7,-12,200.6,612.8), null);
...
(lib.Символ74 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(82.8,23.4,1,1,0,0,0,10,13.4);

	this.instance_1 = new lib.Символ72();
	this.instance_1.parent = this;
	this.instance_1.setTransform(56.6,24.1,0.555,0.555,0,0,0,12.2,8.4);

	this.instance_2 = new lib.Символ71();
	this.instance_2.parent = this;
	this.instance_2.setTransform(19.9,21.6,1,1,0,0,0,19.9,21.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ74, new cjs.Rectangle(0,0,92.7,43.2), null);
...
(lib.Символ67 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(41.6,12.3,1,1,0,0,0,5.2,5.2);

	this.instance_1 = new lib.Символ20();
	this.instance_1.parent = this;
	this.instance_1.setTransform(6.8,12.3,1,1,0,0,0,5.2,5.2);

	this.instance_2 = new lib.Символ18();
	this.instance_2.parent = this;
	this.instance_2.setTransform(41,10.7,1,1,0,0,0,10.7,10.7);

	this.instance_3 = new lib.Символ17();
	this.instance_3.parent = this;
	this.instance_3.setTransform(10.7,10.7,1,1,0,0,0,10.7,10.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ67, new cjs.Rectangle(0,0,50.8,21.4), null);
...
(lib.Символ6 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(255.7,283,0.874,1,0,0,0,178.6,283);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ6, new cjs.Rectangle(99.6,0,312,566), null);
...
(lib.Символ77 = function(mode,startPosition,loop) {
	...
	this.instance = new lib.Символ49();
	this.instance.parent = this;
	this.instance.setTransform(15.8,17,0.472,0.472,0,0,0,33.4,36);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:29.9,regY:36.1,rotation:-720,x:14.1,y:17.1},34).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2.5,-2.5,75.4,73.1);
...
(lib.Символ68 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(19,22,0.419,0.419,0,0,0,25.2,10.7);

	this.instance_1 = new lib.herik();
	this.instance_1.parent = this;
	this.instance_1.setTransform(22,0,0.419,0.419);

	this.instance_2 = new lib.her();
	this.instance_2.parent = this;
	this.instance_2.setTransform(0,0,0.419,0.419);

	this.instance_3 = new lib.boda();
	this.instance_3.parent = this;
	this.instance_3.setTransform(7,15,0.419,0.419);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ68, new cjs.Rectangle(0,0,37.1,46.8), null);
...
(lib.Символ62 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(248.3,17.5,1.229,1.229,0,0,0,162.9,24);

	this.instance_1 = new lib.Символ76();
	this.instance_1.parent = this;
	this.instance_1.setTransform(111.1,57.3,1,1,0,0,0,104,57.9);
	this.instance_1.alpha = 0.801;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ62, new cjs.Rectangle(0,-0.6,215.1,116.4), null);
...
(lib.Символ48 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:0.79,scaleY:0.79},19).to({scaleX:0.84,scaleY:0.84},4).to({scaleX:1,scaleY:1},11).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-44.6,0,881.2,651.8);
...
(lib.Символ5 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({rotation:-2.3,x:42.2,y:71.2},16,cjs.Ease.get(-1)).to({rotation:-4.9,x:39.3,y:73.2},14,cjs.Ease.get(1)).to({rotation:-2.3,x:42.3,y:71},15,cjs.Ease.get(-1)).to({rotation:0,x:45,y:69},14,cjs.Ease.get(1)).wait(2).to({rotation:-2.3,x:42.2,y:71.2},16,cjs.Ease.get(-1)).to({rotation:-4.9,x:39.3,y:73.2},14,cjs.Ease.get(1)).to({rotation:-2.8,x:41.6,y:71.6},14,cjs.Ease.get(-1)).to({regX:44.9,rotation:-6.7,x:42,y:74.3},1).to({regX:45,rotation:-2.3,x:42.3,y:71},2).wait(1).to({rotation:0,x:45,y:69},11,cjs.Ease.get(1)).to({_off:true},1).wait(1));
...
(lib.Символ70 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(18.5,23.4,1,1,0,0,0,18.5,23.4);

	this.instance_1 = new lib.Символ66();
	this.instance_1.parent = this;
	this.instance_1.setTransform(50,29.8,1,1,0,0,0,7.5,4.2);

	this.instance_2 = new lib.Символ65();
	this.instance_2.parent = this;
	this.instance_2.setTransform(110.4,29.5,1,1,0,0,0,15.6,4.5);

	this.instance_3 = new lib.Символ69();
	this.instance_3.parent = this;
	this.instance_3.setTransform(105.3,29.4,1,1,0,0,0,67.4,8.2);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#009900").s().p("");
...
}).prototype = getMCSymbolPrototype(lib.Символ70, new cjs.Rectangle(0,0,172.8,46.8), null);
...
(lib.Символ64 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-143.5,-108.5,1,1,0,0,0,46.3,21.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-142.4,y:-172.7},19,cjs.Ease.get(1)).to({y:-110.8},20,cjs.Ease.get(-1)).wait(1));

	// Слой 1
	this.instance_1 = new lib.Символ70();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-312,-417,1,1,0,0,0,86.4,23.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-106.5},19,cjs.Ease.get(1)).to({x:-307.9},20,cjs.Ease.get(-1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-398.4,-440.4,301.3,353.5);
...
(lib.regina640305 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		function fl_CustomMouseCursor_2() {
			...
			this.elki.x = - stage.mouseX/20/window.devicePixelRatio;
	...
	// Слой 9
	this.face = new lib.Символ64();
	this.face.parent = this;
	this.face.setTransform(267.6,455.2,1,1,0,0,0,67.4,8.2);
	...
	// elka.png
	this.elki = new lib.Символ10();
	this.elki.parent = this;
	this.elki.setTransform(-12.4,137.3,1,1,0,0,0,53.6,332.3);

	this.timeline.addTween(cjs.Tween.get(this.elki).wait(1));

	// elkaka.png
	this.instance_1 = new lib.Символ11_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-457.2,14.1,1,1,0,0,0,83,83);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(326.3,102.5,1,1,0,0,0,328.3,208.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(121.7,-42.5,1236.3,651.8);
// library properties:
lib.properties = {
	width: 640,
	height: 305,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/arma.png?1482932514848", id:"arma"},
		{src:"images/armikol.png?1482932514848", id:"armikol"},
		{src:"images/aska.png?1482932514848", id:"aska"},
		{src:"images/assy.png?1482932514848", id:"assy"},
		{src:"images/back.jpg?1482932514848", id:"back"},
		{src:"images/boda.png?1482932514848", id:"boda"},
		{src:"images/corner.png?1482932514848", id:"corner"},
		{src:"images/elka.png?1482932514848", id:"elka"},
		{src:"images/elkaka.png?1482932514848", id:"elkaka"},
		{src:"images/fing.png?1482932514848", id:"fing"},
		{src:"images/foot.png?1482932514848", id:"foot"},
		{src:"images/haed.png?1482932514848", id:"haed"},
		{src:"images/her.png?1482932514848", id:"her"},
		{src:"images/herik.png?1482932514848", id:"herik"},
		{src:"images/lawkod.png?1482932514848", id:"lawkod"},
		{src:"images/leg.png?1482932514848", id:"leg"},
		{src:"images/leggy.png?1482932514848", id:"leggy"},
		{src:"images/rabarm.png?1482932514848", id:"rabarm"},
		{src:"images/rabarman.png?1482932514848", id:"rabarman"},
		{src:"images/romkl.png?1482932514848", id:"romkl"},
		{src:"images/rou.png?1482932514848", id:"rou"},
		{src:"images/shadow.png?1482932514848", id:"shadow"},
		{src:"images/shisha.png?1482932514848", id:"shisha"},
		{src:"images/volossa.png?1482932514848", id:"volossa"}
	],
	preloads: []
};
