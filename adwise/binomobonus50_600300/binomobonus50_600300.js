...
p.nominalBounds = new cjs.Rectangle(0,0,263,45);// helper functions:
...
(lib.Символ52 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-137,-182,1.062,1.062);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ52, new cjs.Rectangle(-137,-182,275.1,304.8), null);
...
(lib.Символ50 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(526.6,-133,0.901,0.901,0,0,180);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ50, new cjs.Rectangle(258,-133,268.6,270.4), null);
...
(lib.Символ34 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#401000").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ34, new cjs.Rectangle(-86.9,-11,173.9,22.1), null);
...
(lib.Символ54 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(20,20,0.91,0.91);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ54, new cjs.Rectangle(-104.7,-145.7,250.5,277.5), null);
...
p.nominalBounds = new cjs.Rectangle(258,-133,268.6,270.4);
...
(lib.Символ4 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,53.2,1.246,1.246);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(7).to({x:-125.6},0).to({x:9.3,alpha:1},5,cjs.Ease.get(1)).to({x:0},2,cjs.Ease.get(1)).wait(37).to({rotation:5.2,y:43.9},2).to({rotation:0,y:153,alpha:0},6).wait(1));

	// Символ 14
	this.instance_1 = new lib.Символ14();
	this.instance_1.parent = this;
	this.instance_1.setTransform(0,0,1.246,1.246);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({y:32.5},0).to({y:-9.3,alpha:1},5,cjs.Ease.get(1)).to({y:0},2,cjs.Ease.get(1)).wait(40).to({rotation:-10.5,y:-9.3},2).to({rotation:0,y:99.8,alpha:0},6).wait(1));

	// Символ 11
	this.instance_2 = new lib.Символ11();
	this.instance_2.parent = this;
	this.instance_2.setTransform(0,-53.1,1.246,1.246);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({x:102.3},0).to({x:-9.3,alpha:1},5,cjs.Ease.get(1)).to({x:0},2,cjs.Ease.get(1)).wait(43).to({regX:-0.1,regY:-0.1,rotation:5.7,x:-0.1,y:-62.4},2).to({regX:0,regY:0,rotation:0,x:0,y:46.7,alpha:0},6).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-154,-77.6,283.6,150.3);
...
p.nominalBounds = new cjs.Rectangle(-104.7,-145.7,250.5,277.5);
...
}).prototype = getMCSymbolPrototype(lib.Символ16, new cjs.Rectangle(-169,-85.6,311.4,165.1), null);
...
// stage content:
(lib.binomobonus50_600300 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
