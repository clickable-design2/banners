...
p.nominalBounds = new cjs.Rectangle(4.1,9.6,153.5,31.9);
...
(lib.Katapulka_600300 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(140.5,249.2,1.36,1.36,0,0,0,91,21.1);
	this.instance.shadow = new cjs.Shadow("rgba(51,0,0,1)",0,0,12);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.png?1484582147996", id:"back"},
		{src:"images/kata.png?1484582147996", id:"kata"},
		{src:"images/logo.png?1484582147996", id:"logo"},
		{src:"images/palka.png?1484582147996", id:"palka"}
	],
	preloads: []
};
