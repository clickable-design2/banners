...
(lib.dreemloto_logo = function() {
	this.initialize(img.dreemloto_logo);
}).prototype = p = new cjs.Bitmap();
...
p.nominalBounds = new cjs.Rectangle(0,0,629,185);
...
(lib.Символ6 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-1,381,1,1,-90);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ6, new cjs.Rectangle(-1,-1,382,382), null);
...
(lib.Символ5 = function(mode,startPosition,loop) {
	...
	// Слой 3
	this.instance = new lib.dreemloto_logo();
	this.instance.parent = this;
	this.instance.setTransform(43,7,0.295,0.295);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(81.6,72.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ5, new cjs.Rectangle(-1.3,7,165.7,68.2), null);
...
(lib.Символ2 = function(mode,startPosition,loop) {
	...
	this.instance_2.setTransform(191.1,191.1,1,1,-90,0,0,190.8,191);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({regX:190,regY:190,rotation:-88.9,x:190.1,y:191.9},0).wait(1).to({rotation:-85.4,x:190,y:191.7},0).wait(1).to({rotation:-79.7},0).wait(1).to({rotation:-71.6,x:189.9,y:191.5},0).wait(1).to({rotation:-61.3,x:189.8,y:191.3},0).wait(1).to({rotation:-48.7,y:191},0).wait(1).to({rotation:-33.7,y:190.7},0).wait(1).to({rotation:-16.6,x:190,y:190.3},0).wait(1).to({rotation:3,x:190.2,y:190.1},0).wait(1).to({rotation:24.8,x:190.6,y:189.8},0).wait(1).to({rotation:48.9,x:191.2},0).wait(1).to({rotation:75.3,x:191.7,y:190},0).wait(1).to({rotation:104,x:192.2,y:190.4},0).wait(1).to({rotation:135,x:192.3,y:191.1},0).wait(1).to({rotation:168.3,x:192,y:191.8},0).wait(1).to({rotation:203.9,x:191.4,y:192.2},0).wait(1).to({rotation:241.7,x:190.5},0).wait(1).to({rotation:281.9,x:189.9,y:191.6},0).wait(1).to({rotation:324.4,x:189.8,y:190.7},0).wait(1).to({rotation:369.2,x:190.3,y:190},0).wait(1).to({rotation:416.3,x:191.3,y:189.8},0).wait(1).to({rotation:465.6,x:192.2,y:190.4},0).wait(1).to({rotation:517.2,y:191.6},0).wait(1).to({rotation:571.2,x:191.2,y:192.3},0).wait(1).to({rotation:627.5,x:190.1,y:191.9},0).wait(1).to({rotation:686,x:189.8,y:190.7},0).wait(1).to({rotation:746.8,x:190.7,y:189.9},0).wait(1).to({rotation:810,x:192,y:190.2},0).wait(1).to({regX:191,regY:191,rotation:692,x:191,y:191},0).to({_off:true},1).wait(30).to({_off:false,regX:189.5,regY:189.7,scaleX:1,scaleY:1,rotation:512.4,x:192.6,y:191.1},0).wait(1).to({regX:190,regY:190,scaleX:1,scaleY:1,rotation:513.1,x:192,y:191},0).wait(1).to({rotation:515.3},0).wait(1).to({rotation:518.8},0).wait(1).to({rotation:523.8,y:190.9},0).wait(1).to({rotation:530.2,x:192.1,y:190.8},0).wait(1).to({rotation:538},0).wait(1).to({rotation:547.2,x:192.2,y:190.7},0).wait(1).to({rotation:557.8,y:190.6},0).wait(1).to({rotation:569.8,x:192.4,y:190.5},0).wait(1).to({rotation:583.3,x:192.5},0).wait(1).to({rotation:598.2,x:192.6},0).wait(1).to({rotation:614.5,x:192.7},0).wait(1).to({rotation:632.2,x:193,y:190.6},0).wait(1).to({rotation:651.3,x:193.1,y:190.7},0).wait(1).to({rotation:671.9,x:193.2,y:190.9},0).wait(1).to({rotation:693.9,y:191.1},0).wait(1).to({rotation:717.2,y:191.3},0).wait(1).to({rotation:742,x:193,y:191.5},0).wait(1).to({rotation:768.3,x:192.7,y:191.7},0).wait(1).to({rotation:795.9,x:192.4},0).wait(1).to({rotation:825,x:192.2,y:191.4},0).wait(1).to({rotation:855.4,x:192.1,y:191.2},0).wait(1).to({rotation:887.3,x:192,y:190.9},0).wait(1).to({rotation:920.6,x:192.3,y:190.6},0).wait(1).to({rotation:955.3,x:192.6,y:190.4},0).wait(1).to({rotation:991.5,x:192.9,y:190.6},0).wait(1).to({rotation:1029,x:193.2,y:190.8},0).wait(1).to({rotation:1068,y:191.2},0).wait(1).to({rotation:1108.4,x:192.9,y:191.6},0).wait(1).to({regX:190.5,regY:190.6,rotation:1259.7,x:190.9,y:191.1},0).to({_off:true},1).wait(30));
...
(lib.take_jackpot = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(136.8,207.3,1,1,0,0,0,111.9,30.4);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(136.8,140.6,1,1,0,0,0,115.8,59.8);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bif.jpg?1493994142318", id:"bif"},
		{src:"images/dreemloto_logo.png?1493994142318", id:"dreemloto_logo"},
		{src:"images/logo18.png?1493994142318", id:"logo18"},
		{src:"images/msl.png?1493994142318", id:"msl"},
		{src:"images/strelka.png?1493994142318", id:"strelka"},
		{src:"images/text1.png?1493994142318", id:"text1"},
		{src:"images/wheel.png?1493994142318", id:"wheel"}
	],
	preloads: []
};
