...
(lib.Символ10 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.instance = new lib.statu91();
	this.instance.parent = this;
	this.instance.setTransform(654.6,359,0.698,0.698,0,0,180);
...
}).prototype = getMCSymbolPrototype(lib.Symbol28, new cjs.Rectangle(-7.5,-18,15,36), null);
...
}).prototype = getMCSymbolPrototype(lib.Слой3, new cjs.Rectangle(0,0,60,65), null);
...
}).prototype = getMCSymbolPrototype(lib.Слой2, new cjs.Rectangle(0,0,31,35), null);
...
}).prototype = getMCSymbolPrototype(lib.Слой1, new cjs.Rectangle(0,0,92,51), null);


(lib.Слой0 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.Слой0, new cjs.Rectangle(0,0,61,114), null);
...
(lib.Symbol = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(77.3,42.6,0.111,0.111,0,0,0,81.4,81.4);
...
}).prototype = getMCSymbolPrototype(lib.Symbol, new cjs.Rectangle(0,20,319.8,235.8), null);
...
p.nominalBounds = new cjs.Rectangle(0,20,319.8,235.8);
...
(lib.Символ8_1 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.instance_2 = new lib.Слой1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(57,49.5,1,1,0,0,0,46,25.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({regY:25.6,rotation:-4.7,x:56.5,y:52.4},0).wait(1).to({regY:25.5,rotation:0,x:57,y:49.5},0).wait(1).to({regY:25.6,rotation:-4.7,x:56.5,y:52.4},0).wait(1).to({regY:25.5,rotation:0,x:57,y:49.5},0).wait(1).to({regY:25.6,rotation:-4.7,x:56.5,y:52.4},0).wait(1).to({regY:25.5,rotation:0,x:57,y:49.5},0).wait(1).to({regY:25.6,rotation:-4.7,x:56.5,y:52.4},0).wait(17));

	// Слой 2
	this.instance_3 = new lib.Слой2();
	this.instance_3.parent = this;
	this.instance_3.setTransform(68.5,19.5,1,1,0,0,0,15.5,17.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({y:22.5},0).wait(1).to({y:19.5},0).wait(1).to({y:22.5},0).wait(1).to({y:19.5},0).wait(1).to({y:22.5},0).wait(1).to({y:19.5},0).wait(1).to({y:22.5},0).wait(17));

	// Слой 3
	this.instance_4 = new lib.Слой3();
	this.instance_4.parent = this;
	this.instance_4.setTransform(91,56.5,1,1,0,0,0,30,32.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({x:90},0).wait(1).to({x:91},0).wait(1).to({x:90},0).wait(1).to({x:91},0).wait(1).to({x:90},0).wait(1).to({x:91},0).wait(1).to({x:90},0).wait(17));

	// Слой 0
	this.instance_5 = new lib.Слой0();
	this.instance_5.parent = this;
	this.instance_5.setTransform(86.5,139,1,1,0,0,0,30.5,57);
...
p.nominalBounds = new cjs.Rectangle(-47.5,-30.5,183.8,103);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bullet1.png?1485351139172", id:"bullet1"},
		{src:"images/fire.png?1485351139172", id:"fire"},
		{src:"images/fon.jpg?1485351139172", id:"fon"},
		{src:"images/Layer_1.png?1485351139172", id:"Layer_1"},
		{src:"images/Layer_2.png?1485351139172", id:"Layer_2"},
		{src:"images/Layer_3.png?1485351139172", id:"Layer_3"},
		{src:"images/Layer_4.png?1485351139172", id:"Layer_4"},
		{src:"images/r2.png?1485351139172", id:"r2"},
		{src:"images/r3.png?1485351139172", id:"r3"},
		{src:"images/r4.png?1485351139172", id:"r4"},
		{src:"images/r5.png?1485351139172", id:"r5"},
		{src:"images/r6.png?1485351139172", id:"r6"},
		{src:"images/rifle1.png?1485351139172", id:"rifle1"},
		{src:"images/statu91.png?1485351139172", id:"statu91"}
	],
	preloads: []
};
