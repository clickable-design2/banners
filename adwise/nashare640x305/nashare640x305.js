...
(lib.Символ41 = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(-334.4,-159.3,1.045,1.045);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ41, new cjs.Rectangle(-334.4,-159.3,668.8,318.7), null);
...
p.nominalBounds = new cjs.Rectangle(-334.4,-159.3,668.8,318.7);
...
(lib.Символ3 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:29.9},6,cjs.Ease.get(1)).to({x:-69.6},8,cjs.Ease.get(-1)).wait(1).to({x:-104.8},6,cjs.Ease.get(1)).to({x:-192.8},8,cjs.Ease.get(-1)).wait(1).to({x:-227.3},6,cjs.Ease.get(1)).to({x:-313.6},8,cjs.Ease.get(-1)).wait(1).to({skewY:180,x:-39.2},0).to({x:-4.4},6,cjs.Ease.get(1)).to({x:82.4},8,cjs.Ease.get(-1)).wait(1).to({x:125.2},6,cjs.Ease.get(1)).to({x:232},8,cjs.Ease.get(-1)).wait(1).to({x:264},6,cjs.Ease.get(1)).to({x:344},8,cjs.Ease.get(-1)).wait(1).to({skewY:0,x:69.6},0).to({x:-313.6},20,cjs.Ease.get(1)).wait(1).to({skewY:180,x:-39.2},0).to({x:344},20,cjs.Ease.get(1)).wait(1).to({skewY:0,x:69.6},0).wait(1));
...
p.nominalBounds = new cjs.Rectangle(291.3,-839,696,1437.7);
// library properties:
lib.properties = {
	width: 640,
	height: 305,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/arr.png?1483017684290", id:"arr"},
		{src:"images/bg.jpg?1483017684290", id:"bg"},
		{src:"images/elk_2uu1.png?1483017684290", id:"elk_2uu1"},
		{src:"images/luk.png?1483017684290", id:"luk"},
		{src:"images/mish.png?1483017684290", id:"mish"},
		{src:"images/nashare_03.png?1483017684290", id:"nashare_03"},
		{src:"images/nashare_05.png?1483017684290", id:"nashare_05"},
		{src:"images/nashare_08.png?1483017684290", id:"nashare_08"},
		{src:"images/nashare_13.png?1483017684290", id:"nashare_13"},
		{src:"images/nashare_16.png?1483017684290", id:"nashare_16"},
		{src:"images/nashare_19.png?1483017684290", id:"nashare_19"},
		{src:"images/nashare_22.png?1483017684290", id:"nashare_22"},
		{src:"images/nashare_26.png?1483017684290", id:"nashare_26"},
		{src:"images/nashare_28.png?1483017684290", id:"nashare_28"},
		{src:"images/nashare_29_03.png?1483017684290", id:"nashare_29_03"},
		{src:"images/ten.png?1483017684290", id:"ten"}
	],
	preloads: []
};
