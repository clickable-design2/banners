2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhLBqQgiglAAhEQAAgqARggQAQghAegSQAegRAoAAQAtAAApATIgXA7IgfgMQgPgFgRAAQgaAAgPAWQgPAWAAAlQAABQA8AAQASAAARgGIAjgLIAAA/QgjAPgrAAQg+AAghgkg");
	this.shape_3.setTransform(-43.9,1.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-58.1,-27.5,116.2,55.2);
...
(lib.Символ29 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(58.1,27.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ29, new cjs.Rectangle(0,0,116.2,55.2), null);
...
(lib.Символ27 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(260.2,57,1,1,0,0,0,58.1,27.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:323.2},9).to({x:260.2},10).wait(1));

	// Слой 1
	this.instance_1 = new lib.Символ28();
	this.instance_1.parent = this;
	this.instance_1.setTransform(287.3,18.2,1,1,0,0,0,85.1,18.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:1.2,scaleY:1.2,y:20.3},9).to({scaleX:1,scaleY:1,y:18.2},10).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(202.1,0,170.3,84.5);
...
(lib.Символ36 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(62.9,-93.5,1,1,180,0,0,0,14.5);

	this.instance_1 = new lib.Символ38();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-28,191.5,1,1,0,0,0,0,14.5);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(17.6,49,1,1,0,0,0,17.4,49);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FF0000").ss(2,1,1).p("AAoAAQAAAQgMAMQgMAMgQAAQgPAAgMgMQgMgMAAgQQAAgPAMgNQAMgLAPAAQAQAAAMALQAMANAAAPg");
	this.shape.setTransform(18,49);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_2}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ36, new cjs.Rectangle(-0.8,-1,36.7,100), null);
...
(lib.Символ26 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(17.1,-176,1,1,0,0,0,206.2,44.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-26},4).to({y:-176},5).wait(1));

	// Слой 1
	this.instance_1 = new lib.Символ17();
	this.instance_1.parent = this;
	this.instance_1.setTransform(99.8,54.1,1,1,0,0,0,99.8,54.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-160.2},4).to({x:99.8},5).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-220.2,199.6,328.4);
...
(lib.Символ9 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:230.5},39).to({y:224.5},40).wait(2).to({regX:221,regY:165.5,scaleX:0.3,skewY:180,x:62,y:213.6},0).wait(1).to({regX:221.1,scaleX:0.84,x:81.9},0).wait(1).to({regX:221,scaleX:0.3,skewY:0,x:62},0).wait(1).to({regX:221.1,scaleX:0.84,x:42},0).wait(1));
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.b1.parent = this;
	this.b1.setTransform(290.6,156,1,1,0,0,0,76.2,164);
	new cjs.ButtonHelper(this.b1, 0, 1, 2, false, new lib.Символ45(), 3);

	this.b2 = new lib.Символ44();
	this.b2.parent = this;
	this.b2.setTransform(444.6,155,1,1,0,0,0,76.2,164);
	...
	this.girl = new lib.Символ9();
	this.girl.parent = this;
	this.girl.setTransform(392,189,1,1,0,0,0,87,225);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.girl},{t:this.kur}]}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(195.1,33.6,824,719);
// library properties:
lib.properties = {
	width: 640,
	height: 305,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1480929622048", id:"back"},
		{src:"images/hend.png?1480929622048", id:"hend"},
		{src:"images/sila1.jpg?1480929622049", id:"sila1"},
		{src:"images/sila2.jpg?1480929622049", id:"sila2"},
		{src:"images/sila3.jpg?1480929622049", id:"sila3"},
		{src:"images/sila4.jpg?1480929622049", id:"sila4"},
		{src:"images/sila5.jpg?1480929622049", id:"sila5"},
		{src:"images/sila6.png?1480929622049", id:"sila6"},
		{src:"images/sloy2.png?1480929622049", id:"sloy2"},
		{src:"images/sloy3.png?1480929622049", id:"sloy3"},
		{src:"images/sloy4.png?1480929622049", id:"sloy4"},
		{src:"images/sloy5.png?1480929622049", id:"sloy5"},
		{src:"images/sloy6.png?1480929622049", id:"sloy6"},
		{src:"images/sloy7.png?1480929622049", id:"sloy7"},
		{src:"images/Sloy8.png?1480929622049", id:"Sloy8"},
		{src:"images/sloy9.png?1480929622049", id:"sloy9"}
	],
	preloads: []
};
