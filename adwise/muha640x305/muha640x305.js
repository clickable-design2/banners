...
(lib.Символ77 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#990000").s().p("");
	this.shape.setTransform(-0.1,11.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF0000").s().p("");
...
(lib.Символ71 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ71, new cjs.Rectangle(-71.6,-15.1,143.2,30.3), null);
...
(lib.Символ70 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFCC00").s().p("");
	this.shape.setTransform(2.9,-7.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF9900").s().p("");
	this.shape_1.setTransform(0,7.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ70, new cjs.Rectangle(-71.6,-15.1,143.2,30.3), null);
...
(lib.Символ72 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.filters = [new cjs.BlurFilter(4, 4, 1)];
	this.instance.cache(-74,-17,147,34);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ72, new cjs.Rectangle(-73.6,-17.1,150,38), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ68, new cjs.Rectangle(-73.6,-15.1,150,40), null);
...
(lib.Символ67 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({regX:0,regY:3.2,scaleX:1.06,scaleY:1.06,x:82.8,y:4.6},0).wait(1).to({scaleX:1.11,scaleY:1.11,x:85.4,y:5.4},0).wait(1).to({scaleX:1.14,scaleY:1.14,x:87.4,y:6},0).wait(1).to({scaleX:1.17,scaleY:1.17,x:88.9,y:6.5},0).wait(1).to({scaleX:1.19,scaleY:1.19,x:90,y:6.9},0).wait(1).to({scaleX:1.21,scaleY:1.21,x:91.1,y:7.2},0).wait(1).to({regX:-57.5,regY:-15,scaleX:1.23,scaleY:1.23,x:21.6,y:-14.8},0).wait(1).to({regX:0,regY:3.2,scaleX:1.17,scaleY:1.17,x:88.7,y:6.4},0).wait(1).to({scaleX:1.13,scaleY:1.13,x:86.3,y:5.6},0).wait(1).to({scaleX:1.09,scaleY:1.09,x:84.4,y:5.1},0).wait(1).to({scaleX:1.07,scaleY:1.07,x:82.9,y:4.6},0).wait(1).to({scaleX:1.05,scaleY:1.05,x:81.8,y:4.2},0).wait(1).to({scaleX:1.03,scaleY:1.03,x:80.8,y:3.9},0).wait(1).to({scaleX:1.02,scaleY:1.02,x:79.9,y:3.6},0).wait(1).to({regX:-57.6,regY:-15.1,scaleX:1,scaleY:1,x:21.5,y:-14.9},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regX:0,regY:3.2,scaleX:1.05,scaleY:1.05,x:-68.2,y:3.9},0).wait(1).to({scaleX:1.08,scaleY:1.08,x:-70.3,y:4.5},0).wait(1).to({scaleX:1.1,scaleY:1.1,x:-71.9,y:4.9},0).wait(1).to({scaleX:1.11,scaleY:1.11,x:-73,y:5.2},0).wait(1).to({scaleX:1.13,scaleY:1.13,x:-74,y:5.4},0).wait(1).to({regX:71.6,regY:-15.2,scaleX:1.14,scaleY:1.14,x:6.7,y:-15.3},0).wait(1).to({regX:0,regY:3.2,scaleX:1.1,scaleY:1.1,x:-72.4,y:5},0).wait(1).to({scaleX:1.08,scaleY:1.08,x:-70.5,y:4.5},0).wait(1).to({scaleX:1.06,scaleY:1.06,x:-69.1,y:4.2},0).wait(1).to({scaleX:1.04,scaleY:1.04,x:-67.9,y:3.9},0).wait(1).to({scaleX:1.03,scaleY:1.03,x:-67.1,y:3.6},0).wait(1).to({scaleX:1.02,scaleY:1.02,x:-66.3,y:3.4},0).wait(1).to({scaleX:1.01,scaleY:1.01,x:-65.7,y:3.3},0).wait(1).to({regX:71.6,regY:-15.2,scaleX:1,scaleY:1,x:6.6,y:-15.3},0).wait(16));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-138.6,-15.2,281.1,40);
...
(lib.Символ1 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-355.2,-170.3,1.096,1.096,1.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(137));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-366.2,-170.3,766.7,386.5);
...
p.nominalBounds = new cjs.Rectangle(-488.3,-275.8,858.2,751.4);
...
p.nominalBounds = new cjs.Rectangle(174.3,60.5,858.2,751.3);
// library properties:
lib.properties = {
	width: 640,
	height: 305,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/fon.png?1478796872314", id:"fon"},
		{src:"images/mish.png?1478796872314", id:"mish"},
		{src:"images/muha2_01.png?1478796872314", id:"muha2_01"},
		{src:"images/muha2_03.png?1478796872314", id:"muha2_03"},
		{src:"images/muha2_04.png?1478796872314", id:"muha2_04"},
		{src:"images/muha_01.png?1478796872314", id:"muha_01"},
		{src:"images/muha_04.png?1478796872314", id:"muha_04"},
		{src:"images/muha_07.png?1478796872314", id:"muha_07"},
		{src:"images/muha_12.png?1478796872314", id:"muha_12"},
		{src:"images/muha_15.png?1478796872314", id:"muha_15"},
		{src:"images/muha_19.png?1478796872314", id:"muha_19"},
		{src:"images/muha_22.png?1478796872314", id:"muha_22"},
		{src:"images/muhoboyka.png?1478796872314", id:"muhoboyka"},
		{src:"images/rot.png?1478796872314", id:"rot"}
	],
	preloads: []
};
