...
(lib.Symbol9 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.spart();
	this.instance.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol9, new cjs.Rectangle(0,0,197,130), null);
...
(lib.Symbol4 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:0.06,x:98.6},19).to({scaleX:1,x:98.5},20).wait(1));
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.spart.setTransform(598.5,77,1,1,0,0,0,98.5,65);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/button.png?1490982346094", id:"button"},
		{src:"images/fott.png?1490982346094", id:"fott"},
		{src:"images/logo.png?1490982346094", id:"logo"},
		{src:"images/Rectangle1.jpg?1490982346094", id:"Rectangle1"},
		{src:"images/spart.png?1490982346094", id:"spart"},
		{src:"images/trener.png?1490982346094", id:"trener"},
		{src:"images/txt.png?1490982346094", id:"txt"}
	],
	preloads: []
};
