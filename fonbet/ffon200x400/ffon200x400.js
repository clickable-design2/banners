...
// stage content:
(lib.ffon200x400 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.team_two.setTransform(300.6,225.2,1,1,0,0,0,65,18.6);

	this.team_one = new lib.team_one();
	this.team_one.parent = this;
	this.team_one.setTransform(49.1,225.2,1,1,0,0,0,65,18.6);
	...
	this.sign_two.setTransform(151.2,140.4,0.899,0.899,0,0,0,53.8,53.8);

	this.sign_one = new lib.sign_one();
	this.sign_one.parent = this;
	this.sign_one.setTransform(48.7,140.4,0.899,0.899,0,0,0,53.8,53.8);

	this.koeff_3 = new lib.koeff_3();
	this.koeff_3.parent = this;
	this.koeff_3.setTransform(99.7,403.8,1,1,0,0,0,61.9,27.9);
	...
	this.btn.setTransform(99.9,343.5,0.898,0.898,0,0,0,96.6,28.2);
...
p.nominalBounds = new cjs.Rectangle(-238.5,151,1114.6,553.9);
// library properties:
lib.properties = {
	width: 200,
	height: 400,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1486024895726", id:"bg"},
		{src:"images/light.png?1486024895726", id:"light"},
		{src:"images/logo.png?1486024895726", id:"logo"},
		{src:"images/zagl_1.png?1486024895726", id:"zagl_1"},
		{src:"images/zagl_2.png?1486024895726", id:"zagl_2"}
	],
	preloads: []
};
