...
(lib.Symbol25 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(4.6,-502,0.944,0.944,0,0,0,42.8,37.1);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(49.3,-282.2,0.493,0.493,0,0,0,135.4,59.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol25, new cjs.Rectangle(-33.9,-621.1,164.3,368.3), null);
...
(lib.Symbol4 = function(mode,startPosition,loop) {
	...
	this.txt.setTransform(133,196.3,0.734,0.734,0,0,0,135.6,59.6);
	...
	this.instance.parent = this;
	this.instance.setTransform(69.8,-11.9,0.549,0.549,0,0,0,115.6,33.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(70,-267,0.589,0.589,0,0,0,90,28);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(164.3,149,1,1,0,0,0,324.5,232);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol4, new cjs.Rectangle(-160.2,-303.5,649.1,684.5), null);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.girl.setTransform(0,1,0.408,0.408,0,0,0,-46.6,-169.5);
...
p.nominalBounds = new cjs.Rectangle(-125.9,112.8,718.3,548.3);
// library properties:
lib.properties = {
	width: 120,
	height: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1499698678928", id:"back"},
		{src:"images/ball.png?1499698678928", id:"ball"},
		{src:"images/body.png?1499698678928", id:"body"},
		{src:"images/button.png?1499698678928", id:"button"},
		{src:"images/hand.png?1499698678928", id:"hand"},
		{src:"images/hand1.png?1499698678928", id:"hand1"},
		{src:"images/handl.png?1499698678928", id:"handl"},
		{src:"images/logored.png?1499698678928", id:"logored"},
		{src:"images/ser1.png?1499698678928", id:"ser1"},
		{src:"images/ser2.png?1499698678928", id:"ser2"},
		{src:"images/ser3.png?1499698678928", id:"ser3"},
		{src:"images/ser4.png?1499698678928", id:"ser4"}
	],
	preloads: []
};
