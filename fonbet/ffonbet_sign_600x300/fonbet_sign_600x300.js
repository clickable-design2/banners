...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-21,-10,1.073,1.073);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(-21,-10,644,322), null);
...
(lib.suuu = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.suuu, new cjs.Rectangle(-96.4,-15.6,193,31.4), null);
...
(lib.sumb = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0,-3.3,0,3.4).s().p("AhSAuIAOhbIAyAAIgIA1IBtAAIgGAmg");
	this.shape.setTransform(85.1,5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0,-3.2,0,3.2).s().p("AgfAuIAOhbIAxAAIgOBbg");
	this.shape_1.setTransform(70.5,5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0,-4.2,0,4.3).s().p("AhjAuIAOhbIAyAAIgIA1IArAAQATAAAOgMQANgNADgSIABgKIAxAAIgBALQgFAkgdAWQgcAWgqAAg");
	this.shape_2.setTransform(56.4,5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0,-3.2,0,3.2).s().p("AgfAuIAOhbIAxAAIgOBbg");
	this.shape_3.setTransform(40.1,5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0,-3.2,0,3.2).s().p("AgfAuIAOhbIAxAAIgOBbg");
	this.shape_4.setTransform(25,5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0,-3.6,0,3.7).s().p("ABDBMIAJg8IiUAAIgKA8IgxAAIAPhiIAOAAQATAAANgaQAFgLAGgRIAwAAIgDAJQgKAbgNASIBaAAIAIg2IAyAAIgJA2IAeAAIgPBig");
	this.shape_5.setTransform(7.1,8.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0.1,-4.2,0.1,4.3).s().p("AhTASQgWgaADgnIAyAAQgCAYAJAPQAMARAaAAQAXAAASgSQAOgPAGgXIAyAAQgJApgdAZQghAdguAAQgtAAgZgeg");
	this.shape_6.setTransform(-16.1,5.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0,-3.8,0,3.8).s().p("AhCAuIAOhbIB3AAQgMACgNAAIgtAAIgNBZg");
	this.shape_7.setTransform(-42.8,5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0,-4,0,4).s().p("AA5AuIgJg1IhPAAIgZA1Ig0AAIAthbICbAAIARBbg");
	this.shape_8.setTransform(-62.8,5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0,-3.2,0,3.2).s().p("AgfAuIAOhbIAxAAIgOBbg");
	this.shape_9.setTransform(-78.1,5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0,-3.2,0,3.2).s().p("AgfAuIAOhbIAxAAIgOBbg");
	this.shape_10.setTransform(-93.3,5);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("");
	this.shape_11.setTransform(0.9,-8.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.sumb, new cjs.Rectangle(-96.4,-15.6,193,31.4), null);
...
(lib.ddd = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.ddd, new cjs.Rectangle(-66,-12.8,132.1,25.6), null);
...
(lib.aaa = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0.1,-3.1,0.1,3.2).s().p("AgeAsIANhXIAwAAIgNBXg");
	this.shape.setTransform(60.5,8.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0.1,-4,0.1,4.1).s().p("Ag5AsIANhXIAxAAIgBAFIABAAIAEgFIAxAAIhBBXg");
	this.shape_1.setTransform(48,8.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0.1,-5,0.1,5).s().p("AgGAsIgrhXIA2AAIAtBXg");
	this.shape_2.setTransform(34.1,8.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0,-3.1,0,3.2).s().p("AgfAsIANhXIAyAAIgOBXg");
	this.shape_3.setTransform(23.2,8.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0,-4.3,0,4.3).s().p("AhiAsIANhXIAyAAIgHAwIAtAAQATAAAMgHQAMgJADgRQABgIgBgHIAyAAQABAHgBAIQgGAkgaASQgaASgrAAg");
	this.shape_4.setTransform(7.7,8.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0,-4.3,0,4.3).s().p("AA5AsIgJg1IhPAAIgZA1Ig0AAIAqhXICfAAIAQBXg");
	this.shape_5.setTransform(-15.5,8.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0.2,-3.2,0.2,3.1).s().p("AgfAsIAOhXIAwAAIgMBXg");
	this.shape_6.setTransform(-36.1,8.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["#CBCBCB","#FFFFFF"],[0,1],0,-4.6,0,4.6).s().p("AhMAQQgVgYACglIAyAAQgBAWAIANQALARAXABQAVAAANgLQANgNAEgXIAwAAIABABQgGAogcAWQgcAWgrgBQgrAAgYgdg");
	this.shape_7.setTransform(-56.4,8.3);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(0.1,-5.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.aaa, new cjs.Rectangle(-66,-12.8,132.1,25.6), null);
...
(lib.Symbol10 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(109.5,15.5);
	...
	this.instance_1.setTransform(109.5,16.5);
	this.instance_1.alpha = 0.602;
	this.instance_1.filters = [new cjs.BlurFilter(2, 2, 1)];
	this.instance_1.cache(-68,-15,136,30);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol10, new cjs.Rectangle(42.5,2.7,138,32), null);
...
(lib.Symbol9 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(80,16.2);
	this.instance_1.filters = [new cjs.BlurFilter(2, 2, 1)];
	this.instance_1.cache(-98,-18,197,35);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol9, new cjs.Rectangle(-17.5,-0.5,198,36), null);
...
p.nominalBounds = new cjs.Rectangle(40.1,14.8,199,69.1);
...
p.nominalBounds = new cjs.Rectangle(-21,-10,644,322);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1485878701498", id:"bg"},
		{src:"images/light.png?1485878701498", id:"light"},
		{src:"images/logo.png?1485878701498", id:"logo"},
		{src:"images/zagl_1.png?1485878701498", id:"zagl_1"},
		{src:"images/zagl_2.png?1485878701498", id:"zagl_2"}
	],
	preloads: []
};
