...
(lib.Symbol10 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:186},4,cjs.Ease.get(-1)).to({y:184},4,cjs.Ease.get(1)).to({y:186},4,cjs.Ease.get(-1)).to({y:185},4,cjs.Ease.get(1)).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1496384343256", id:"back"},
		{src:"images/ball.png?1496384343256", id:"ball"},
		{src:"images/body.png?1496384343256", id:"body"},
		{src:"images/button.png?1496384343256", id:"button"},
		{src:"images/hand.png?1496384343256", id:"hand"},
		{src:"images/hand1.png?1496384343256", id:"hand1"},
		{src:"images/handl.png?1496384343256", id:"handl"},
		{src:"images/logored.png?1496384343256", id:"logored"},
		{src:"images/ser1.png?1496384343256", id:"ser1"},
		{src:"images/ser2.png?1496384343256", id:"ser2"},
		{src:"images/ser3.png?1496384343256", id:"ser3"},
		{src:"images/ser4.png?1496384343256", id:"ser4"}
	],
	preloads: []
};
