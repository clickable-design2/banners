...
(lib.team_bg = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("rgba(119,119,128,0.486)").s().p("EgzAAEJIAAoQMBmBAAAIm0IQg");
	this.shape.setTransform(-54.5,14.7);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.team_bg, new cjs.Rectangle(-381,-11.8,653,52.9), null);
...
(lib.symbol2 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#4D0000").s().p("AouCgQg4gMgYgyQgshdBKhIQAJgJAHgMQAwhXBqAEQAdACAdgCQBrgCBsAHQBjAFBigCQCggECgAEQBhADBcAcQBhAeAPBhQATB4h1AnQglAMgnABQiRAEiQgDQiQgDiOgBQibAAibAHIgdABQg/AAg8gMg");
...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["rgba(0,0,0,0)","rgba(0,0,0,0.749)"],[0,0.612],0,0,0,0,0,724.7).s().p("EhhqAN/IAA79MDDVAAAIAAb9g");
	this.shape.setTransform(393.7,216.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol5, new cjs.Rectangle(-231.5,127,1250.3,179), null);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-420,-209,2.403,2.403);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(-420,-209,1441.9,721), null);
...
(lib.koeff_bg = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#990000","#D42A28"],[0,1],-64.9,0,65,0).s().p("Al8i0IQGgFIkNFuIwGAFg");
	this.shape.setTransform(192.5,-7.3,1.551,1.551);
...
}).prototype = getMCSymbolPrototype(lib.koeff_bg, new cjs.Rectangle(0.5,-36.1,292.9,73.8), null);
...
(lib.Символ18 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(63.7,18.8);
	this.instance.filters = [new cjs.BlurFilter(22, 22, 1)];
	this.instance.cache(-67,-19,135,38);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ18, new cjs.Rectangle(-12.9,-9.4,156,59), null);
...
(lib.team_2 = function(mode,startPosition,loop) {
	...
	// txt
	this.text = new cjs.Text(" ", "italic bold 42px 'Roboto'", "#FFFFFF");
	this.text.textAlign = "right";
	this.text.lineHeight = 51;
	this.text.lineWidth = 233;
	this.text.parent = this;
	this.text.setTransform(533,-14.1);
...
}).prototype = getMCSymbolPrototype(lib.team_2, new cjs.Rectangle(14,-16.1,653,211.3), null);
...
(lib.team_1 = function(mode,startPosition,loop) {
	...
	this.text.lineWidth = 233;
	this.text.parent = this;
	this.text.setTransform(-243.8,-13);
...
}).prototype = getMCSymbolPrototype(lib.team_1, new cjs.Rectangle(-381,-15,653,211.3), null);
...
(lib.koeff_2 = function(mode,startPosition,loop) {
	...
	// txt
	this.text = new cjs.Text(" ", "italic bold 46px 'Roboto'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 56;
	this.text.lineWidth = 100;
	this.text.parent = this;
	this.text.setTransform(52.8,-35.6);
...
}).prototype = getMCSymbolPrototype(lib.koeff_2, new cjs.Rectangle(-42.8,-37.6,292.9,75.3), null);
...
(lib.koeff_1 = function(mode,startPosition,loop) {
	...
	this.text.lineWidth = 100;
	this.text.parent = this;
	this.text.setTransform(-11.2,-35.8);
	...
	this.instance = new lib.koeff_bg();
	this.instance.parent = this;
	this.instance.setTransform(-138.8,18.8,1,1,0,0,0,65.2,18.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.koeff_1, new cjs.Rectangle(-203.5,-37.8,292.9,87.2), null);
...
(lib.date = function(mode,startPosition,loop) {
	...
	this.text.parent = this;
	this.text.setTransform(103.4,10.5);
...
}).prototype = getMCSymbolPrototype(lib.date, new cjs.Rectangle(-8,0,222,86.9), null);
...
p.nominalBounds = new cjs.Rectangle(-231.5,127,1250.3,179);
...
p.nominalBounds = new cjs.Rectangle(-420,-209,1441.9,721);
...
(lib.team_two = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.koeff_2).wait(5).to({regX:103.6,regY:0.8,x:30.5,y:0.8},0).wait(1).to({x:-16.5},0).wait(1).to({x:-49},0).wait(1).to({x:-73.4},0).wait(1).to({x:-93.3},0).wait(1).to({x:-110.5},0).wait(1).to({x:-124.7},0).wait(1).to({x:-135.8},0).wait(1).to({x:-144.4},0).wait(1).to({x:-150.9},0).wait(1).to({x:-155.8},0).wait(1).to({x:-159.6},0).wait(1).to({x:-162.6},0).wait(1).to({x:-165.2},0).wait(1).to({regX:65.2,regY:20.8,x:-205.8,y:20.8},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.team_2).wait(1).to({regX:340.5,regY:89.5,x:215.3,y:119.4},0).wait(1).to({x:160.4},0).wait(1).to({x:124.9},0).wait(1).to({x:97.9},0).wait(1).to({x:79.2},0).wait(1).to({x:67.3},0).wait(1).to({x:59.8},0).wait(1).to({x:54.7},0).wait(1).to({regX:143,regY:109.9,x:-146.7,y:139.8},0).to({x:-135.5},2,cjs.Ease.get(1)).to({x:-146.7},3,cjs.Ease.get(-1)).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regX:-54.5,regY:14.7,x:50.8,y:97.2,alpha:0.487},0).wait(1).to({y:119.2,alpha:0.271},0).wait(1).to({y:133.6,alpha:0.131},0).wait(1).to({y:141,alpha:0.059},0).wait(1).to({y:144.6,alpha:0.023},0).wait(1).to({regX:142.8,regY:20.6,x:-146.5,y:152.9,alpha:0},0).to({_off:true},1).wait(13));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-313.9,-37.6,964,262.6);
...
(lib.team_one = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.koeff_1).wait(5).to({regX:-57.1,regY:5.6,x:-228.6,y:5.6},0).wait(1).to({x:-154.5},0).wait(1).to({x:-99.3},0).wait(1).to({x:-56.6},0).wait(1).to({x:-20.9},0).wait(1).to({x:11.3},0).wait(1).to({x:40.4},0).wait(1).to({x:65},0).wait(1).to({x:84.7},0).wait(1).to({x:100.3},0).wait(1).to({x:112.8},0).wait(1).to({x:123},0).wait(1).to({x:131.9},0).wait(1).to({x:139.7},0).wait(1).to({regX:65.2,regY:20.8,x:269.2,y:20.8},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.team_1).wait(1).to({regX:-54.5,regY:90.6,x:-257.8,y:120.5},0).wait(1).to({x:-204.9},0).wait(1).to({x:-168.9},0).wait(1).to({x:-139.2},0).wait(1).to({x:-115.8},0).wait(1).to({x:-99.7},0).wait(1).to({x:-88.6},0).wait(1).to({x:-80.2},0).wait(1).to({regX:143,regY:109.9,x:124.3,y:139.8},0).to({x:119.3},2,cjs.Ease.get(1)).to({x:124.3},3,cjs.Ease.get(-1)).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:146.9,regY:0.8,x:146.9,y:0.8,alpha:0.453},0).wait(1).to({alpha:0.206},0).wait(1).to({alpha:0.064},0).wait(1).to({regX:65.2,regY:18.8,x:65.2,y:18.8,alpha:0},0).to({_off:true},1).wait(15));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regX:-54.5,regY:14.7,x:-73.2,y:91.5,alpha:0.556},0).wait(1).to({y:111.3,alpha:0.368},0).wait(1).to({y:128.5,alpha:0.206},0).wait(1).to({y:139.9,alpha:0.097},0).wait(1).to({y:146.2,alpha:0.038},0).wait(1).to({regX:142.8,regY:20.6,x:124.1,y:156.1,alpha:0},0).to({_off:true},1).wait(13));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-670.7,-37.8,964,264);
...
p.nominalBounds = new cjs.Rectangle(-10,-10.3,180,73);
...
p.nominalBounds = new cjs.Rectangle(0,0,222,86.9);
...
// stage content:
(lib.fon940x100 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		stage.canvas.width = 940 * 2;
		stage.canvas.height = 100 * 2;
		stage.canvas.style.width = '940px';
		stage.canvas.style.height = '100px';
	...
	this.btn.setTransform(823.5,31.9,0.935,0.935,0,0,0,96.9,28.6);
	...
	this.sign_two.setTransform(664.3,40.9,0.718,0.718,0,0,0,54.1,53.8);

	this.sign_one = new lib.sign_one();
	this.sign_one.parent = this;
	this.sign_one.setTransform(277,40.9,0.718,0.718,0,0,0,53.9,53.8);

	this.koeff_3 = new lib.koeff_3();
	this.koeff_3.parent = this;
	this.koeff_3.setTransform(470,81.6,1.071,1.071,0,0,0,62.2,28.5);
	...
	this.date.parent = this;
	this.date.setTransform(470.1,33.2,0.907,0.907,0,0,0,111.5,41.8);
	...
	this.team_two.setTransform(741.7,64.3,0.711,0.711,0,0,0,65.2,18.8);

	this.team_one = new lib.team_one();
	this.team_one.parent = this;
	this.team_one.setTransform(306.8,64.3,0.711,0.711,0,0,0,65.1,18.8);
	...
	this.instance.parent = this;
	this.instance.setTransform(109.6,-61.3,1.139,1.139,0,0,0,135.1,69.7);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(109.6,33.5,1.354,1.354,0,0,0,59.6,17.8);
	...
	this.black.setTransform(470.8,63.6,0.755,0.755,0,0,0,393.8,230.5);
	...
	this.bg.parent = this;
	this.bg.setTransform(470.7,68.7,0.711,0.711,0,0,0,300.2,150);

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(253.6,-136.6,1374,512.7);
// library properties:
lib.properties = {
	width: 940,
	height: 100,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1486038980240", id:"bg"},
		{src:"images/light.png?1486038980240", id:"light"},
		{src:"images/logo.png?1486038980240", id:"logo"},
		{src:"images/zagl_1.png?1486038980240", id:"zagl_1"},
		{src:"images/zagl_2.png?1486038980240", id:"zagl_2"}
	],
	preloads: []
};
