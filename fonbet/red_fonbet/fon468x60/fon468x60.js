...
// stage content:
(lib.fon468x60 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.koeff_3.setTransform(234.2,50.1,0.6,0.6,0,0,0,62.2,28.4);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1486038051826", id:"bg"},
		{src:"images/light.png?1486038051826", id:"light"},
		{src:"images/logo.png?1486038051826", id:"logo"},
		{src:"images/zagl_1.png?1486038051826", id:"zagl_1"},
		{src:"images/zagl_2.png?1486038051826", id:"zagl_2"}
	],
	preloads: []
};
