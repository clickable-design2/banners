...
// stage content:
(lib.fon240x400 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.koeff_3.setTransform(120.2,386.6,0.714,0.714,0,0,0,61.9,27.9);
	...
	this.btn.setTransform(118.9,338.7,0.794,0.794,0,0,0,96.6,28.4);
...
p.nominalBounds = new cjs.Rectangle(-165.1,20.8,1081.7,672.5);
// library properties:
lib.properties = {
	width: 240,
	height: 400,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1486037989453", id:"bg"},
		{src:"images/light.png?1486037989453", id:"light"},
		{src:"images/logo.png?1486037989453", id:"logo"},
		{src:"images/zagl_1.png?1486037989453", id:"zagl_1"},
		{src:"images/zagl_2.png?1486037989453", id:"zagl_2"}
	],
	preloads: []
};
