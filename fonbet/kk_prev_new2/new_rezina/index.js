...
(lib.Символ78 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(59,-32,0.581,0.581);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ78, new cjs.Rectangle(59,-32,54.6,64.5), null);
...
(lib.Символ40 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF0000").s().p("");
	this.shape.setTransform(0,19);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(-0.7,-23.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ40, new cjs.Rectangle(-212.6,-34.8,425.2,69.6), null);
...
(lib.Символ25 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-94,-20,0.944,0.944);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ25, new cjs.Rectangle(-94,-20,188.7,43.4), null);
...
(lib.Символ16 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ16, new cjs.Rectangle(-106.5,-23.4,213.2,46.8), null);
...
(lib.Символ15 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ15, new cjs.Rectangle(-106.5,-23.4,213.2,46.8), null);
...
p.nominalBounds = new cjs.Rectangle(-94,-20,188.7,43.4);
...
(lib.Символ39 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-0.1,0.5,0.571,0.571,0,0,0,-0.1,0.1);
	...
	this.instance_1.setTransform(-0.1,1.3,0.571,0.571,0,0,0,-0.1,0.1);
	this.instance_1.filters = [new cjs.BlurFilter(4, 4, 1)];
	this.instance_1.cache(-215,-34,429,68);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ39, new cjs.Rectangle(-123.5,-19.5,250,44.5), null);
...
(lib.Символ14 = function(mode,startPosition,loop) {
	...
	this.instance_1.filters = [new cjs.BlurFilter(4, 4, 1)];
	this.instance_1.cache(-108,-25,217,51);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ14, new cjs.Rectangle(-108.5,-24.4,220,54), null);
...
(lib.Символ12 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(115.6,-98.1);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-230,-130,0.905,0.905);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ12, new cjs.Rectangle(-230,-130,458,62.5), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ13, new cjs.Rectangle(-226.8,-130,458,62.5), null);
