...
p.nominalBounds = new cjs.Rectangle(0,0,201,66);
...
(lib.Symbol16 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("EhW8AP8IAA/3MCt5AAAIAAf3g");
	this.shape.setTransform(556.5,102);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol16, new cjs.Rectangle(0,0,1112.9,204), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol15, new cjs.Rectangle(0,0,201,66), null);
...
(lib.Tween2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0.1,0.1,1,1,0,0,0,556.5,102);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#00B23A").ss(1,1,1).p("EhW8gP7MCt5AAAIAAf3Mit5AAAg");

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-557.4,-102.9,1114.9,206);
...
(lib.Symbol26 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({scaleX:1.08,scaleY:1.08,x:139.1,y:39.6},0).wait(1));
...
(lib.Symbol8 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(151).to({scaleX:0.95},0).to({scaleX:1},4).to({scaleX:0.95},5).to({scaleX:1},5).to({scaleY:1.12},5).to({scaleY:1},6).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(11).to({_off:false},0).to({regY:25,scaleX:1,scaleY:1,rotation:360,x:403,y:65,alpha:1},11).wait(1).to({scaleX:0.88,scaleY:0.88,x:403.1},0).wait(1).to({scaleX:1,scaleY:1,x:403},0).wait(10).to({x:404,y:73},2).to({x:403,y:65},2).wait(8).to({y:75},2).to({y:65},2).wait(89).to({x:521,y:294},5).to({_off:true},1).wait(32));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:145.5,scaleX:1,scaleY:1,rotation:360,x:145.5,alpha:1},9).wait(1).to({regX:145.6,scaleX:0.93,scaleY:0.93,x:145.6,y:67.1},0).wait(1).to({regX:145.5,scaleX:1,scaleY:1,x:145.5,y:67},0).wait(23).to({x:144.5,y:81},2).to({x:145.5,y:67},2).wait(8).to({x:135.5,y:77},2).to({x:145.5,y:67},2).wait(89).to({x:29.6,y:252},5).to({_off:true},1).wait(32));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(124).to({rotation:360,x:286.5,y:55.2},15).to({x:337.3,y:72.8},2,cjs.Ease.get(-1)).to({x:413.5,y:99.2},3,cjs.Ease.get(1)).to({x:479.5,y:42.2},3,cjs.Ease.get(-1)).to({x:523.5,y:4.2},2,cjs.Ease.get(1)).to({regX:40.6,scaleX:0.88,x:531.6},1).wait(1).to({regX:40.5,scaleX:0.93,x:521.6},0).to({regX:40.6,rotation:0,x:382.6,y:193.2},5,cjs.Ease.get(-1)).wait(3).to({_off:true},1).wait(17));

	// Layer 7
	this.instance_6 = new lib.Tween1("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(279.5,46,0.231,0.231);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.instance_7 = new lib.Tween2("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(279.5,46);
	this.instance_7.alpha = 0.629;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_6}]},9).to({state:[{t:this.instance_7}]},2).to({state:[]},1).to({state:[{t:this.instance_6}]},11).to({state:[{t:this.instance_7}]},2).to({state:[]},1).to({state:[{t:this.instance_6}]},111).to({state:[{t:this.instance_7}]},2).to({state:[]},1).wait(37));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(9).to({_off:false},0).to({_off:true,scaleX:1,scaleY:1,alpha:0.629},2).wait(12).to({_off:false,scaleX:0.23,scaleY:0.23,alpha:0},0).to({_off:true,scaleX:1,scaleY:1,alpha:0.629},2).wait(112).to({_off:false,scaleX:0.23,scaleY:0.23,alpha:0},0).to({_off:true,scaleX:1,scaleY:1,alpha:0.629},2).wait(38));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-388,-28,1151,161.9);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.247)").s().p("EhcBASSMAAAgkjMC4DAAAMAAAAkjg");
...
(lib._1 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(131,117.5,1,1,0,0,0,145,121.5);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(929,140.5,1,1,0,0,0,139,39.5);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(542,102.5,1,1,0,0,0,556,148.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1486546948609", id:"back"},
		{src:"images/ball.png?1486546948609", id:"ball"},
		{src:"images/button.png?1486546948609", id:"button"},
		{src:"images/fnl2017.png?1486546948609", id:"fnl2017"},
		{src:"images/girls.png?1486546948609", id:"girls"},
		{src:"images/kipr.png?1486546948609", id:"kipr"},
		{src:"images/Layer10.png?1486546948609", id:"Layer10"},
		{src:"images/Layer3.png?1486546948609", id:"Layer3"},
		{src:"images/Layer4.png?1486546948609", id:"Layer4"},
		{src:"images/Layer5.png?1486546948609", id:"Layer5"},
		{src:"images/Layer6.png?1486546948609", id:"Layer6"},
		{src:"images/Layer7.png?1486546948609", id:"Layer7"},
		{src:"images/Layer8.png?1486546948609", id:"Layer8"},
		{src:"images/Layer9.png?1486546948609", id:"Layer9"},
		{src:"images/logo.png?1486546948609", id:"logo"},
		{src:"images/sm.png?1486546948609", id:"sm"},
		{src:"images/t11.png?1486546948609", id:"t11"}
	],
	preloads: []
};
