...
(lib.Symbol32 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(173,0);

	this.instance_1 = new lib.service2();
	this.instance_1.parent = this;
	this.instance_1.setTransform(75,-3);

	this.instance_2 = new lib.service();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-26,0);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol32, new cjs.Rectangle(-26,-3,261,67), null);
...
(lib.Symbol27 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-4.7,69.1,1.246,1.246,0,0,0,43.5,26.5);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(159.7,69.1,1.246,1.246,0,0,0,43.5,26.5);
...
p.nominalBounds = new cjs.Rectangle(-67.1,-58,284.9,165.2);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.instance_14.setTransform(200.5,90.4,1,1,34.5,0,0,7.5,12.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({scaleX:1,scaleY:1,rotation:25.8,x:193.4,y:90.3},4,cjs.Ease.get(-1)).to({regX:7.6,rotation:15.3,x:184.4,y:90.4},5,cjs.Ease.get(1)).to({rotation:20.1,x:188.5,y:90.3},5,cjs.Ease.get(-1)).to({regX:7.5,scaleX:1,scaleY:1,rotation:34.5,x:200.5,y:90.4},5,cjs.Ease.get(1)).wait(1).to({scaleX:1,scaleY:1,rotation:25.8,x:193.4,y:90.3},4,cjs.Ease.get(-1)).to({regX:7.6,rotation:15.3,x:184.4,y:90.4},5,cjs.Ease.get(1)).to({rotation:20.1,x:188.5,y:90.3},5,cjs.Ease.get(-1)).to({regX:7.5,scaleX:1,scaleY:1,rotation:34.5,x:200.5,y:90.4},5,cjs.Ease.get(1)).to({scaleX:1,scaleY:1,rotation:28.1,x:195.1,y:87.1},2).to({scaleX:1,scaleY:1,rotation:18.5,x:187,y:82.2},3,cjs.Ease.get(1)).to({regX:7.6,scaleX:1,scaleY:1,rotation:24.8,x:192.5,y:85.6},2,cjs.Ease.get(-1)).to({regX:7.5,scaleX:1,scaleY:1,rotation:34.5,x:200.5,y:90.4},3,cjs.Ease.get(1)).wait(1).to({scaleX:1,scaleY:1,rotation:25.8,x:193.4,y:90.3},4,cjs.Ease.get(-1)).to({regX:7.6,rotation:15.3,x:184.4,y:90.4},5,cjs.Ease.get(1)).to({rotation:20.1,x:188.5,y:90.3},5,cjs.Ease.get(-1)).to({regX:7.5,scaleX:1,scaleY:1,rotation:34.5,x:200.5,y:90.4},5,cjs.Ease.get(1)).wait(1).to({scaleX:1,scaleY:1,rotation:25.8,x:193.4,y:90.3},4,cjs.Ease.get(-1)).to({regX:7.6,rotation:15.3,x:184.4,y:90.4},5,cjs.Ease.get(1)).to({rotation:20.1,x:188.5,y:90.3},5,cjs.Ease.get(-1)).to({regX:7.5,scaleX:1,scaleY:1,rotation:34.5,x:200.5,y:90.4},5,cjs.Ease.get(1)).wait(1).to({rotation:18.5,x:187,y:82.2},3,cjs.Ease.get(-1)).to({regX:7.6,scaleX:1,scaleY:1,rotation:24.8,x:192.5,y:85.6},163,cjs.Ease.get(-1)).to({regX:7.5,scaleX:1,scaleY:1,rotation:34.5,x:200.5,y:90.4},5,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(99,-45,184.4,396.4);
...
(lib.index = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.fon = new lib.Symbol23();
	this.fon.parent = this;
	this.fon.setTransform(0.6,0.6,1,1,0,0,0,80.6,63.6);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1496910019547", id:"back"},
		{src:"images/ball.png?1496910019547", id:"ball"},
		{src:"images/bodu.png?1496910019547", id:"bodu"},
		{src:"images/btngreen.png?1496910019547", id:"btngreen"},
		{src:"images/btnred.png?1496910019547", id:"btnred"},
		{src:"images/hand1.png?1496910019547", id:"hand1"},
		{src:"images/handl.png?1496910019547", id:"handl"},
		{src:"images/head.png?1496910019547", id:"head"},
		{src:"images/hend.png?1496910019547", id:"hend"},
		{src:"images/Layer10.png?1496910019547", id:"Layer10"},
		{src:"images/Layer11.png?1496910019547", id:"Layer11"},
		{src:"images/leg1.png?1496910019547", id:"leg1"},
		{src:"images/leg2.png?1496910019547", id:"leg2"},
		{src:"images/legr.png?1496910019547", id:"legr"},
		{src:"images/legr1.png?1496910019547", id:"legr1"},
		{src:"images/logored.png?1496910019547", id:"logored"},
		{src:"images/raketka.png?1496910019547", id:"raketka"},
		{src:"images/service.png?1496910019547", id:"service"},
		{src:"images/service2.png?1496910019547", id:"service2"},
		{src:"images/service3.png?1496910019547", id:"service3"}
	],
	preloads: []
};
