...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(47,-53.1,1,1,0,0,0,35,35.5);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(54).to({y:-16.7,alpha:0.398},2,cjs.Ease.get(-1)).to({y:37.9,alpha:1},3,cjs.Ease.get(1)).wait(11).to({x:44},1).to({x:50},1).to({x:44},1).to({x:50},1).to({x:47},1).wait(28).to({y:1.5,alpha:0.602},2,cjs.Ease.get(-1)).to({y:-53.1,alpha:0},3,cjs.Ease.get(1)).to({_off:true},1).wait(7));

	// ser3.png
	this.instance_1 = new lib.Symbol8();
	this.instance_1.parent = this;
	this.instance_1.setTransform(131.6,-53.2,1,1,0,0,0,36.5,36);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(56).to({y:-16.8,alpha:0.398},2,cjs.Ease.get(-1)).to({y:37.8,alpha:1},3,cjs.Ease.get(1)).wait(27).to({x:128.6},1).to({x:134.6},1).to({x:128.6},1).to({x:134.6},1).to({x:131.6},1).wait(12).to({y:1.4,alpha:0.602},2,cjs.Ease.get(-1)).to({y:-53.2,alpha:0},3,cjs.Ease.get(1)).to({_off:true},1).wait(5));

	// ser2.png
	this.instance_2 = new lib.Symbol7();
	this.instance_2.parent = this;
	this.instance_2.setTransform(135.6,36,1,1,0,0,0,40.5,37);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(29).to({x:132.6},1).to({x:138.6},1).to({x:132.6},1).to({x:138.6},1).to({x:135.6},1).wait(17).to({y:4,alpha:0.602},2,cjs.Ease.get(-1)).to({y:-44,alpha:0},3,cjs.Ease.get(1)).wait(54).to({y:-12,alpha:0.398},2,cjs.Ease.get(-1)).to({y:36,alpha:1},3,cjs.Ease.get(1)).wait(1));
...
p.nominalBounds = new cjs.Rectangle(2,-89.2,174.1,163.2);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(463.2,204.5,0.637,0.637,0,0,0,15.5,15.5);
...
(lib.Symbol25 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-1.1,-478.9,1.039,1.039,0,0,0,42.9,37.1);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(49.3,-209.9,0.609,0.609,0,0,0,135.4,59.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol25, new cjs.Rectangle(-43.5,-610.1,180.8,436.6), null);
...
(lib.Symbol15 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(71,237.5,1,1,0,0,0,71,185);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol15, new cjs.Rectangle(0,52.5,213,370), null);
...
(lib.Symbol4 = function(mode,startPosition,loop) {
	...
	this.txt.setTransform(133,197.9,0.734,0.734,0,0,0,135.6,59.6);
	...
	this.instance.parent = this;
	this.instance.setTransform(68.9,54.5,0.644,0.644,0,0,0,115.5,33.6);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(70,-263,0.75,0.75,0,0,0,90,28);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(164.3,197.6,1,1,0,0,0,324.5,232);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol4, new cjs.Rectangle(-160.2,-293.8,649.1,723.4), null);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.red.setTransform(183.8,421.9,0.801,0.801,0,0,0,223.5,232.1);
	...
	this.girl.setTransform(-1.3,1,0.527,0.527,0,0,0,-7.1,-153.5);
	...
	this.fon.setTransform(0.1,1,1.074,1.074,0,0,0,173.2,3.1);

	this.timeline.addTween(cjs.Tween.get(this.fon).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-125.9,147.7,718.3,582.4);
// library properties:
lib.properties = {
	width: 120,
	height: 300,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1499698463052", id:"back"},
		{src:"images/ball.png?1499698463052", id:"ball"},
		{src:"images/body.png?1499698463052", id:"body"},
		{src:"images/button.png?1499698463052", id:"button"},
		{src:"images/hand.png?1499698463052", id:"hand"},
		{src:"images/hand1.png?1499698463052", id:"hand1"},
		{src:"images/handl.png?1499698463052", id:"handl"},
		{src:"images/logored.png?1499698463052", id:"logored"},
		{src:"images/ser1.png?1499698463052", id:"ser1"},
		{src:"images/ser2.png?1499698463052", id:"ser2"},
		{src:"images/ser3.png?1499698463052", id:"ser3"},
		{src:"images/ser4.png?1499698463052", id:"ser4"}
	],
	preloads: []
};
