...
(lib.team_bg = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("rgba(119,119,128,0.486)").s().p("EgtZAEJIAAoQMBazAAAImDIQg");
	this.shape.setTransform(-18.6,14.7);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.team_bg, new cjs.Rectangle(-309.2,-11.8,581.2,52.9), null);
...
(lib.team_2 = function(mode,startPosition,loop) {
	...
	this.text.setTransform(428.7,-14.1);
...
}).prototype = getMCSymbolPrototype(lib.team_2, new cjs.Rectangle(14,-16.1,581.2,211.3), null);
...
}).prototype = getMCSymbolPrototype(lib.team_1, new cjs.Rectangle(-309.2,-15,581.2,211.3), null);
...
(lib.team_two = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.team_2).wait(1).to({regX:304.6,regY:89.5,x:179.4,y:119.4},0).wait(1).to({x:124.5},0).wait(1).to({x:89},0).wait(1).to({x:62},0).wait(1).to({x:43.3},0).wait(1).to({x:31.4},0).wait(1).to({x:23.9},0).wait(1).to({x:18.8},0).wait(1).to({regX:143,regY:109.9,x:-146.7,y:139.8},0).to({x:-135.5},2,cjs.Ease.get(1)).to({x:-146.7},3,cjs.Ease.get(-1)).wait(6));
...
(lib.team_one = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.team_1).wait(1).to({regX:-18.6,regY:90.6,x:-221.9,y:120.5},0).wait(1).to({x:-169},0).wait(1).to({x:-133},0).wait(1).to({x:-103.3},0).wait(1).to({x:-79.9},0).wait(1).to({x:-63.8},0).wait(1).to({x:-52.7},0).wait(1).to({x:-44.3},0).wait(1).to({regX:143,regY:109.9,x:124.3,y:139.8},0).to({x:119.3},2,cjs.Ease.get(1)).to({x:124.3},3,cjs.Ease.get(-1)).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regX:-18.6,regY:14.7,x:-37.3,y:91.5,alpha:0.556},0).wait(1).to({y:111.3,alpha:0.368},0).wait(1).to({y:128.5,alpha:0.206},0).wait(1).to({y:139.9,alpha:0.097},0).wait(1).to({y:146.2,alpha:0.038},0).wait(1).to({regX:142.8,regY:20.6,x:124.1,y:156.1,alpha:0},0).to({_off:true},1).wait(13));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-598.9,-37.8,892.2,264);
...
// stage content:
(lib.fonbet_sign_468x60 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		stage.canvas.width = 468 * 2;
		stage.canvas.height = 60 * 2;
		stage.canvas.style.width = '468px';
		stage.canvas.style.height = '60px';
	...
	this.btn.setTransform(402.7,19.1,0.569,0.569,0,0,0,96.7,28.5);
	...
	this.sign_two.setTransform(317.1,25.4,0.386,0.386,0,0,0,54,53.8);

	this.sign_one = new lib.sign_one();
	this.sign_one.parent = this;
	this.sign_one.setTransform(151.9,25.4,0.386,0.386,0,0,0,53.8,53.8);

	this.koeff_3 = new lib.koeff_3();
	this.koeff_3.parent = this;
	this.koeff_3.setTransform(234.1,63.6,0.82,0.82,0,0,0,62.1,28.4);
	...
	this.date.parent = this;
	this.date.setTransform(234.2,19.6,0.586,0.586,0,0,0,111.4,41.7);
	...
	this.team_two.setTransform(380.3,41.2,0.382,0.382,0,0,0,65.2,18.7);

	this.team_one = new lib.team_one();
	this.team_one.parent = this;
	this.team_one.setTransform(146.4,41.2,0.382,0.382,0,0,0,65,18.7);
	...
	this.instance.parent = this;
	this.instance.setTransform(40.4,-35,0.612,0.612,0,0,0,135.1,69.7);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(52.8,19.8,0.728,0.728,0,0,0,59.6,17.7);
	...
	this.black.setTransform(234.6,34.9,0.382,0.382,0,0,0,393.7,230.6);
	...
	this.bg.parent = this;
	this.bg.setTransform(234.6,34.9,0.382,0.382,0,0,0,300.2,149.8);

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(126.5,-72.3,683.8,275.7);
// library properties:
lib.properties = {
	width: 468,
	height: 60,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1485946229779", id:"bg"},
		{src:"images/light.png?1485946229779", id:"light"},
		{src:"images/logo.png?1485946229779", id:"logo"},
		{src:"images/zagl_1.png?1485946229779", id:"zagl_1"},
		{src:"images/zagl_2.png?1485946229779", id:"zagl_2"}
	],
	preloads: []
};
