...
(lib.Символ78 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-27.3,-32.2,0.581,0.581);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ78, new cjs.Rectangle(-27.3,-32.2,54.6,64.5), null);
...
(lib.Символ35 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(69).to({_off:false},0).to({x:-204.9,alpha:1},8,cjs.Ease.get(1)).wait(32).to({x:287.4,y:11,alpha:0},8,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(69).to({_off:false},0).to({x:23,y:13.9,alpha:1},8,cjs.Ease.get(1)).wait(32).to({x:200.6,y:11.5,alpha:0},8,cjs.Ease.get(1)).wait(1));

	// Слой 5
	this.instance_2 = new lib.Символ77();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-174.1,6.3);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(29).to({_off:false},0).to({x:-109.1,alpha:1},8,cjs.Ease.get(1)).wait(32).to({x:-78.8,alpha:0},8,cjs.Ease.get(1)).wait(41));

	// Слой 2
	this.instance_3 = new lib.Символ36();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-219.2,5.8);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(29).to({_off:false},0).to({x:38.5,alpha:1},8,cjs.Ease.get(1)).wait(32).to({x:186.6,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(40));

	// Слой 4
	this.instance_4 = new lib.Символ76();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-177.2,9.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(29).to({x:-145.5},0).to({x:-73,alpha:0},8,cjs.Ease.get(1)).wait(72).to({x:-319.5},0).to({x:-145.5,alpha:1},8).wait(1));

	// Слой 1
	this.instance_5 = new lib.Символ32();
	this.instance_5.parent = this;
	this.instance_5.setTransform(0,-0.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(29).to({x:31.8},0).to({x:104.3,alpha:0},8).wait(72).to({x:-142.2},0).to({x:31.8,alpha:1},8).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-201,-25.3,346.6,70.3);
...
}).prototype = getMCSymbolPrototype(lib.Символ31, new cjs.Rectangle(-207.9,-15.8,346.6,70.3), null);
