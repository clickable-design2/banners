...
(lib.suuu = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
...
(lib.sumb = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FFA08E","#FF7B00","#FFC3C3","#FFFFFF"],[0,0.498,0.518,1],0,12.9,0,-12.8).s().p("AhiB9IAmj5ICeAAIgFAnIhtAAIgKA+IBcAAIgGAmIhbAAIgKBHIBsAAIgGAng");
	this.shape.setTransform(86.7,-2.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#FFA08E","#FF7B00","#FFC3C3","#FFFFFF"],[0,0.498,0.518,1],0,12.9,0,-12.8).s().p("AgqB9IAlj5IAwAAIglD5g");
	this.shape_1.setTransform(71.7,-2.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#FFA08E","#FF7B00","#FFC3C3","#FFFFFF"],[0,0.498,0.518,1],0,10,0,-9.9).s().p("AhjB9IAlj5IAyAAIgNBYIAqAAQApAAAXAXQAFAEADAGIACADQALARgEAbQgFAlgdAVQgcAXgqAAgAgrBWIArAAQATAAANgMQAOgNADgSQACgSgJgMQgKgMgVAAIgqAAg");
	this.shape_2.setTransform(56.4,-2.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#FFA08E","#FF7B00","#FFC3C3","#FFFFFF"],[0,0.498,0.518,1],0,12,0,-11.9).s().p("AAgB9IAQhoIhlAAIgPBoIgyAAIAlj5IAyAAIgQBsIBkAAIAQhsIAyAAIglD5g");
	this.shape_3.setTransform(33.7,-2.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["#FFA08E","#FF7B00","#FFC3C3","#FFFFFF"],[0,0.498,0.518,1],1.1,10.5,1.1,-16.1).s().p("ABCCbIAJg9IiUAAIgKA9IgxAAIAPhjIAOAAQATAAANgbQAKgVAKgnIAAgCIAEgTIAVhmICfAAIggDSIAeAAIgPBjgAACg0IgDATIgBACQgGAXgHATQgKAbgNASIBaAAIAZirIg/AAg");
	this.shape_4.setTransform(7.2,0.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.lf(["#FFA08E","#FF7B00","#FFC3C3","#FFFFFF"],[0,0.498,0.518,1],0,10.9,0,-10.8).s().p("AhYBiQgZgeAHguIAHgsQAHguAhgdQAggeAuAAQAsAAAaAeQAZAfgHAsIgGAsQgIAwggAdQghAdguAAQgtAAgZgegAgchFQgRASgFAdIgGAsQgFAfALASQAMATAaAAQAXgBASgSQARgUAFgdIAHgsQAEgdgMgTQgLgSgaAAQgYAAgRATg");
	this.shape_5.setTransform(-15.6,-2.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#FFA08E","#FF7B00","#FFC3C3","#FFFFFF"],[0,0.498,0.518,1],0,10.7,0,-10.7).s().p("AhqB9IAmj5IBeAAQApAAAWAXQAWAWgFAjQgDAYgNARIgCADQgGAGgJAHQgbAVgsABIgsAAIgOBagAgkgDIAtAAQATAAANgMQANgMACgQQADgTgJgLQgJgMgVAAIgsAAg");
	this.shape_6.setTransform(-38.9,-2.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["#FFA08E","#FF7B00","#FFC3C3","#FFFFFF"],[0,0.498,0.518,1],0,11,0,-10.9).s().p("AA5B9IgJg2IhPAAIgZA2Ig0AAIB4j5IAzAAIAuD5gAgNAfIA3AAIgOhWIgBAAg");
	this.shape_7.setTransform(-62.8,-2.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.lf(["#FFA08E","#FF7B00","#FFC3C3","#FFFFFF"],[0,0.498,0.518,1],0,12,0,-11.9).s().p("AAgB9IAQhoIhlAAIgPBoIgyAAIAlj5IAyAAIgQBsIBkAAIAQhsIAyAAIglD5g");
	this.shape_8.setTransform(-84.5,-2.8);
...
(lib.ddd = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
...
(lib.aaa = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FFA08E","#FF7B00","#FFC3C3","#FFFFFF"],[0,0.498,0.518,1],0,11,0,-10.9).s().p("AA5B8IgJg1IhPAAIgZA1Ig0AAIB4j3IAzAAIAuD3gAgNAfIA3AAIgOhWIgBgBg");
	this.shape.setTransform(-15.5,0);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#FFA08E","#FF7B00","#FFC3C3","#FFFFFF"],[0,0.498,0.518,1],0,9.9,0,-9.8).s().p("Ag7B8IAfjRIhFAAIAFgmIC+AAIgFAmIhHAAIgfDRg");
	this.shape_1.setTransform(-33.3,0);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#FFA08E","#FF7B00","#FFC3C3","#FFFFFF"],[0,0.498,0.518,1],0,10.4,0,-10.3).s().p("AhTBjQgYgdAGgtIAIgwQAHgvAfgdQAfgcArAAQArAAAXAXQAYAWgHAoIgBABIgwAAQAEgZgKgLQgKgMgYABQgVAAgPASQgQASgEAcIgIAxQgEAeAKARQALASAXAAQAVAAANgMQANgMAEgYIAwAAIABABQgGAqgcAVQgcAWgrAAQgrAAgYgdg");
	this.shape_2.setTransform(-55.7,0);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#FFA08E","#FF7B00","#FFC3C3","#FFFFFF"],[0,0.498,0.518,1],0,12,0,-11.9).s().p("AAgB8IAZikIgBgBIh8ClIgyAAIAlj3IAyAAIgZCkIABABIB8ilIAyAAIglD3g");
	this.shape_3.setTransform(54.1,0);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["#FFA08E","#FF7B00","#FFC3C3","#FFFFFF"],[0,0.498,0.518,1],0,11.3,0,-11.2).s().p("AAVB8IgyhmIgRAAIgPBmIgzAAIAlj3IAzAAIgQBlIASAAIBFhlIBBAAIhhB7IA/B8g");
	this.shape_4.setTransform(31.3,0);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.lf(["#FFA08E","#FF7B00","#FFC3C3","#FFFFFF"],[0,0.498,0.518,1],0,10.2,0,-10.1).s().p("AhkB8IAlj3IBRAAQAqAAAXARQAXARgFAiQgDARgLAOQgKANgSAHQAWAEAJAPQAJAQgCAVQgGAlgaASQgaARgrAAgAgsBWIAtAAQATAAAMgJQAMgIADgRQACgTgIgJQgJgKgVAAIgtAAgAgcgTIAiAAQASgBAMgIQAMgIACgPQADgSgJgIQgKgIgWAAIgfAAg");
	this.shape_5.setTransform(7.9,0);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1485877745580", id:"bg"},
		{src:"images/light.png?1485877745580", id:"light"},
		{src:"images/logo.png?1485877745580", id:"logo"},
		{src:"images/zagl_1.png?1485877745580", id:"zagl_1"},
		{src:"images/zagl_2.png?1485877745580", id:"zagl_2"}
	],
	preloads: []
};
