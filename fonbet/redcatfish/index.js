...
(lib.index = function(mode,startPosition,loop) {
	...
	// Layer 10
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(255,255,255,0)").ss(1,1,1).p("APXYKI+tAAMAAAgwTIetAA");
	this.shape.setTransform(361.8,374);
	...
	this.instance.parent = this;
	this.instance.setTransform(539.6,29.8,0.496,0.496,0,0,0,157,48.6);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(1303.9,50,0.566,0.566,0,0,0,240.7,62.6);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(1677.4,119.3,0.496,0.496,0,0,180,253,240.5);

	this.instance_3 = new lib.Symbol55();
	this.instance_3.parent = this;
	this.instance_3.setTransform(236.3,110.5,0.496,0.496,0,0,0,253,240.5);
	...
	this.bigs.setTransform(0.1,1.5,0.754,0.754,0,0,0,-340.8,111.2);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(1017.7,42.1,0.286,0.286,0,0,0,184.7,179.1);
	...
	this.smals.setTransform(1.7,2.2,0.468,0.468,0,0,0,-1337.7,93.7);
...
p.nominalBounds = new cjs.Rectangle(898,-37.3,2051.9,1330.8);
// library properties:
lib.properties = {
	width: 1920,
	height: 90,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1487776803896", id:"back"},
		{src:"images/button.png?1487776803896", id:"button"},
		{src:"images/chel.png?1487776803896", id:"chel"},
		{src:"images/foot.png?1487776803896", id:"foot"},
		{src:"images/logo.png?1487776803896", id:"logo"},
		{src:"images/logo1.png?1487776803896", id:"logo1"},
		{src:"images/logo2.png?1487776803896", id:"logo2"},
		{src:"images/logo3.png?1487776803896", id:"logo3"},
		{src:"images/logo4.png?1487776803896", id:"logo4"},
		{src:"images/logo5.png?1487776803896", id:"logo5"},
		{src:"images/LogosSportsbig.png?1487776803896", id:"LogosSportsbig"},
		{src:"images/LogosSports_small.png?1487776803896", id:"LogosSports_small"}
	],
	preloads: []
};
